...
::String StringTools_obj::quoteUnixArg(::String argument){
            	HX_STACK_FRAME("StringTools","quoteUnixArg",0xc59dac56,"StringTools.quoteUnixArg","/usr/local/lib/haxe/std/StringTools.hx",488,0x3f930611)
...
::String StringTools_obj::quoteWinArg(::String argument,Bool escapeMetaCharacters){
            	HX_STACK_FRAME("StringTools","quoteWinArg",0x7e16b8f2,"StringTools.quoteWinArg","/usr/local/lib/haxe/std/StringTools.hx",521,0x3f930611)
            	HX_STACK_ARG(argument,"argument")
...
{
{
            	HX_STACK_FRAME("StringTools","boot",0x1d20b7b6,"StringTools.boot","/usr/local/lib/haxe/std/StringTools.hx",506,0x3f930611)
