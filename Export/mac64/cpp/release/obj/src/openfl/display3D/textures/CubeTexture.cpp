...
HXLINE(  22)		super::__construct(context,(int)34067);
HXLINE(  24)		this->_hx___size = size;
HXLINE(  26)		this->_hx___optimizeForRenderToTexture = optimizeForRenderToTexture;
HXLINE(  27)		this->_hx___streamingLevels = streamingLevels;
HXLINE(  29)		this->_hx___uploadedSides = (int)0;
            	}
...
HXLINE(  43)		{
HXLINE(  43)			Int target = this->_hx___textureTarget;
HXDLIN(  43)			HX_VARI(  ::lime::graphics::opengl::GLTexture,texture) = this->_hx___textureID;
HXDLIN(  43)			{
HXLINE(  43)				 ::Dynamic texture1;
HXDLIN(  43)				Bool _hx_tmp = hx::IsNull( texture );
HXDLIN(  43)				if (_hx_tmp) {
HXLINE(  43)					texture1 = null();
            				}
            				else {
HXLINE(  43)					texture1 = texture->id;
            				}
HXDLIN(  43)				::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_texture(target,hx::DynamicPtr(texture1));
            			}
            		}
HXLINE(  45)		switch((int)(side)){
            			case (int)0: {
            			}
            			break;
            			case (int)1: {
            			...
            			break;
            			default:{
HXLINE(  53)				HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__new(null()));
            			}
            		}
HXLINE(  59)		hx::OrEq(this->_hx___uploadedSides,((int)(int)1 << (int)side));
HXLINE(  62)		{
HXLINE(  62)			Int target1 = this->_hx___textureTarget;
HXDLIN(  62)			{
HXLINE(  62)				 ::Dynamic texture2 = null();
HXDLIN(  62)				::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_texture(target1,hx::DynamicPtr(texture2));
            			}
            		}
            	}
...
static hx::StorageInfo CubeTexture_obj_sMemberStorageInfo[] = {
	{hx::fsBool,(int)offsetof(CubeTexture_obj,_hx___optimizeForRenderToTexture),HX_HCSTRING("__optimizeForRenderToTexture","\xbe","\xd4","\x90","\xb3")},
	{hx::fsInt,(int)offsetof(CubeTexture_obj,_hx___size),HX_HCSTRING("__size","\xe1","\x03","\x4c","\xfb")},
	{hx::fsInt,(int)offsetof(CubeTexture_obj,_hx___streamingLevels),HX_HCSTRING("__streamingLevels","\x51","\xa1","\xde","\x07")},
