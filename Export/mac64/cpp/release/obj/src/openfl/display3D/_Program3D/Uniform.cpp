...
HXDLIN( 461)					::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2fv(location,hx::DynamicPtr(v->buffer));
            				}
            				break;
            				case (int)35665: {
...
HXDLIN( 462)					::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3fv(location1,hx::DynamicPtr(v1->buffer));
            				}
            				break;
            				case (int)35666: {
...
HXDLIN( 463)					::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4fv(location2,hx::DynamicPtr(v2->buffer));
            				}
            				break;
            				case (int)35674: {
...
HXDLIN( 458)					::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform_matrix(location3,false,hx::DynamicPtr(v3->buffer),(int)2);
            				}
            				break;
            				case (int)35675: {
...
HXDLIN( 459)					::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform_matrix(location4,false,hx::DynamicPtr(v4->buffer),(int)3);
            				}
            				break;
            				case (int)35676: {
...
HXDLIN( 460)					::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform_matrix(location5,false,hx::DynamicPtr(v5->buffer),(int)4);
            				}
            				break;
            				default:{
...
HXDLIN( 464)					::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4fv(location6,hx::DynamicPtr(v6->buffer));
            				}
            			}
            		}
