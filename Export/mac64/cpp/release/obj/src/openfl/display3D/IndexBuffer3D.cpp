...
HXLINE(  31)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::get_version();
HXDLIN(  31)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_buffer()) );
HXDLIN(  31)		 ::Dynamic _hx_tmp1 = Dynamic(hx::DynamicPtr(inVal));
HXDLIN(  31)		this->_hx___id =  ::lime::graphics::opengl::GLBuffer_obj::__new(_hx_tmp,_hx_tmp1);
...
HXLINE(  34)			_hx_tmp2 = (int)35048;
            		}
            		else {
HXLINE(  34)			_hx_tmp2 = (int)35044;
            		}
HXDLIN(  34)		this->_hx___usage = _hx_tmp2;
...
void IndexBuffer3D_obj::dispose(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  44)		{
HXLINE(  44)			HX_VARI(  ::lime::graphics::opengl::GLBuffer,buffer) = this->_hx___id;
HXDLIN(  44)			{
HXLINE(  44)				 ::Dynamic buffer1 = buffer->id;
HXDLIN(  44)				::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_buffer(hx::DynamicPtr(buffer1));
            			}
...
void IndexBuffer3D_obj::uploadFromTypedArray( ::lime::utils::ArrayBufferView data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(  64)		{
HXLINE(  64)			HX_VARI(  ::lime::graphics::opengl::GLBuffer,buffer) = this->_hx___id;
HXDLIN(  64)			{
HXLINE(  64)				 ::Dynamic buffer1;
HXDLIN(  64)				Bool _hx_tmp = hx::IsNull( buffer );
HXDLIN(  64)				if (_hx_tmp) {
HXLINE(  64)					buffer1 = null();
            				}
            				else {
HXLINE(  64)					buffer1 = buffer->id;
            				}
HXDLIN(  64)				::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_buffer((int)34963,hx::DynamicPtr(buffer1));
            			}
            		}
HXLINE(  65)		::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE(  67)		{
HXLINE(  67)			Int usage = this->_hx___usage;
HXDLIN(  67)			{
HXLINE(  67)				Int byteOffset = data->byteOffset;
HXDLIN(  67)				Int size = data->byteLength;
HXDLIN(  67)				::lime::graphics::opengl::GL_obj::cffi_lime_gl_buffer_data((int)34963,hx::DynamicPtr(data->buffer),byteOffset,size,usage);
            			}
            		}
HXLINE(  68)		::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
HXLINE(  70)		Bool _hx_tmp1 = (data->byteLength != this->_hx___memoryUsage);
HXDLIN(  70)		if (_hx_tmp1) {
HXLINE(  72)			Int _hx_tmp2 = (data->byteLength - this->_hx___memoryUsage);
HXDLIN(  72)			this->_hx___context->_hx___statsAdd((int)6,_hx_tmp2);
HXLINE(  73)			this->_hx___memoryUsage = data->byteLength;
            		}
            	}
...
void IndexBuffer3D_obj::uploadFromVector( ::openfl::_Vector::IntVector data,Int startOffset,Int count){
            	...
            	HX_STACK_ARG(startOffset,"startOffset")
            	HX_STACK_ARG(count,"count")
HXLINE(  84)		HX_VARI( Int,length) = (startOffset + count);
HXLINE(  86)		HX_VAR_NAME(  ::lime::utils::ArrayBufferView,this1,"this");
HXDLIN(  86)		Bool _hx_tmp = hx::IsNotNull( count );
HXDLIN(  86)		if (_hx_tmp) {
HXLINE(  86)			this1 =  ::lime::utils::ArrayBufferView_obj::__new(count,(int)2);
            		}
            		else {
HXLINE(  86)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Int16Array",95,b2,95,a7));
            		}
HXDLIN(  86)		HX_VARI(  ::lime::utils::ArrayBufferView,buffer) = this1;
HXLINE(  88)		{
HXLINE(  88)			HX_VARI( Int,_g1) = startOffset;
HXDLIN(  88)			while((_g1 < length)){
HXLINE(  88)				HX_VARI( Int,i) = _g1++;
HXLINE(  90)				{
HXLINE(  90)					HX_VARI( Int,val) = data->get(i);
HXDLIN(  90)					Int _hx_tmp1 = buffer->byteOffset;
HXDLIN(  90)					::lime::utils::ArrayBufferIO_obj::setInt16(buffer->buffer,(_hx_tmp1 + ((i - startOffset) * (int)2)),val);
            				}
            			}
            		}
HXLINE(  94)		this->uploadFromTypedArray(buffer);
            	}
