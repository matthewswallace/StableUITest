...
HXLINE( 139)			HX_VARI( ::cpp::VirtualArray,a) = ::cpp::VirtualArray_obj::__new(16)->init(0,matrix->a)->init(1,matrix->b)->init(2,((Float)0.0))->init(3,((Float)0.0))->init(4,matrix->c)->init(5,matrix->d)->init(6,((Float)0.0))->init(7,((Float)0.0))->init(8,((Float)0.0))->init(9,((Float)0.0))->init(10,((Float)1.0))->init(11,((Float)0.0))->init(12,matrix->tx)->init(13,matrix->ty)->init(14,((Float)0.0))->init(15,((Float)1.0));
...
HXDLIN( 139)				HX_VARI( Int,_g) = a->get_length();
HXDLIN( 139)				while((_g1 < _g)){
HXLINE( 139)					HX_VARI( Int,i) = _g1++;
HXDLIN( 139)					vector->set(i,( (Float)(a->__get(i)) ));
            				}
            			}
