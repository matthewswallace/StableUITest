...
HXLINE(  26)			HX_VARI( ::cpp::VirtualArray,a) = ::cpp::VirtualArray_obj::__new(16)->init(0,((Float)1.0))->init(1,((Float)0.0))->init(2,((Float)0.0))->init(3,((Float)0.0))->init(4,((Float)0.0))->init(5,((Float)1.0))->init(6,((Float)0.0))->init(7,((Float)0.0))->init(8,((Float)0.0))->init(9,((Float)0.0))->init(10,((Float)1.0))->init(11,((Float)0.0))->init(12,((Float)0.0))->init(13,((Float)0.0))->init(14,((Float)0.0))->init(15,((Float)1.0));
...
HXDLIN(  26)				HX_VARI( Int,_g) = a->get_length();
HXDLIN(  26)				while((_g1 < _g)){
HXLINE(  26)					HX_VARI( Int,i) = _g1++;
HXDLIN(  26)					vector->set(i,( (Float)(a->__get(i)) ));
            				}
            			}
...
HXDLIN( 118)			HX_VARI( Int,_g) = a->get_length();
HXDLIN( 118)			while((_g1 < _g)){
HXLINE( 118)				HX_VARI( Int,i) = _g1++;
HXDLIN( 118)				vector->set(i,( (Float)(a->__get(i)) ));
            			}
            		}
...
void Matrix3D_obj::identity(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 523)		HX_VARI( ::cpp::VirtualArray,a) = ::cpp::VirtualArray_obj::__new(16)->init(0,((Float)1.0))->init(1,((Float)0.0))->init(2,((Float)0.0))->init(3,((Float)0.0))->init(4,((Float)0.0))->init(5,((Float)1.0))->init(6,((Float)0.0))->init(7,((Float)0.0))->init(8,((Float)0.0))->init(9,((Float)0.0))->init(10,((Float)1.0))->init(11,((Float)0.0))->init(12,((Float)0.0))->init(13,((Float)0.0))->init(14,((Float)0.0))->init(15,((Float)1.0));
...
HXDLIN( 523)			HX_VARI( Int,_g) = a->get_length();
HXDLIN( 523)			while((_g1 < _g)){
HXLINE( 523)				HX_VARI( Int,i) = _g1++;
HXDLIN( 523)				vector->set(i,( (Float)(a->__get(i)) ));
            			}
            		}
...
void Matrix3D_obj::prependScale(Float xScale,Float yScale,Float zScale){
            	...
            	HX_STACK_ARG(yScale,"yScale")
            	HX_STACK_ARG(zScale,"zScale")
HXLINE( 744)		HX_VARI( ::cpp::VirtualArray,a) = ::cpp::VirtualArray_obj::__new(16)->init(0,xScale)->init(1,((Float)0.0))->init(2,((Float)0.0))->init(3,((Float)0.0))->init(4,((Float)0.0))->init(5,yScale)->init(6,((Float)0.0))->init(7,((Float)0.0))->init(8,((Float)0.0))->init(9,((Float)0.0))->init(10,zScale)->init(11,((Float)0.0))->init(12,((Float)0.0))->init(13,((Float)0.0))->init(14,((Float)0.0))->init(15,((Float)1.0));
...
HXDLIN( 744)			HX_VARI( Int,_g) = a->get_length();
HXDLIN( 744)			while((_g1 < _g)){
HXLINE( 744)				HX_VARI( Int,i) = _g1++;
HXDLIN( 744)				vector->set(i,( (Float)(a->__get(i)) ));
            			}
            		}
...
HXLINE( 363)		HX_VARI( ::cpp::VirtualArray,a) = ::cpp::VirtualArray_obj::__new(16)->init(0,(c * scale))->init(1,(-(s) * scale))->init(2,(int)0)->init(3,(int)0)->init(4,(s * scale))->init(5,(c * scale))->init(6,(int)0)->init(7,(int)0)->init(8,(int)0)->init(9,(int)0)->init(10,(int)1)->init(11,(int)0)->init(12,x)->init(13,y)->init(14,(int)0)->init(15,(int)1);
...
HXDLIN( 363)			HX_VARI( Int,_g) = a->get_length();
HXDLIN( 363)			while((_g1 < _g)){
HXLINE( 363)				HX_VARI( Int,i) = _g1++;
HXDLIN( 363)				vector->set(i,( (Float)(a->__get(i)) ));
            			}
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(Matrix3D_obj,create2D,return )
 ...
 ::openfl::geom::Matrix3D Matrix3D_obj::createABCD(Float a,Float b,Float c,Float d,Float tx,Float ty){
            	...
            	HX_STACK_ARG(tx,"tx")
            	HX_STACK_ARG(ty,"ty")
HXLINE( 370)		HX_VARI_NAME( ::cpp::VirtualArray,a1,"a") = ::cpp::VirtualArray_obj::__new(16)->init(0,a)->init(1,b)->init(2,(int)0)->init(3,(int)0)->init(4,c)->init(5,d)->init(6,(int)0)->init(7,(int)0)->init(8,(int)0)->init(9,(int)0)->init(10,(int)1)->init(11,(int)0)->init(12,tx)->init(13,ty)->init(14,(int)0)->init(15,(int)1);
...
HXDLIN( 370)			HX_VARI( Int,_g) = a1->get_length();
HXDLIN( 370)			while((_g1 < _g)){
HXLINE( 370)				HX_VARI( Int,i) = _g1++;
HXDLIN( 370)				vector->set(i,( (Float)(a1->__get(i)) ));
            			}
            		}
...
HXLINE( 381)		HX_VARI( ::cpp::VirtualArray,a) = ::cpp::VirtualArray_obj::__new(16)->init(0,(((Float)2.0) * sx))->init(1,(int)0)->init(2,(int)0)->init(3,(int)0)->init(4,(int)0)->init(5,(((Float)2.0) * sy))->init(6,(int)0)->init(7,(int)0)->init(8,(int)0)->init(9,(int)0)->init(10,(((Float)-2.) * sz))->init(11,(int)0)->init(12,(-((x0 + x1)) * sx))->init(13,(-((y0 + y1)) * sy))->init(14,(-((zNear + zFar)) * sz))->init(15,(int)1);
...
HXDLIN( 381)			HX_VARI( Int,_g) = a->get_length();
HXDLIN( 381)			while((_g1 < _g)){
HXLINE( 381)				HX_VARI( Int,i) = _g1++;
HXDLIN( 381)				vector->set(i,( (Float)(a->__get(i)) ));
            			}
            		}
