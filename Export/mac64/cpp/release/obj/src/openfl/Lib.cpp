...
Dynamic Lib_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic Lib_obj::as( ::Dynamic v,hx::Class c){
            	HX_STACK_FRAME("openfl.Lib","as",0x3965ffb9,"openfl.Lib.as","openfl/Lib.hx",36,0x62fb7c98)
            	HX_STACK_ARG(v,"v")
            	HX_STACK_ARG(c,"c")
HXLINE(  36)		Bool _hx_tmp = ::Std_obj::is(v,c);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Lib_obj,as,return )
 ...
 ::openfl::display::MovieClip Lib_obj::attach(::String name){
            	HX_STACK_FRAME("openfl.Lib","attach",0xe350160c,"openfl.Lib.attach","openfl/Lib.hx",47,0x62fb7c98)
            	HX_STACK_ARG(name,"name")
HXLINE(  47)		return  ::openfl::display::MovieClip_obj::__new();
            	}
...
Int Lib_obj::getTimer(){
            	HX_STACK_FRAME("openfl.Lib","getTimer",0xd73d4956,"openfl.Lib.getTimer","openfl/Lib.hx",76,0x62fb7c98)
HXLINE(  76)		return ::lime::_hx_system::System_obj::getTimer();
            	}
...
void Lib_obj::getURL( ::openfl::net::URLRequest request,::String target){
            	HX_STACK_FRAME("openfl.Lib","getURL",0xa66862c0,"openfl.Lib.getURL","openfl/Lib.hx",82,0x62fb7c98)
            	HX_STACK_ARG(request,"request")
            	HX_STACK_ARG(target,"target")
HXLINE(  84)		Bool _hx_tmp = hx::IsNull( target );
HXDLIN(  84)		if (_hx_tmp) {
HXLINE(  86)			target = HX_("_blank",95,26,d9,b0);
            		}
HXLINE(  95)		::lime::tools::helpers::ProcessHelper_obj::openURL(request->url);
            	}
...
void Lib_obj::notImplemented( ::Dynamic posInfo){
            	HX_STACK_FRAME("openfl.Lib","notImplemented",0x6ff873b6,"openfl.Lib.notImplemented","openfl/Lib.hx",101,0x62fb7c98)
            	HX_STACK_ARG(posInfo,"posInfo")
HXLINE( 103)		HX_VARI( ::String,api) = ((( (::String)(posInfo->__Field(HX_("className",a3,92,3d,dc),hx::paccDynamic)) ) + HX_(".",2e,00,00,00)) + ( (::String)(posInfo->__Field(HX_("methodName",cc,19,0f,12),hx::paccDynamic)) ));
HXLINE( 105)		Bool _hx_tmp = !(::openfl::Lib_obj::_hx___sentWarnings->exists(api));
HXDLIN( 105)		if (_hx_tmp) {
HXLINE( 107)			::openfl::Lib_obj::_hx___sentWarnings->set(api,true);
HXLINE( 109)			::lime::utils::Log_obj::warn((( (::String)(posInfo->__Field(HX_("methodName",cc,19,0f,12),hx::paccDynamic)) ) + HX_(" is not implemented",1f,12,d2,b9)),posInfo);
            		}
            	}
...
void Lib_obj::preventDefaultTouchMove(){
            	HX_STACK_FRAME("openfl.Lib","preventDefaultTouchMove",0x0727aa40,"openfl.Lib.preventDefaultTouchMove","openfl/Lib.hx",116,0x62fb7c98)
            	}
...
void Lib_obj::trace( ::Dynamic arg){
            	HX_STACK_FRAME("openfl.Lib","trace",0xeba99a1e,"openfl.Lib.trace","openfl/Lib.hx",140,0x62fb7c98)
            	HX_STACK_ARG(arg,"arg")
HXLINE( 140)		::haxe::Log_obj::trace(arg,hx::SourceInfo(HX_("Lib.hx",b9,80,1c,19),140,HX_("openfl.Lib",47,43,57,2f),HX_("trace",85,8e,1f,16)));
            	}
...
{
{
            	HX_STACK_FRAME("openfl.Lib","boot",0xdf56aeb9,"openfl.Lib.boot","openfl/Lib.hx",23,0x62fb7c98)
HXLINE(  23)		current =  ::openfl::display::MovieClip_obj::__new();
            	}
{
            	HX_STACK_FRAME("openfl.Lib","boot",0xdf56aeb9,"openfl.Lib.boot","openfl/Lib.hx",28,0x62fb7c98)
HXLINE(  28)		_hx___sentWarnings =  ::haxe::ds::StringMap_obj::__new();
            	}
}
