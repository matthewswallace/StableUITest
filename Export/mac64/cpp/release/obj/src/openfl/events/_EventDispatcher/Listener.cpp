...
void Listener_obj::__construct( ::Dynamic callback,Bool useCapture,Int priority){
            	HX_STACK_FRAME("openfl.events._EventDispatcher.Listener","new",0x63be323b,"openfl.events._EventDispatcher.Listener.new","openfl/events/EventDispatcher.hx",340,0xe2270714)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(callback,"callback")
            	HX_STACK_ARG(useCapture,"useCapture")
            	HX_STACK_ARG(priority,"priority")
HXLINE( 342)		this->callback = callback;
HXLINE( 343)		this->useCapture = useCapture;
HXLINE( 344)		this->priority = priority;
            	}
...
Bool Listener_obj::match( ::Dynamic callback,Bool useCapture){
            	HX_STACK_FRAME("openfl.events._EventDispatcher.Listener","match",0xdf4e17e0,"openfl.events._EventDispatcher.Listener.match","openfl/events/EventDispatcher.hx",351,0xe2270714)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(callback,"callback")
            	HX_STACK_ARG(useCapture,"useCapture")
HXLINE( 351)		Bool _hx_tmp = ::Reflect_obj::compareMethods(this->callback,callback);
HXDLIN( 351)		if (_hx_tmp) {
HXLINE( 351)			return (this->useCapture == useCapture);
            		}
            		else {
