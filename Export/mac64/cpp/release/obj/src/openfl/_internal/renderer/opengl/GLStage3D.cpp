...
HXLINE(  18)			renderSession->blendModeManager->setBlendMode(null());
HXLINE(  20)			Bool _hx_tmp1 = hx::IsNotNull( renderSession->shaderManager->currentShader );
HXDLIN(  20)			if (_hx_tmp1) {
HXLINE(  22)				renderSession->shaderManager->setShader(null());
HXLINE(  24)				Bool _hx_tmp2 = hx::IsNotNull( stage3D->context3D->_hx___program );
HXDLIN(  24)				if (_hx_tmp2) {
HXLINE(  26)					stage3D->context3D->_hx___program->_hx___use();
            				}
            			}
            		}
            	}
