...
HXLINE(  23)		super::__construct(stage);
...
HXLINE(  32)		this->renderSession->blendModeManager =  ::openfl::_internal::renderer::cairo::CairoBlendModeManager_obj::__new(this->renderSession);
            	}
...
void CairoRenderer_obj::clear(){
            	HX_STACK_FRAME("openfl._internal.renderer.cairo.CairoRenderer","clear",0x6bca5509,"openfl._internal.renderer.cairo.CairoRenderer.clear","openfl/_internal/renderer/cairo/CairoRenderer.hx",39,0x849037d4)
            	HX_STACK_THIS(this)
HXLINE(  39)		HX_VARI( Int,_g) = (int)0;
HXDLIN(  39)		HX_VARI(  ::openfl::_Vector::ObjectVector,_g1) = this->stage->stage3Ds;
HXDLIN(  39)		while(true){
HXLINE(  39)			Int _hx_tmp = _g1->get_length();
HXDLIN(  39)			if (!((_g < _hx_tmp))) {
HXLINE(  39)				goto _hx_goto_0;
            			}
HXDLIN(  39)			HX_VARI(  ::openfl::display::Stage3D,stage3D) = _g1->get(_g).StaticCast<  ::openfl::display::Stage3D >();
HXDLIN(  39)			++_g;
HXLINE(  41)			stage3D->_hx___renderCairo(this->stage,this->renderSession);
            		}
            		_hx_goto_0:;
            	}
...
void CairoRenderer_obj::render(){
            	HX_STACK_FRAME("openfl._internal.renderer.cairo.CairoRenderer","render",0xe2c1945a,"openfl._internal.renderer.cairo.CairoRenderer.render","openfl/_internal/renderer/cairo/CairoRenderer.hx",48,0x849037d4)
            	HX_STACK_THIS(this)
HXLINE(  50)		this->renderSession->allowSmoothing = hx::IsNotEq( this->stage->quality,(int)2 );
HXLINE(  52)		this->cairo->identityMatrix();
HXLINE(  54)		Bool _hx_tmp = this->stage->_hx___clearBeforeRender;
HXDLIN(  54)		if (_hx_tmp) {
HXLINE(  56)			Float _hx_tmp1 = this->stage->_hx___colorSplit->__get((int)0);
HXDLIN(  56)			Float _hx_tmp2 = this->stage->_hx___colorSplit->__get((int)1);
HXDLIN(  56)			Float _hx_tmp3 = this->stage->_hx___colorSplit->__get((int)2);
HXDLIN(  56)			this->cairo->setSourceRGB(_hx_tmp1,_hx_tmp2,_hx_tmp3);
HXLINE(  57)			this->cairo->paint();
            		}
HXLINE(  61)		this->stage->_hx___renderCairo(this->renderSession);
            	}
