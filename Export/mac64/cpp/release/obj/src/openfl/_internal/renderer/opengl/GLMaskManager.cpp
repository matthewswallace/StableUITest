...
HXLINE( 158)			{
HXLINE( 158)				Int cap = this->gl->SCISSOR_TEST;
HXDLIN( 158)				::lime::graphics::opengl::GL_obj::cffi_lime_gl_enable(cap);
            			}
...
HXLINE( 171)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_scissor(x,y,width,height);
            		}
            		else {
HXLINE( 175)			Int cap1 = this->gl->SCISSOR_TEST;
HXDLIN( 175)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_disable(cap1);
            		}
            	}
