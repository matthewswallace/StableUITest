...
void CanvasGraphics_obj::createTempPatternCanvas( ::openfl::display::BitmapData bitmap,Bool repeat,Int width,Int height){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","createTempPatternCanvas",0x07b48808,"openfl._internal.renderer.canvas.CanvasGraphics.createTempPatternCanvas","openfl/_internal/renderer/canvas/CanvasGraphics.hx",157,0x0b9ff65e)
            	HX_STACK_ARG(bitmap,"bitmap")
...
void CanvasGraphics_obj::drawRoundRect(Float x,Float y,Float width,Float height,Float ellipseWidth, ::Dynamic ellipseHeight){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","drawRoundRect",0x4e8f7efe,"openfl._internal.renderer.canvas.CanvasGraphics.drawRoundRect","openfl/_internal/renderer/canvas/CanvasGraphics.hx",183,0x0b9ff65e)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
...
void CanvasGraphics_obj::endFill(){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","endFill",0x3478970e,"openfl._internal.renderer.canvas.CanvasGraphics.endFill","openfl/_internal/renderer/canvas/CanvasGraphics.hx",219,0x0b9ff65e)
            	}
...
void CanvasGraphics_obj::endStroke(){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","endStroke",0x411cf503,"openfl._internal.renderer.canvas.CanvasGraphics.endStroke","openfl/_internal/renderer/canvas/CanvasGraphics.hx",230,0x0b9ff65e)
            	}
...
Bool CanvasGraphics_obj::hitTest( ::openfl::display::Graphics graphics,Float x,Float y){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","hitTest",0xf1176f55,"openfl._internal.renderer.canvas.CanvasGraphics.hitTest","openfl/_internal/renderer/canvas/CanvasGraphics.hx",448,0x0b9ff65e)
...
Bool CanvasGraphics_obj::isCCW(Float x1,Float y1,Float x2,Float y2,Float x3,Float y3){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","isCCW",0xce74af1d,"openfl._internal.renderer.canvas.CanvasGraphics.isCCW","openfl/_internal/renderer/canvas/CanvasGraphics.hx",455,0x0b9ff65e)
            	HX_STACK_ARG(x1,"x1")
            	HX_STACK_ARG(y1,"y1")
            	HX_STACK_ARG(x2,"x2")
            	HX_STACK_ARG(y2,"y2")
...
Bool skipT = __o_skipT.Default(false);
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","normalizeUVT",0x11b66056,"openfl._internal.renderer.canvas.CanvasGraphics.normalizeUVT","openfl/_internal/renderer/canvas/CanvasGraphics.hx",460,0x0b9ff65e)
            	HX_STACK_ARG(uvt,"uvt")
            	HX_STACK_ARG(skipT,"skipT")
HXLINE( 462)		HX_VARI( Float,max) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 463)		HX_VARI( Float,tmp) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 464)		HX_VARI( Int,len) = uvt->get_length();
HXLINE( 466)		{
HXLINE( 466)			HX_VARI( Int,_g1) = (int)1;
HXDLIN( 466)			HX_VARI( Int,_g) = (len + (int)1);
HXDLIN( 466)			while((_g1 < _g)){
HXLINE( 466)				HX_VARI( Int,t) = _g1++;
...
HXLINE( 476)				Bool _hx_tmp1 = (max < tmp);
...
HXDLIN( 490)		HX_VARI(  ::openfl::_Vector::FloatVector,result) =  ::openfl::_Vector::FloatVector_obj::__new(length,fixed,null());
HXLINE( 492)		{
HXLINE( 492)			HX_VARI_NAME( Int,_g11,"_g1") = (int)1;
HXDLIN( 492)			HX_VARI_NAME( Int,_g2,"_g") = (len + (int)1);
HXDLIN( 492)			while((_g11 < _g2)){
HXLINE( 492)				HX_VARI_NAME( Int,t1,"t") = _g11++;
HXLINE( 494)				Bool _hx_tmp2;
HXDLIN( 494)				if (skipT) {
HXLINE( 494)					_hx_tmp2 = (hx::Mod(t1,(int)3) == (int)0);
            				}
            				else {
...
HXLINE( 500)				{
HXLINE( 500)					Float x = uvt->get((t1 - (int)1));
HXDLIN( 500)					result->push(x);
            				}
            			}
            		}
...
Bool stroke = __o_stroke.Default(false);
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","playCommands",0x147605cc,"openfl._internal.renderer.canvas.CanvasGraphics.playCommands","openfl/_internal/renderer/canvas/CanvasGraphics.hx",509,0x0b9ff65e)
...
void CanvasGraphics_obj::render( ::openfl::display::Graphics graphics, ::openfl::_internal::renderer::RenderSession renderSession, ::openfl::geom::Matrix parentTransform){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","render",0x7dc3ee46,"openfl._internal.renderer.canvas.CanvasGraphics.render","openfl/_internal/renderer/canvas/CanvasGraphics.hx",840,0x0b9ff65e)
            	HX_STACK_ARG(graphics,"graphics")
...
void CanvasGraphics_obj::renderMask( ::openfl::display::Graphics graphics, ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","renderMask",0xfa8ef652,"openfl._internal.renderer.canvas.CanvasGraphics.renderMask","openfl/_internal/renderer/canvas/CanvasGraphics.hx",1187,0x0b9ff65e)
            	HX_STACK_ARG(graphics,"graphics")
            	HX_STACK_ARG(renderSession,"renderSession")
            	}
...
void CanvasGraphics_obj::setSmoothing(Bool smooth){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","setSmoothing",0x84b8ec62,"openfl._internal.renderer.canvas.CanvasGraphics.setSmoothing","openfl/_internal/renderer/canvas/CanvasGraphics.hx",1294,0x0b9ff65e)
            	HX_STACK_ARG(smooth,"smooth")
            	}
