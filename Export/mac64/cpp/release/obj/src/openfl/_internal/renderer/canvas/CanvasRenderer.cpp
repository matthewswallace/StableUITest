...
HXLINE(  20)		super::__construct(stage);
...
HXDLIN(  37)		HX_VARI(  ::openfl::_Vector::ObjectVector,_g1) = this->stage->stage3Ds;
HXDLIN(  37)		while(true){
HXLINE(  37)			Int _hx_tmp = _g1->get_length();
HXDLIN(  37)			if (!((_g < _hx_tmp))) {
HXLINE(  37)				goto _hx_goto_0;
            			}
HXDLIN(  37)			HX_VARI(  ::openfl::display::Stage3D,stage3D) = _g1->get(_g).StaticCast<  ::openfl::display::Stage3D >();
HXDLIN(  37)			++_g;
HXLINE(  39)			stage3D->_hx___renderCanvas(this->stage,this->renderSession);
            		}
            		_hx_goto_0:;
            	}
...
void CanvasRenderer_obj::render(){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasRenderer","render",0x244720ce,"openfl._internal.renderer.canvas.CanvasRenderer.render","openfl/_internal/renderer/canvas/CanvasRenderer.hx",46,0x1be544e6)
            	HX_STACK_THIS(this)
HXLINE(  48)		this->renderSession->allowSmoothing = hx::IsNotEq( this->stage->quality,(int)2 );
HXLINE(  50)		this->context->setTransform((int)1,(int)0,(int)0,(int)1,(int)0,(int)0);
HXLINE(  51)		this->context->globalAlpha = (int)1;
HXLINE(  53)		Bool _hx_tmp;
HXDLIN(  53)		if (!(this->stage->_hx___transparent)) {
HXLINE(  53)			_hx_tmp = this->stage->_hx___clearBeforeRender;
            		}
            		else {
HXLINE(  53)			_hx_tmp = false;
            		}
HXDLIN(  53)		if (_hx_tmp) {
HXLINE(  55)			this->context->fillStyle = this->stage->_hx___colorString;
HXLINE(  56)			this->context->fillRect((int)0,(int)0,this->stage->stageWidth,this->stage->stageHeight);
            		}
            		else {
HXLINE(  58)			Bool _hx_tmp1;
HXDLIN(  58)			if (this->stage->_hx___transparent) {
HXLINE(  58)				_hx_tmp1 = this->stage->_hx___clearBeforeRender;
            			}
            			else {
HXLINE(  58)				_hx_tmp1 = false;
            			}
HXDLIN(  58)			if (_hx_tmp1) {
HXLINE(  60)				this->context->clearRect((int)0,(int)0,this->stage->stageWidth,this->stage->stageHeight);
            			}
            		}
HXLINE(  64)		this->stage->_hx___renderCanvas(this->renderSession);
            	}
