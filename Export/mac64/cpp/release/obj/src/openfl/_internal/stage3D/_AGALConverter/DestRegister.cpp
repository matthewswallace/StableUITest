...
::String DestRegister_obj::getWriteMask(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 499)		HX_VARI( ::String,str) = HX_(".",2e,00,00,00);
HXLINE( 500)		if ((((int)this->mask & (int)(int)1) != (int)0)) {
HXLINE( 500)			str = (HX_(".",2e,00,00,00) + HX_("x",78,00,00,00));
            		}
HXLINE( 501)		if ((((int)this->mask & (int)(int)2) != (int)0)) {
HXLINE( 501)			hx::AddEq(str,HX_("y",79,00,00,00));
            		}
HXLINE( 502)		if ((((int)this->mask & (int)(int)4) != (int)0)) {
HXLINE( 502)			hx::AddEq(str,HX_("z",7a,00,00,00));
            		}
HXLINE( 503)		if ((((int)this->mask & (int)(int)8) != (int)0)) {
HXLINE( 503)			hx::AddEq(str,HX_("w",77,00,00,00));
            		}
HXLINE( 504)		return str;
            	}
...
HXLINE( 523)		HX_VAR( ::String,str);
HXLINE( 525)		Bool _hx_tmp = (this->type == (int)3);
HXDLIN( 525)		if (_hx_tmp) {
HXLINE( 527)			if (hx::IsEq( this->programType,::openfl::_internal::stage3D::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
HXLINE( 527)				str = HX_("gl_Position",63,0d,2a,e5);
            			}
            			else {
HXLINE( 527)				str = HX_("gl_FragColor",d7,68,e4,21);
            			}
            		}
            		else {
HXLINE( 531)			::String _hx_tmp1 = ::openfl::_internal::stage3D::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXDLIN( 531)			str = (_hx_tmp1 + this->n);
            		}
HXLINE( 535)		Bool _hx_tmp2;
HXDLIN( 535)		if (useMask) {
HXLINE( 535)			_hx_tmp2 = (this->mask != (int)15);
            		}
            		else {
HXLINE( 535)			_hx_tmp2 = false;
            		}
HXDLIN( 535)		if (_hx_tmp2) {
HXLINE( 537)			::String _hx_tmp3 = this->getWriteMask();
HXDLIN( 537)			hx::AddEq(str,_hx_tmp3);
            		}
HXLINE( 541)		return str;
            	}
...
HXLINE( 511)		HX_VARI(  ::openfl::_internal::stage3D::_AGALConverter::DestRegister,dr) =  ::openfl::_internal::stage3D::_AGALConverter::DestRegister_obj::__new();
HXLINE( 512)		dr->programType = programType;
HXLINE( 513)		dr->type = ((int)hx::UShr(v,(int)24) & (int)(int)15);
HXLINE( 514)		dr->mask = ((int)hx::UShr(v,(int)16) & (int)(int)15);
HXLINE( 515)		dr->n = ((int)v & (int)(int)65535);
HXLINE( 516)		return dr;
            	}
