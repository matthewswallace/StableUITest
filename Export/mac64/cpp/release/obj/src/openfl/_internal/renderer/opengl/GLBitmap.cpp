...
HXLINE(  24)			HX_VARI(  ::lime::graphics::GLRenderContext,gl) = renderSession->gl;
...
HXLINE(  37)			{
HXLINE(  37)				Int target = gl->ARRAY_BUFFER;
HXDLIN(  37)				HX_VARI(  ::lime::graphics::opengl::GLBuffer,buffer) = bitmap->bitmapData->getBuffer(gl,bitmap->_hx___worldAlpha);
HXDLIN(  37)				{
HXLINE(  37)					 ::Dynamic buffer1;
HXDLIN(  37)					Bool _hx_tmp5 = hx::IsNull( buffer );
HXDLIN(  37)					if (_hx_tmp5) {
HXLINE(  37)						buffer1 = null();
            					}
            					else {
HXLINE(  37)						buffer1 = buffer->id;
            					}
HXDLIN(  37)					::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_buffer(target,hx::DynamicPtr(buffer1));
            				}
            			}
HXLINE(  38)			{
HXLINE(  38)				Int indx = shader->get_data()->aPosition->index;
HXDLIN(  38)				Int type = gl->FLOAT;
HXDLIN(  38)				::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib_pointer(indx,(int)3,type,false,(int)24,(int)0);
            			}
HXLINE(  39)			{
HXLINE(  39)				Int indx1 = shader->get_data()->aTexCoord->index;
HXDLIN(  39)				Int type1 = gl->FLOAT;
HXDLIN(  39)				::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib_pointer(indx1,(int)2,type1,false,(int)24,(int)12);
            			}
HXLINE(  40)			{
HXLINE(  40)				Int indx2 = shader->get_data()->aAlpha->index;
HXDLIN(  40)				Int type2 = gl->FLOAT;
HXDLIN(  40)				::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib_pointer(indx2,(int)1,type2,false,(int)24,(int)20);
            			}
HXLINE(  42)			{
HXLINE(  42)				Int mode = gl->TRIANGLE_STRIP;
HXDLIN(  42)				::lime::graphics::opengl::GL_obj::cffi_lime_gl_draw_arrays(mode,(int)0,(int)4);
            			}
