...
HXLINE(  30)		super::__construct(stage);
...
void DOMRenderer_obj::clear(){
            	HX_STACK_FRAME("openfl._internal.renderer.dom.DOMRenderer","clear",0x7c37cbfd,"openfl._internal.renderer.dom.DOMRenderer.clear","openfl/_internal/renderer/dom/DOMRenderer.hx",126,0xc812e2a0)
            	HX_STACK_THIS(this)
HXLINE( 126)		HX_VARI( Int,_g) = (int)0;
HXDLIN( 126)		HX_VARI(  ::openfl::_Vector::ObjectVector,_g1) = this->stage->stage3Ds;
HXDLIN( 126)		while(true){
HXLINE( 126)			Int _hx_tmp = _g1->get_length();
HXDLIN( 126)			if (!((_g < _hx_tmp))) {
HXLINE( 126)				goto _hx_goto_0;
            			}
HXDLIN( 126)			HX_VARI(  ::openfl::display::Stage3D,stage3D) = _g1->get(_g).StaticCast<  ::openfl::display::Stage3D >();
HXDLIN( 126)			++_g;
HXLINE( 128)			stage3D->_hx___renderDOM(this->stage,this->renderSession);
            		}
            		_hx_goto_0:;
            	}
...
void DOMRenderer_obj::render(){
            	HX_STACK_FRAME("openfl._internal.renderer.dom.DOMRenderer","render",0x321c32e6,"openfl._internal.renderer.dom.DOMRenderer.render","openfl/_internal/renderer/dom/DOMRenderer.hx",157,0xc812e2a0)
            	HX_STACK_THIS(this)
HXLINE( 159)		this->renderSession->allowSmoothing = hx::IsNotEq( this->stage->quality,(int)2 );
HXLINE( 161)		Bool _hx_tmp = !(this->stage->_hx___transparent);
