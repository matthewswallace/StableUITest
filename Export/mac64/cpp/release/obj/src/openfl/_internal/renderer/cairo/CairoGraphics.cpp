...
HXDLIN( 102)			pattern = ::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::createRadial(x,y,(int)0,x,y,_hx_tmp2);
...
HXLINE( 129)				Bool _hx_tmp3 = (ratio < (int)0);
HXDLIN( 129)				if (_hx_tmp3) {
HXLINE( 129)					ratio = (int)0;
            				}
HXLINE( 130)				Bool _hx_tmp4 = (ratio > (int)1);
...
HXLINE(1016)		if (!(graphics->_hx___dirty)) {
HXLINE(1016)			return;
            		}
...
HXDLIN(1023)		Bool _hx_tmp4 = !(!(graphics->_hx___visible));
HXDLIN(1023)		if (_hx_tmp4) {
HXLINE(1023)			Int _hx_tmp5 = graphics->_hx___commands->get_length();
HXDLIN(1023)			_hx_tmp3 = (_hx_tmp5 == (int)0);
            		}
            		else {
HXLINE(1023)			_hx_tmp3 = true;
            		}
HXDLIN(1023)		if (!(_hx_tmp3)) {
HXLINE(1023)			_hx_tmp2 = hx::IsNull( ::openfl::_internal::renderer::cairo::CairoGraphics_obj::bounds );
            		}
            		else {
HXLINE(1023)			_hx_tmp2 = true;
            		}
HXDLIN(1023)		if (!(_hx_tmp2)) {
HXLINE(1023)			_hx_tmp1 = (width < (int)1);
            		}
            		else {
HXLINE(1023)			_hx_tmp1 = true;
            		}
HXDLIN(1023)		if (!(_hx_tmp1)) {
HXLINE(1023)			_hx_tmp = (height < (int)1);
            		}
            		else {
...
HXLINE(1032)			Bool _hx_tmp6 = hx::IsNotNull( graphics->_hx___cairo );
HXDLIN(1032)			if (_hx_tmp6) {
HXLINE(1034)				HX_VARI(  ::Dynamic,surface) = graphics->_hx___cairo->get_target();
HXLINE(1036)				Bool _hx_tmp7;
HXDLIN(1036)				Int _hx_tmp8 = ::lime::graphics::cairo::_CairoImageSurface::CairoImageSurface_Impl__obj::get_width(surface);
HXDLIN(1036)				if ((width == _hx_tmp8)) {
HXLINE(1036)					Int _hx_tmp9 = ::lime::graphics::cairo::_CairoImageSurface::CairoImageSurface_Impl__obj::get_height(surface);
HXDLIN(1036)					_hx_tmp7 = (height != _hx_tmp9);
            				}
            				else {
HXLINE(1036)					_hx_tmp7 = true;
            				}
HXDLIN(1036)				if (_hx_tmp7) {
HXLINE(1038)					graphics->_hx___cairo = null();
            				}
            			}
HXLINE(1044)			Bool _hx_tmp10;
HXDLIN(1044)			Bool _hx_tmp11 = hx::IsNotNull( graphics->_hx___cairo );
HXDLIN(1044)			if (_hx_tmp11) {
HXLINE(1044)				_hx_tmp10 = hx::IsNull( graphics->_hx___bitmap );
            			}
            			else {
HXLINE(1044)				_hx_tmp10 = true;
            			}
HXDLIN(1044)			if (_hx_tmp10) {
...
HXLINE(1054)			 ::lime::math::Matrix3 _hx_tmp12 = graphics->_hx___renderTransform->_hx___toMatrix3();
HXDLIN(1054)			::openfl::_internal::renderer::cairo::CairoGraphics_obj::cairo->set_matrix(_hx_tmp12);
...
HXDLIN(1071)					++_g;
HXLINE(1073)					Int _hx_tmp13 = ( ( ::hx::EnumBase)(type) )->_hx_getIndex();
HXDLIN(1073)					switch((int)(_hx_tmp13)){
            						case (int)0: case (int)1: case (int)2: {
...
HXLINE(1129)								{
HXLINE(1129)									Int _hx_tmp14 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(1129)									switch((int)(_hx_tmp14)){
            										case (int)0: {
...
HXLINE(1130)								 ::openfl::display::BitmapData _hx_tmp15 = ( ( ::openfl::display::BitmapData)(c->buffer->o->__get(c->oPos)) );
HXDLIN(1130)								 ::openfl::geom::Matrix _hx_tmp16 = ( ( ::openfl::geom::Matrix)(c->buffer->o->__get((c->oPos + (int)1))) );
HXDLIN(1130)								Bool _hx_tmp17 = c->buffer->b->__get(c->bPos);
HXDLIN(1130)								Bool _hx_tmp18 = c->buffer->b->__get((c->bPos + (int)1));
HXDLIN(1130)								::openfl::_internal::renderer::cairo::CairoGraphics_obj::fillCommands->beginBitmapFill(_hx_tmp15,_hx_tmp16,_hx_tmp17,_hx_tmp18);
HXLINE(1131)								 ::openfl::display::BitmapData _hx_tmp19 = ( ( ::openfl::display::BitmapData)(c->buffer->o->__get(c->oPos)) );
HXDLIN(1131)								 ::openfl::geom::Matrix _hx_tmp20 = ( ( ::openfl::geom::Matrix)(c->buffer->o->__get((c->oPos + (int)1))) );
HXDLIN(1131)								Bool _hx_tmp21 = c->buffer->b->__get(c->bPos);
HXDLIN(1131)								Bool _hx_tmp22 = c->buffer->b->__get((c->bPos + (int)1));
HXDLIN(1131)								::openfl::_internal::renderer::cairo::CairoGraphics_obj::strokeCommands->beginBitmapFill(_hx_tmp19,_hx_tmp20,_hx_tmp21,_hx_tmp22);
            							}
            							else {
HXLINE(1133)								if (hx::IsEq( type,::openfl::_internal::renderer::DrawCommandType_obj::BEGIN_GRADIENT_FILL_dyn() )) {
HXLINE(1135)									{
HXLINE(1135)										Int _hx_tmp23 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(1135)										switch((int)(_hx_tmp23)){
            											case (int)0: {
...
HXLINE(1136)									Int _hx_tmp24 = (c1->iiPos + (int)1);
HXDLIN(1136)									Int _hx_tmp25 = (c1->oPos + (int)1);
HXDLIN(1136)									Int _hx_tmp26 = (c1->oPos + (int)2);
HXDLIN(1136)									Int _hx_tmp27 = (c1->oPos + (int)3);
...
HXLINE(1137)									Int _hx_tmp28 = (c1->iiPos + (int)1);
HXDLIN(1137)									Int _hx_tmp29 = (c1->oPos + (int)1);
HXDLIN(1137)									Int _hx_tmp30 = (c1->oPos + (int)2);
HXDLIN(1137)									Int _hx_tmp31 = (c1->oPos + (int)3);
...
HXLINE(1141)									{
HXLINE(1141)										Int _hx_tmp32 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(1141)										switch((int)(_hx_tmp32)){
            											case (int)0: {
...
HXLINE(1142)									Int _hx_tmp33 = c2->buffer->i->__get(c2->iPos);
HXDLIN(1142)									Float _hx_tmp34 = c2->buffer->f->__get(c2->fPos);
HXDLIN(1142)									::openfl::_internal::renderer::cairo::CairoGraphics_obj::fillCommands->beginFill(_hx_tmp33,_hx_tmp34);
HXLINE(1143)									Int _hx_tmp35 = c2->buffer->i->__get(c2->iPos);
HXDLIN(1143)									Float _hx_tmp36 = c2->buffer->f->__get(c2->fPos);
HXDLIN(1143)									::openfl::_internal::renderer::cairo::CairoGraphics_obj::strokeCommands->beginFill(_hx_tmp35,_hx_tmp36);
            								}
            							}
            						}
            						break;
            						case (int)3: {
HXLINE(1077)							{
HXLINE(1077)								Int _hx_tmp37 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(1077)								switch((int)(_hx_tmp37)){
            									case (int)0: {
...
HXLINE(1078)							Float _hx_tmp38 = c3->buffer->f->__get(c3->fPos);
HXDLIN(1078)							Float _hx_tmp39 = c3->buffer->f->__get((c3->fPos + (int)1));
HXDLIN(1078)							Float _hx_tmp40 = c3->buffer->f->__get((c3->fPos + (int)2));
HXDLIN(1078)							Float _hx_tmp41 = c3->buffer->f->__get((c3->fPos + (int)3));
HXDLIN(1078)							Float _hx_tmp42 = c3->buffer->f->__get((c3->fPos + (int)4));
HXDLIN(1078)							Float _hx_tmp43 = c3->buffer->f->__get((c3->fPos + (int)5));
HXDLIN(1078)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::fillCommands->cubicCurveTo(_hx_tmp38,_hx_tmp39,_hx_tmp40,_hx_tmp41,_hx_tmp42,_hx_tmp43);
HXLINE(1079)							Float _hx_tmp44 = c3->buffer->f->__get(c3->fPos);
HXDLIN(1079)							Float _hx_tmp45 = c3->buffer->f->__get((c3->fPos + (int)1));
HXDLIN(1079)							Float _hx_tmp46 = c3->buffer->f->__get((c3->fPos + (int)2));
HXDLIN(1079)							Float _hx_tmp47 = c3->buffer->f->__get((c3->fPos + (int)3));
HXDLIN(1079)							Float _hx_tmp48 = c3->buffer->f->__get((c3->fPos + (int)4));
HXDLIN(1079)							Float _hx_tmp49 = c3->buffer->f->__get((c3->fPos + (int)5));
HXDLIN(1079)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::strokeCommands->cubicCurveTo(_hx_tmp44,_hx_tmp45,_hx_tmp46,_hx_tmp47,_hx_tmp48,_hx_tmp49);
            						}
            						break;
            						case (int)4: {
HXLINE(1083)							{
HXLINE(1083)								Int _hx_tmp50 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(1083)								switch((int)(_hx_tmp50)){
            									case (int)0: {
...
HXLINE(1084)							Float _hx_tmp51 = c4->buffer->f->__get(c4->fPos);
HXDLIN(1084)							Float _hx_tmp52 = c4->buffer->f->__get((c4->fPos + (int)1));
HXDLIN(1084)							Float _hx_tmp53 = c4->buffer->f->__get((c4->fPos + (int)2));
HXDLIN(1084)							Float _hx_tmp54 = c4->buffer->f->__get((c4->fPos + (int)3));
HXDLIN(1084)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::fillCommands->curveTo(_hx_tmp51,_hx_tmp52,_hx_tmp53,_hx_tmp54);
HXLINE(1085)							Float _hx_tmp55 = c4->buffer->f->__get(c4->fPos);
HXDLIN(1085)							Float _hx_tmp56 = c4->buffer->f->__get((c4->fPos + (int)1));
HXDLIN(1085)							Float _hx_tmp57 = c4->buffer->f->__get((c4->fPos + (int)2));
HXDLIN(1085)							Float _hx_tmp58 = c4->buffer->f->__get((c4->fPos + (int)3));
HXDLIN(1085)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::strokeCommands->curveTo(_hx_tmp55,_hx_tmp56,_hx_tmp57,_hx_tmp58);
            						}
            						break;
            						case (int)5: {
HXLINE(1149)							{
HXLINE(1149)								Int _hx_tmp59 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(1149)								switch((int)(_hx_tmp59)){
            									case (int)0: {
...
HXLINE(1150)							Float _hx_tmp60 = c5->buffer->f->__get(c5->fPos);
HXDLIN(1150)							Float _hx_tmp61 = c5->buffer->f->__get((c5->fPos + (int)1));
HXDLIN(1150)							Float _hx_tmp62 = c5->buffer->f->__get((c5->fPos + (int)2));
HXDLIN(1150)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::fillCommands->drawCircle(_hx_tmp60,_hx_tmp61,_hx_tmp62);
HXLINE(1151)							Float _hx_tmp63 = c5->buffer->f->__get(c5->fPos);
HXDLIN(1151)							Float _hx_tmp64 = c5->buffer->f->__get((c5->fPos + (int)1));
HXDLIN(1151)							Float _hx_tmp65 = c5->buffer->f->__get((c5->fPos + (int)2));
HXDLIN(1151)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::strokeCommands->drawCircle(_hx_tmp63,_hx_tmp64,_hx_tmp65);
            						}
            						break;
            						case (int)6: {
HXLINE(1155)							{
HXLINE(1155)								Int _hx_tmp66 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(1155)								switch((int)(_hx_tmp66)){
            									case (int)0: {
...
HXLINE(1156)							Float _hx_tmp67 = c6->buffer->f->__get(c6->fPos);
HXDLIN(1156)							Float _hx_tmp68 = c6->buffer->f->__get((c6->fPos + (int)1));
HXDLIN(1156)							Float _hx_tmp69 = c6->buffer->f->__get((c6->fPos + (int)2));
HXDLIN(1156)							Float _hx_tmp70 = c6->buffer->f->__get((c6->fPos + (int)3));
HXDLIN(1156)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::fillCommands->drawEllipse(_hx_tmp67,_hx_tmp68,_hx_tmp69,_hx_tmp70);
HXLINE(1157)							Float _hx_tmp71 = c6->buffer->f->__get(c6->fPos);
HXDLIN(1157)							Float _hx_tmp72 = c6->buffer->f->__get((c6->fPos + (int)1));
HXDLIN(1157)							Float _hx_tmp73 = c6->buffer->f->__get((c6->fPos + (int)2));
HXDLIN(1157)							Float _hx_tmp74 = c6->buffer->f->__get((c6->fPos + (int)3));
HXDLIN(1157)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::strokeCommands->drawEllipse(_hx_tmp71,_hx_tmp72,_hx_tmp73,_hx_tmp74);
            						}
            						break;
            						case (int)7: {
HXLINE(1161)							{
HXLINE(1161)								Int _hx_tmp75 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(1161)								switch((int)(_hx_tmp75)){
            									case (int)0: {
...
HXLINE(1162)							Float _hx_tmp76 = c7->buffer->f->__get(c7->fPos);
HXDLIN(1162)							Float _hx_tmp77 = c7->buffer->f->__get((c7->fPos + (int)1));
HXDLIN(1162)							Float _hx_tmp78 = c7->buffer->f->__get((c7->fPos + (int)2));
HXDLIN(1162)							Float _hx_tmp79 = c7->buffer->f->__get((c7->fPos + (int)3));
HXDLIN(1162)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::fillCommands->drawRect(_hx_tmp76,_hx_tmp77,_hx_tmp78,_hx_tmp79);
HXLINE(1163)							Float _hx_tmp80 = c7->buffer->f->__get(c7->fPos);
HXDLIN(1163)							Float _hx_tmp81 = c7->buffer->f->__get((c7->fPos + (int)1));
HXDLIN(1163)							Float _hx_tmp82 = c7->buffer->f->__get((c7->fPos + (int)2));
HXDLIN(1163)							Float _hx_tmp83 = c7->buffer->f->__get((c7->fPos + (int)3));
HXDLIN(1163)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::strokeCommands->drawRect(_hx_tmp80,_hx_tmp81,_hx_tmp82,_hx_tmp83);
            						}
            						break;
            						case (int)8: {
HXLINE(1167)							{
HXLINE(1167)								Int _hx_tmp84 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(1167)								switch((int)(_hx_tmp84)){
            									case (int)0: {
...
HXLINE(1168)							Float _hx_tmp85 = c8->buffer->f->__get(c8->fPos);
HXDLIN(1168)							Float _hx_tmp86 = c8->buffer->f->__get((c8->fPos + (int)1));
HXDLIN(1168)							Float _hx_tmp87 = c8->buffer->f->__get((c8->fPos + (int)2));
HXDLIN(1168)							Float _hx_tmp88 = c8->buffer->f->__get((c8->fPos + (int)3));
HXDLIN(1168)							Float _hx_tmp89 = c8->buffer->f->__get((c8->fPos + (int)4));
HXDLIN(1168)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::fillCommands->drawRoundRect(_hx_tmp85,_hx_tmp86,_hx_tmp87,_hx_tmp88,_hx_tmp89,c8->buffer->o->__get(c8->oPos));
HXLINE(1169)							Float _hx_tmp90 = c8->buffer->f->__get(c8->fPos);
HXDLIN(1169)							Float _hx_tmp91 = c8->buffer->f->__get((c8->fPos + (int)1));
HXDLIN(1169)							Float _hx_tmp92 = c8->buffer->f->__get((c8->fPos + (int)2));
HXDLIN(1169)							Float _hx_tmp93 = c8->buffer->f->__get((c8->fPos + (int)3));
HXDLIN(1169)							Float _hx_tmp94 = c8->buffer->f->__get((c8->fPos + (int)4));
HXDLIN(1169)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::strokeCommands->drawRoundRect(_hx_tmp90,_hx_tmp91,_hx_tmp92,_hx_tmp93,_hx_tmp94,c8->buffer->o->__get(c8->oPos));
            						}
            						break;
            						case (int)10: {
HXLINE(1173)							{
HXLINE(1173)								Int _hx_tmp95 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(1173)								switch((int)(_hx_tmp95)){
            									case (int)0: {
...
HXLINE(1174)							Int _hx_tmp96 = (c9->oPos + (int)1);
HXDLIN(1174)							Int _hx_tmp97 = (c9->oPos + (int)2);
HXDLIN(1174)							Int _hx_tmp98 = (c9->oPos + (int)3);
HXDLIN(1174)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::fillCommands->drawTriangles(( ( ::openfl::_Vector::FloatVector)(c9->buffer->o->__get(c9->oPos)) ),( ( ::openfl::_Vector::IntVector)(c9->buffer->o->__get(_hx_tmp96)) ),( ( ::openfl::_Vector::FloatVector)(c9->buffer->o->__get(_hx_tmp97)) ),c9->buffer->o->__get(_hx_tmp98));
            						}
            						break;
            						case (int)11: {
HXLINE(1101)							{
HXLINE(1101)								{
HXLINE(1101)									Int _hx_tmp99 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(1101)									switch((int)(_hx_tmp99)){
            										case (int)0: {
...
HXLINE(1105)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::bitmapFill = null();
            						...
            						case (int)12: {
HXLINE(1114)							{
HXLINE(1114)								Int _hx_tmp100 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(1114)								switch((int)(_hx_tmp100)){
            									case (int)0: {
...
HXLINE(1115)							Int _hx_tmp101 = (c10->oPos + (int)1);
HXDLIN(1115)							Int _hx_tmp102 = (c10->bPos + (int)1);
HXDLIN(1115)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::strokeCommands->lineBitmapStyle(( ( ::openfl::display::BitmapData)(c10->buffer->o->__get(c10->oPos)) ),( ( ::openfl::geom::Matrix)(c10->buffer->o->__get(_hx_tmp101)) ),c10->buffer->b->__get(c10->bPos),c10->buffer->b->__get(_hx_tmp102));
            						}
            						break;
            						case (int)13: {
HXLINE(1109)							{
HXLINE(1109)								Int _hx_tmp103 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(1109)								switch((int)(_hx_tmp103)){
            									case (int)0: {
...
HXLINE(1110)							Int _hx_tmp104 = (c11->iiPos + (int)1);
HXDLIN(1110)							Int _hx_tmp105 = (c11->oPos + (int)1);
HXDLIN(1110)							Int _hx_tmp106 = (c11->oPos + (int)2);
HXDLIN(1110)							Int _hx_tmp107 = (c11->oPos + (int)3);
HXDLIN(1110)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::strokeCommands->lineGradientStyle(c11->buffer->o->__get(c11->oPos),c11->buffer->ii->__get(c11->iiPos).StaticCast< ::Array< Int > >(),c11->buffer->ff->__get(c11->ffPos).StaticCast< ::Array< Float > >(),c11->buffer->ii->__get(_hx_tmp104).StaticCast< ::Array< Int > >(),( ( ::openfl::geom::Matrix)(c11->buffer->o->__get(_hx_tmp105)) ),c11->buffer->o->__get(_hx_tmp106),c11->buffer->o->__get(_hx_tmp107),c11->buffer->f->__get(c11->fPos));
            						...
            						case (int)14: {
HXLINE(1119)							{
HXLINE(1119)								Int _hx_tmp108 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(1119)								switch((int)(_hx_tmp108)){
            									case (int)0: {
...
HXLINE(1120)							Int _hx_tmp109 = (c12->oPos + (int)1);
HXDLIN(1120)							Int _hx_tmp110 = (c12->oPos + (int)2);
HXDLIN(1120)							Int _hx_tmp111 = (c12->oPos + (int)3);
HXDLIN(1120)							Int _hx_tmp112 = (c12->fPos + (int)1);
HXDLIN(1120)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::strokeCommands->lineStyle(c12->buffer->o->__get(c12->oPos),c12->buffer->i->__get(c12->iPos),c12->buffer->f->__get(c12->fPos),c12->buffer->b->__get(c12->bPos),c12->buffer->o->__get(_hx_tmp109),c12->buffer->o->__get(_hx_tmp110),c12->buffer->o->__get(_hx_tmp111),c12->buffer->f->__get(_hx_tmp112));
            						}
            						break;
            						case (int)15: {
HXLINE(1089)							{
HXLINE(1089)								Int _hx_tmp113 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(1089)								switch((int)(_hx_tmp113)){
            									case (int)0: {
...
HXLINE(1090)							Float _hx_tmp114 = c13->buffer->f->__get(c13->fPos);
HXDLIN(1090)							Float _hx_tmp115 = c13->buffer->f->__get((c13->fPos + (int)1));
HXDLIN(1090)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::fillCommands->lineTo(_hx_tmp114,_hx_tmp115);
HXLINE(1091)							Float _hx_tmp116 = c13->buffer->f->__get(c13->fPos);
HXDLIN(1091)							Float _hx_tmp117 = c13->buffer->f->__get((c13->fPos + (int)1));
HXDLIN(1091)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::strokeCommands->lineTo(_hx_tmp116,_hx_tmp117);
            						}
            						break;
            						case (int)16: {
HXLINE(1095)							{
HXLINE(1095)								Int _hx_tmp118 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(1095)								switch((int)(_hx_tmp118)){
            									case (int)0: {
...
HXLINE(1096)							Float _hx_tmp119 = c14->buffer->f->__get(c14->fPos);
HXDLIN(1096)							Float _hx_tmp120 = c14->buffer->f->__get((c14->fPos + (int)1));
HXDLIN(1096)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::fillCommands->moveTo(_hx_tmp119,_hx_tmp120);
HXLINE(1097)							Float _hx_tmp121 = c14->buffer->f->__get(c14->fPos);
HXDLIN(1097)							Float _hx_tmp122 = c14->buffer->f->__get((c14->fPos + (int)1));
HXDLIN(1097)							::openfl::_internal::renderer::cairo::CairoGraphics_obj::strokeCommands->moveTo(_hx_tmp121,_hx_tmp122);
            						}
            						break;
            						default:{
HXLINE(1178)							{
HXLINE(1178)								Int _hx_tmp123 = ( ( ::hx::EnumBase)(data->prev) )->_hx_getIndex();
HXDLIN(1178)								switch((int)(_hx_tmp123)){
            									case (int)0: {
...
HXLINE(1184)			Int _hx_tmp124 = ::openfl::_internal::renderer::cairo::CairoGraphics_obj::fillCommands->get_length();
HXDLIN(1184)			if ((_hx_tmp124 > (int)0)) {
HXLINE(1186)				::openfl::_internal::renderer::cairo::CairoGraphics_obj::endFill();
            			}
HXLINE(1190)			Int _hx_tmp125 = ::openfl::_internal::renderer::cairo::CairoGraphics_obj::strokeCommands->get_length();
HXDLIN(1190)			if ((_hx_tmp125 > (int)0)) {
