...
HXLINE(  48)			{
HXLINE(  48)				::lime::graphics::opengl::GL_obj::_hx___currentProgram = null();
HXDLIN(  48)				{
HXLINE(  48)					 ::Dynamic program = null();
HXDLIN(  48)					::lime::graphics::opengl::GL_obj::cffi_lime_gl_use_program(hx::DynamicPtr(program));
            				}
            			}
HXLINE(  49)			return;
            		}
...
HXLINE(  62)		{
HXLINE(  62)			HX_VARI_NAME(  ::lime::graphics::opengl::GLProgram,program1,"program") = shader->glProgram;
HXDLIN(  62)			{
HXLINE(  62)				::lime::graphics::opengl::GL_obj::_hx___currentProgram = program1;
HXDLIN(  62)				{
HXLINE(  62)					 ::Dynamic program2;
HXDLIN(  62)					Bool _hx_tmp4 = hx::IsNull( program1 );
HXDLIN(  62)					if (_hx_tmp4) {
HXLINE(  62)						program2 = null();
            					}
            					else {
HXLINE(  62)						program2 = program1->id;
            					}
HXDLIN(  62)					::lime::graphics::opengl::GL_obj::cffi_lime_gl_use_program(hx::DynamicPtr(program2));
            				}
            			}
            		}
