...
HXDLIN( 642)				this->b[pos] = value;
            			}
HXLINE( 643)			{
HXLINE( 643)				Int pos1 = this->position++;
HXDLIN( 643)				this->b[pos1] = ((int)value >> (int)(int)8);
            			}
HXLINE( 644)			{
HXLINE( 644)				Int pos2 = this->position++;
HXDLIN( 644)				this->b[pos2] = ((int)value >> (int)(int)16);
            			}
HXLINE( 645)			{
HXLINE( 645)				Int pos3 = this->position++;
HXDLIN( 645)				this->b[pos3] = ((int)value >> (int)(int)24);
            			}
            		}
            		else {
HXLINE( 649)			{
HXLINE( 649)				Int pos4 = this->position++;
HXDLIN( 649)				this->b[pos4] = ((int)value >> (int)(int)24);
            			}
HXLINE( 650)			{
HXLINE( 650)				Int pos5 = this->position++;
HXDLIN( 650)				this->b[pos5] = ((int)value >> (int)(int)16);
            			}
HXLINE( 651)			{
HXLINE( 651)				Int pos6 = this->position++;
HXDLIN( 651)				this->b[pos6] = ((int)value >> (int)(int)8);
            			}
HXLINE( 652)			{
HXLINE( 652)				Int pos7 = this->position++;
HXDLIN( 652)				this->b[pos7] = value;
            			}
            		}
            	}
