...
void OpenGLView_obj::_hx___renderGL( ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl.display.OpenGLView","__renderGL",0x34d59d2b,"openfl.display.OpenGLView.__renderGL","openfl/display/OpenGLView.hx",182,0x7a9fe7de)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(renderSession,"renderSession")
HXLINE( 182)		Bool _hx_tmp;
HXDLIN( 182)		Bool _hx_tmp1 = hx::IsNotNull( this->stage );
HXDLIN( 182)		if (_hx_tmp1) {
HXLINE( 182)			_hx_tmp = this->_hx___renderable;
            		}
            		else {
HXLINE( 182)			_hx_tmp = false;
            		}
HXDLIN( 182)		if (_hx_tmp) {
HXLINE( 184)			HX_VARI(  ::openfl::geom::Rectangle,rect) = null();
HXLINE( 186)			Bool _hx_tmp2 = hx::IsNull( this->_hx___scrollRect );
HXDLIN( 186)			if (_hx_tmp2) {
HXLINE( 188)				rect =  ::openfl::geom::Rectangle_obj::__new((int)0,(int)0,this->stage->stageWidth,this->stage->stageHeight);
            			}
            			else {
HXLINE( 192)				Float _hx_tmp3 = this->get_x();
HXDLIN( 192)				Float _hx_tmp4 = (_hx_tmp3 + this->_hx___scrollRect->x);
HXDLIN( 192)				Float _hx_tmp5 = this->get_y();
HXDLIN( 192)				rect =  ::openfl::geom::Rectangle_obj::__new(_hx_tmp4,(_hx_tmp5 + this->_hx___scrollRect->y),this->_hx___scrollRect->width,this->_hx___scrollRect->height);
            			}
HXLINE( 196)			renderSession->shaderManager->setShader(null());
HXLINE( 197)			renderSession->blendModeManager->setBlendMode(null());
HXLINE( 199)			Bool _hx_tmp6 = hx::IsNotNull( this->_hx___render );
HXDLIN( 199)			if (_hx_tmp6) {
HXLINE( 199)				this->_hx___render(rect);
            			}
            		}
            	}
