...
void DefaultPreloader_obj::__construct(){
            	HX_STACK_FRAME("openfl.display.DefaultPreloader","new",0xd9ecb051,"openfl.display.DefaultPreloader.new","openfl/display/Preloader.hx",138,0xc399db74)
            	HX_STACK_THIS(this)
HXLINE( 140)		super::__construct();
HXLINE( 142)		HX_VARI( Int,backgroundColor) = this->getBackgroundColor();
HXLINE( 146)		HX_VARI( Float,perceivedLuminosity) = (((((Float)0.299) * ((int)((int)backgroundColor >> (int)(int)16) & (int)(int)255)) + (((Float)0.587) * ((int)((int)backgroundColor >> (int)(int)8) & (int)(int)255))) + (((Float)0.114) * ((int)backgroundColor & (int)(int)255)));
HXLINE( 147)		HX_VARI( Int,color) = (int)0;
HXLINE( 149)		if ((perceivedLuminosity < (int)70)) {
HXLINE( 151)			color = (int)16777215;
            		}
HXLINE( 157)		Float _hx_tmp = this->getHeight();
HXDLIN( 157)		HX_VARI( Float,y) = (((Float)_hx_tmp / (Float)(int)2) - ((Float)3.5));
HXLINE( 158)		Float _hx_tmp1 = this->getWidth();
HXDLIN( 158)		HX_VARI( Float,width) = (_hx_tmp1 - (int)60);
HXLINE( 162)		this->outline =  ::openfl::display::Sprite_obj::__new();
HXLINE( 163)		this->outline->get_graphics()->beginFill(color,((Float)0.07));
HXLINE( 164)		this->outline->get_graphics()->drawRect((int)0,(int)0,width,(int)7);
HXLINE( 165)		this->outline->set_x((int)30);
HXLINE( 166)		this->outline->set_y(y);
HXLINE( 167)		this->outline->set_alpha((int)0);
HXLINE( 168)		this->addChild(this->outline);
HXLINE( 170)		this->progress =  ::openfl::display::Sprite_obj::__new();
HXLINE( 171)		this->progress->get_graphics()->beginFill(color,((Float)0.35));
HXLINE( 172)		 ::openfl::display::Graphics _hx_tmp2 = this->progress->get_graphics();
HXDLIN( 172)		_hx_tmp2->drawRect((int)0,(int)0,(width - (int)4),(int)3);
HXLINE( 173)		this->progress->set_x((int)32);
HXLINE( 174)		this->progress->set_y((y + (int)2));
HXLINE( 175)		this->progress->set_scaleX((int)0);
HXLINE( 176)		this->progress->set_alpha((int)0);
HXLINE( 177)		this->addChild(this->progress);
HXLINE( 179)		Int _hx_tmp3 = ::openfl::Lib_obj::getTimer();
HXDLIN( 179)		this->startAnimation = (_hx_tmp3 + (int)100);
HXLINE( 180)		this->endAnimation = (this->startAnimation + (int)1000);
            	}
...
Int DefaultPreloader_obj::getBackgroundColor(){
            	HX_STACK_FRAME("openfl.display.DefaultPreloader","getBackgroundColor",0xe99da5ce,"openfl.display.DefaultPreloader.getBackgroundColor","openfl/display/Preloader.hx",187,0xc399db74)
            	HX_STACK_THIS(this)
HXLINE( 187)		return ::openfl::Lib_obj::current->stage->window->config->__Field(HX_("background",ee,93,1d,26),hx::paccDynamic);
            	}
...
Float DefaultPreloader_obj::getHeight(){
            	HX_STACK_FRAME("openfl.display.DefaultPreloader","getHeight",0xf2617bce,"openfl.display.DefaultPreloader.getHeight","openfl/display/Preloader.hx",192,0xc399db74)
            	HX_STACK_THIS(this)
HXLINE( 194)		HX_VARI(  ::Dynamic,height) = ::openfl::Lib_obj::current->stage->window->config->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic);
HXLINE( 196)		if (hx::IsGreater( height,(int)0 )) {
HXLINE( 198)			return height;
            		}
            		else {
HXLINE( 202)			return ::openfl::Lib_obj::current->stage->stageHeight;
            		}
...
Float DefaultPreloader_obj::getWidth(){
            	HX_STACK_FRAME("openfl.display.DefaultPreloader","getWidth",0x7b1a7bff,"openfl.display.DefaultPreloader.getWidth","openfl/display/Preloader.hx",209,0xc399db74)
            	HX_STACK_THIS(this)
HXLINE( 211)		HX_VARI(  ::Dynamic,width) = ::openfl::Lib_obj::current->stage->window->config->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic);
HXLINE( 213)		if (hx::IsGreater( width,(int)0 )) {
HXLINE( 215)			return width;
            		}
            		else {
HXLINE( 219)			return ::openfl::Lib_obj::current->stage->stageWidth;
            		}
...
void DefaultPreloader_obj::onInit(){
            	HX_STACK_FRAME("openfl.display.DefaultPreloader","onInit",0x238e307e,"openfl.display.DefaultPreloader.onInit","openfl/display/Preloader.hx",228,0xc399db74)
            	HX_STACK_THIS(this)
HXLINE( 228)		this->addEventListener(HX_("enterFrame",f5,03,50,02),this->this_onEnterFrame_dyn(),null(),null(),null());
            	}
...
void DefaultPreloader_obj::onLoaded(){
            	HX_STACK_FRAME("openfl.display.DefaultPreloader","onLoaded",0x88fcf4f3,"openfl.display.DefaultPreloader.onLoaded","openfl/display/Preloader.hx",233,0xc399db74)
            	HX_STACK_THIS(this)
HXLINE( 235)		this->removeEventListener(HX_("enterFrame",f5,03,50,02),this->this_onEnterFrame_dyn(),null());
HXLINE( 236)		this->dispatchEvent( ::openfl::events::Event_obj::__new(HX_("complete",b9,00,c8,7f),null(),null()));
            	}
...
void DefaultPreloader_obj::onUpdate(Int bytesLoaded,Int bytesTotal){
            	HX_STACK_FRAME("openfl.display.DefaultPreloader","onUpdate",0xb79332f7,"openfl.display.DefaultPreloader.onUpdate","openfl/display/Preloader.hx",241,0xc399db74)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(bytesLoaded,"bytesLoaded")
            	HX_STACK_ARG(bytesTotal,"bytesTotal")
HXLINE( 243)		HX_VARI( Float,percentLoaded) = ((Float)bytesLoaded / (Float)bytesTotal);
HXLINE( 245)		Bool _hx_tmp = (percentLoaded > (int)1);
HXDLIN( 245)		if (_hx_tmp) {
HXLINE( 247)			percentLoaded = (int)1;
            		}
HXLINE( 251)		this->progress->set_scaleX(percentLoaded);
            	}
...
void DefaultPreloader_obj::this_onEnterFrame( ::openfl::events::Event event){
            	HX_STACK_FRAME("openfl.display.DefaultPreloader","this_onEnterFrame",0x72c19366,"openfl.display.DefaultPreloader.this_onEnterFrame","openfl/display/Preloader.hx",263,0xc399db74)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(event,"event")
HXLINE( 265)		Int _hx_tmp = ::openfl::Lib_obj::getTimer();
HXLINE( 268)		HX_VARI( Float,percent) = ((Float)(_hx_tmp - this->startAnimation) / (Float)(this->endAnimation - this->startAnimation));
HXLINE( 270)		Bool _hx_tmp1 = (percent < (int)0);
HXDLIN( 270)		if (_hx_tmp1) {
HXLINE( 270)			percent = (int)0;
            		}
HXLINE( 271)		Bool _hx_tmp2 = (percent > (int)1);
HXDLIN( 271)		if (_hx_tmp2) {
HXLINE( 271)			percent = (int)1;
            		}
HXLINE( 273)		this->outline->set_alpha(percent);
HXLINE( 274)		this->progress->set_alpha(percent);
            	}
