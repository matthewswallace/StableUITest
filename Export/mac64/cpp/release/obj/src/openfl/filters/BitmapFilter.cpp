...
Dynamic BitmapFilter_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::filters::BitmapFilter BitmapFilter_obj::clone(){
            	HX_STACK_FRAME("openfl.filters.BitmapFilter","clone",0x8c417bc7,"openfl.filters.BitmapFilter.clone","openfl/filters/BitmapFilter.hx",23,0x1697f5a4)
            	HX_STACK_THIS(this)
HXLINE(  23)		return  ::openfl::filters::BitmapFilter_obj::__new();
            	}
...
HX_DEFINE_DYNAMIC_FUNC4(BitmapFilter_obj,_hx___applyFilter,(void))
 ...
 ::openfl::display::Shader BitmapFilter_obj::_hx___initShader( ::openfl::_internal::renderer::RenderSession renderSession){
            	HX_STACK_FRAME("openfl.filters.BitmapFilter","__initShader",0x9b1b6e4b,"openfl.filters.BitmapFilter.__initShader","openfl/filters/BitmapFilter.hx",37,0x1697f5a4)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(renderSession,"renderSession")
HXLINE(  37)		return renderSession->shaderManager->defaultShader;
            	}


HX_DEFINE_DYNAMIC_FUNC1(BitmapFilter_obj,_hx___initShader,return )
...
#if HXCPP_SCRIPTABLE
static hx::StorageInfo *BitmapFilter_obj_sMemberStorageInfo = 0;
