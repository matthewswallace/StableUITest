...
void ListIterator_obj::__construct( ::_List::ListNode head){
            	HX_STACK_FRAME("_List.ListIterator","new",0x1ee472af,"_List.ListIterator.new","/usr/local/lib/haxe/std/List.hx",269,0xdb880ee3)
            	HX_STACK_THIS(this)
...
Bool ListIterator_obj::hasNext(){
            	HX_STACK_FRAME("_List.ListIterator","hasNext",0x25781b3c,"_List.ListIterator.hasNext","/usr/local/lib/haxe/std/List.hx",273,0xdb880ee3)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(ListIterator_obj,hasNext,return )
 ...
 ::Dynamic ListIterator_obj::next(){
            	HX_STACK_FRAME("_List.ListIterator","next",0xe8ffe7c4,"_List.ListIterator.next","/usr/local/lib/haxe/std/List.hx",276,0xdb880ee3)
            	HX_STACK_THIS(this)
