...
HX_DEFINE_DYNAMIC_FUNC1(EReg_obj,matched,return )
 ...
 ::Dynamic EReg_obj::matchedPos(){
            	HX_STACK_FRAME("EReg","matchedPos",0x7007a70f,"EReg.matchedPos","/usr/local/lib/haxe/std/cpp/_std/EReg.hx",64,0x5a2fdacd)
            	HX_STACK_THIS(this)
...
Int len = __o_len.Default(-1);
            	HX_STACK_FRAME("EReg","matchSub",0xbc75cb7a,"EReg.matchSub","/usr/local/lib/haxe/std/cpp/_std/EReg.hx",67,0x5a2fdacd)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
