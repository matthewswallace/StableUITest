...
HXLINE( 372)		::lime::graphics::utils::ImageCanvasUtil_obj::convertToCanvas(image,true);
HXLINE( 374)		 ::Dynamic(image->buffer->_hx___srcContext->__Field(HX_("clearRect",51,35,68,bf),hx::paccDynamic))(x,y,image->width,image->height);
HXLINE( 375)		 ::Dynamic(image->buffer->_hx___srcContext->__Field(HX_("drawImage",b7,54,74,85),hx::paccDynamic))(image->buffer->_hx___srcCanvas,x,y);
...
void ImageCanvasUtil_obj::setPixel( ::lime::graphics::Image image,Int x,Int y,Int color,Int format){
            	...
            	HX_STACK_ARG(color,"color")
            	HX_STACK_ARG(format,"format")
HXLINE( 385)		::lime::graphics::utils::ImageCanvasUtil_obj::convertToData(image,null());
HXLINE( 387)		::lime::graphics::utils::ImageDataUtil_obj::setPixel(image,x,y,color,format);
            	}
...
void ImageCanvasUtil_obj::setPixel32( ::lime::graphics::Image image,Int x,Int y,Int color,Int format){
            	...
            	HX_STACK_ARG(color,"color")
            	HX_STACK_ARG(format,"format")
HXLINE( 394)		::lime::graphics::utils::ImageCanvasUtil_obj::convertToData(image,null());
HXLINE( 396)		::lime::graphics::utils::ImageDataUtil_obj::setPixel32(image,x,y,color,format);
            	}
...
void ImageCanvasUtil_obj::setPixels( ::lime::graphics::Image image, ::lime::math::Rectangle rect, ::haxe::io::Bytes bytes,Int format){
            	...
            	HX_STACK_ARG(format,"format")
HXLINE( 403)		::lime::graphics::utils::ImageCanvasUtil_obj::convertToData(image,null());
HXLINE( 405)		::lime::graphics::utils::ImageDataUtil_obj::setPixels(image,rect,bytes,format);
            	}
