...
HXLINE( 375)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_active_texture(texture);
            	}
...
HXLINE( 382)		program->attach(shader);
HXDLIN( 382)		{
HXLINE( 382)			 ::Dynamic program1 = program->id;
HXDLIN( 382)			 ::Dynamic shader1 = shader->id;
HXDLIN( 382)			 ::hx::Object * _hx_tmp = hx::DynamicPtr(program1);
HXDLIN( 382)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_attach_shader(_hx_tmp,hx::DynamicPtr(shader1));
            		}
            	}
...
HXLINE( 389)		 ::Dynamic program1 = program->id;
HXDLIN( 389)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_attrib_location(hx::DynamicPtr(program1),index,name);
            	}
...
HXLINE( 396)		 ::Dynamic buffer1;
HXDLIN( 396)		Bool _hx_tmp = hx::IsNull( buffer );
HXDLIN( 396)		if (_hx_tmp) {
HXLINE( 396)			buffer1 = null();
            		}
            		else {
HXLINE( 396)			buffer1 = buffer->id;
            		}
HXDLIN( 396)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_buffer(target,hx::DynamicPtr(buffer1));
            	}
...
HXLINE( 403)		 ::Dynamic framebuffer1;
HXDLIN( 403)		Bool _hx_tmp = hx::IsNull( framebuffer );
HXDLIN( 403)		if (_hx_tmp) {
HXLINE( 403)			framebuffer1 = null();
            		}
            		else {
HXLINE( 403)			framebuffer1 = framebuffer->id;
            		}
HXDLIN( 403)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_framebuffer(target,hx::DynamicPtr(framebuffer1));
            	}
...
HXLINE( 410)		 ::Dynamic renderbuffer1;
HXDLIN( 410)		Bool _hx_tmp = hx::IsNull( renderbuffer );
HXDLIN( 410)		if (_hx_tmp) {
HXLINE( 410)			renderbuffer1 = null();
            		}
            		else {
HXLINE( 410)			renderbuffer1 = renderbuffer->id;
            		}
HXDLIN( 410)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_renderbuffer(target,hx::DynamicPtr(renderbuffer1));
            	}
...
void GLRenderContext_obj::bindTexture(Int target, ::lime::graphics::opengl::GLTexture texture){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(texture,"texture")
HXLINE( 417)		 ::Dynamic texture1;
HXDLIN( 417)		Bool _hx_tmp = hx::IsNull( texture );
HXDLIN( 417)		if (_hx_tmp) {
HXLINE( 417)			texture1 = null();
            		}
            		else {
HXLINE( 417)			texture1 = texture->id;
            		}
HXDLIN( 417)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_texture(target,hx::DynamicPtr(texture1));
            	}
...
HXLINE( 424)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_color(red,green,blue,alpha);
            	}
...
HXLINE( 431)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_equation(mode);
            	}
...
HXLINE( 438)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_equation_separate(modeRGB,modeAlpha);
            	}
...
HXLINE( 445)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_func(sfactor,dfactor);
            	}
...
HXLINE( 452)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_func_separate(srcRGB,dstRGB,srcAlpha,dstAlpha);
            	}
...
HXLINE( 459)		Int byteOffset = data->byteOffset;
HXDLIN( 459)		Int size = data->byteLength;
HXDLIN( 459)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_buffer_data(target,hx::DynamicPtr(data->buffer),byteOffset,size,usage);
            	}
...
void GLRenderContext_obj::bufferSubData(Int target,Int offset, ::lime::utils::ArrayBufferView data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 466)		Int byteOffset = data->byteOffset;
HXDLIN( 466)		Int size = data->byteLength;
HXDLIN( 466)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_buffer_sub_data(target,offset,hx::DynamicPtr(data->buffer),byteOffset,size);
            	}
...
Int GLRenderContext_obj::checkFramebufferStatus(Int target){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
HXLINE( 473)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_check_framebuffer_status(target)) );
            	}
...
HXLINE( 480)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_clear(mask);
            	}
...
void GLRenderContext_obj::clearColor(Float red,Float green,Float blue,Float alpha){
            	...
            	HX_STACK_ARG(blue,"blue")
            	HX_STACK_ARG(alpha,"alpha")
HXLINE( 487)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_clear_color(red,green,blue,alpha);
            	}
...
HXLINE( 494)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_clear_depth(depth);
            	}
...
void GLRenderContext_obj::clearStencil(Int s){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
HXLINE( 501)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_clear_stencil(s);
            	}
...
void GLRenderContext_obj::colorMask(Bool red,Bool green,Bool blue,Bool alpha){
            	...
            	HX_STACK_ARG(blue,"blue")
            	HX_STACK_ARG(alpha,"alpha")
HXLINE( 508)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_color_mask(red,green,blue,alpha);
            	}
...
void GLRenderContext_obj::compileShader( ::lime::graphics::opengl::GLShader shader){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(shader,"shader")
HXLINE( 515)		 ::Dynamic shader1 = shader->id;
HXDLIN( 515)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_compile_shader(hx::DynamicPtr(shader1));
            	}
...
void GLRenderContext_obj::compressedTexImage2D(Int target,Int level,Int internalformat,Int width,Int height,Int border, ::lime::utils::ArrayBufferView data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 522)		HX_VAR(  ::haxe::io::Bytes,buffer);
HXDLIN( 522)		Bool _hx_tmp = hx::IsNull( data );
HXDLIN( 522)		if (_hx_tmp) {
HXLINE( 522)			buffer = null();
            		}
            		else {
HXLINE( 522)			buffer = data->buffer;
            		}
HXDLIN( 522)		{
HXLINE( 522)			Int byteOffset;
HXDLIN( 522)			Bool _hx_tmp1 = hx::IsNull( data );
HXDLIN( 522)			if (_hx_tmp1) {
HXLINE( 522)				byteOffset = (int)0;
            			}
            			else {
HXLINE( 522)				byteOffset = data->byteOffset;
            			}
HXDLIN( 522)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_compressed_tex_image_2d(target,level,internalformat,width,height,border,hx::DynamicPtr(buffer),byteOffset);
            		}
            	}
...
void GLRenderContext_obj::compressedTexSubImage2D(Int target,Int level,Int xoffset,Int yoffset,Int width,Int height,Int format, ::lime::utils::ArrayBufferView data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 529)		HX_VAR(  ::haxe::io::Bytes,buffer);
HXDLIN( 529)		Bool _hx_tmp = hx::IsNull( data );
HXDLIN( 529)		if (_hx_tmp) {
HXLINE( 529)			buffer = null();
            		}
            		else {
HXLINE( 529)			buffer = data->buffer;
            		}
HXDLIN( 529)		{
HXLINE( 529)			Int byteOffset;
HXDLIN( 529)			Bool _hx_tmp1 = hx::IsNull( data );
HXDLIN( 529)			if (_hx_tmp1) {
HXLINE( 529)				byteOffset = (int)0;
            			}
            			else {
HXLINE( 529)				byteOffset = data->byteOffset;
            			}
HXDLIN( 529)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_compressed_tex_sub_image_2d(target,level,xoffset,yoffset,width,height,format,hx::DynamicPtr(buffer),byteOffset);
            		}
            	}
...
void GLRenderContext_obj::copyTexImage2D(Int target,Int level,Int internalformat,Int x,Int y,Int width,Int height,Int border){
            	...
            	HX_STACK_ARG(height,"height")
            	HX_STACK_ARG(border,"border")
HXLINE( 536)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_copy_tex_image_2d(target,level,internalformat,x,y,width,height,border);
            	}
...
void GLRenderContext_obj::copyTexSubImage2D(Int target,Int level,Int xoffset,Int yoffset,Int x,Int y,Int width,Int height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE( 543)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_copy_tex_sub_image_2d(target,level,xoffset,yoffset,x,y,width,height);
            	}
...
HX_DEFINE_DYNAMIC_FUNC8(GLRenderContext_obj,copyTexSubImage2D,(void))
 ...
 ::lime::graphics::opengl::GLBuffer GLRenderContext_obj::createBuffer(){
            	HX_STACK_FRAME("lime.graphics.GLRenderContext","createBuffer",0xcc9d9f60,"lime.graphics.GLRenderContext.createBuffer","lime/graphics/GLRenderContext.hx",550,0xbdd53034)
            	HX_STACK_THIS(this)
HXLINE( 550)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::get_version();
HXDLIN( 550)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_buffer()) );
HXDLIN( 550)		 ::Dynamic _hx_tmp1 = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 550)		return  ::lime::graphics::opengl::GLBuffer_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(GLRenderContext_obj,createBuffer,return )
 ...
 ::lime::graphics::opengl::GLFramebuffer GLRenderContext_obj::createFramebuffer(){
            	HX_STACK_FRAME("lime.graphics.GLRenderContext","createFramebuffer",0xeb0e968d,"lime.graphics.GLRenderContext.createFramebuffer","lime/graphics/GLRenderContext.hx",557,0xbdd53034)
            	HX_STACK_THIS(this)
HXLINE( 557)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::get_version();
HXDLIN( 557)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_framebuffer()) );
HXDLIN( 557)		 ::Dynamic _hx_tmp1 = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 557)		return  ::lime::graphics::opengl::GLFramebuffer_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(GLRenderContext_obj,createFramebuffer,return )
 ...
 ::lime::graphics::opengl::GLProgram GLRenderContext_obj::createProgram(){
            	HX_STACK_FRAME("lime.graphics.GLRenderContext","createProgram",0x7fb67c24,"lime.graphics.GLRenderContext.createProgram","lime/graphics/GLRenderContext.hx",564,0xbdd53034)
            	HX_STACK_THIS(this)
HXLINE( 564)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::get_version();
HXDLIN( 564)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_program()) );
HXDLIN( 564)		 ::Dynamic _hx_tmp1 = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 564)		return  ::lime::graphics::opengl::GLProgram_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(GLRenderContext_obj,createProgram,return )
 ...
 ::lime::graphics::opengl::GLRenderbuffer GLRenderContext_obj::createRenderbuffer(){
            	HX_STACK_FRAME("lime.graphics.GLRenderContext","createRenderbuffer",0x48413736,"lime.graphics.GLRenderContext.createRenderbuffer","lime/graphics/GLRenderContext.hx",571,0xbdd53034)
            	HX_STACK_THIS(this)
HXLINE( 571)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::get_version();
HXDLIN( 571)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_render_buffer()) );
HXDLIN( 571)		 ::Dynamic _hx_tmp1 = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 571)		return  ::lime::graphics::opengl::GLRenderbuffer_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(GLRenderContext_obj,createRenderbuffer,return )
 ...
 ::lime::graphics::opengl::GLShader GLRenderContext_obj::createShader(Int type){
            	HX_STACK_FRAME("lime.graphics.GLRenderContext","createShader",0x1929a185,"lime.graphics.GLRenderContext.createShader","lime/graphics/GLRenderContext.hx",578,0xbdd53034)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(type,"type")
HXLINE( 578)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::get_version();
HXDLIN( 578)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_shader(type)) );
HXDLIN( 578)		 ::Dynamic _hx_tmp1 = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 578)		return  ::lime::graphics::opengl::GLShader_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(GLRenderContext_obj,createShader,return )
 ...
 ::lime::graphics::opengl::GLTexture GLRenderContext_obj::createTexture(){
            	HX_STACK_FRAME("lime.graphics.GLRenderContext","createTexture",0x2a9dfa7b,"lime.graphics.GLRenderContext.createTexture","lime/graphics/GLRenderContext.hx",585,0xbdd53034)
            	HX_STACK_THIS(this)
HXLINE( 585)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::get_version();
HXDLIN( 585)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_texture()) );
HXDLIN( 585)		 ::Dynamic _hx_tmp1 = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 585)		return  ::lime::graphics::opengl::GLTexture_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
void GLRenderContext_obj::cullFace(Int mode){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(mode,"mode")
HXLINE( 592)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_cull_face(mode);
            	}
...
void GLRenderContext_obj::deleteBuffer( ::lime::graphics::opengl::GLBuffer buffer){
            	...
            	HX_STACK_ARG(buffer,"buffer")
HXLINE( 599)		{
HXLINE( 599)			 ::Dynamic buffer1 = buffer->id;
HXDLIN( 599)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_buffer(hx::DynamicPtr(buffer1));
            		}
HXDLIN( 599)		buffer->invalidate();
            	}
...
void GLRenderContext_obj::deleteFramebuffer( ::lime::graphics::opengl::GLFramebuffer framebuffer){
            	...
            	HX_STACK_ARG(framebuffer,"framebuffer")
HXLINE( 606)		{
HXLINE( 606)			 ::Dynamic framebuffer1 = framebuffer->id;
HXDLIN( 606)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_framebuffer(hx::DynamicPtr(framebuffer1));
            		}
HXDLIN( 606)		framebuffer->invalidate();
            	}
...
void GLRenderContext_obj::deleteProgram( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE( 613)		{
HXLINE( 613)			 ::Dynamic program1 = program->id;
HXDLIN( 613)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_program(hx::DynamicPtr(program1));
            		}
HXDLIN( 613)		program->invalidate();
            	}
...
void GLRenderContext_obj::deleteRenderbuffer( ::lime::graphics::opengl::GLRenderbuffer renderbuffer){
            	...
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE( 620)		{
HXLINE( 620)			 ::Dynamic renderbuffer1 = renderbuffer->id;
HXDLIN( 620)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_render_buffer(hx::DynamicPtr(renderbuffer1));
            		}
HXDLIN( 620)		renderbuffer->invalidate();
            	}
...
void GLRenderContext_obj::deleteShader( ::lime::graphics::opengl::GLShader shader){
            	...
            	HX_STACK_ARG(shader,"shader")
HXLINE( 627)		{
HXLINE( 627)			 ::Dynamic shader1 = shader->id;
HXDLIN( 627)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_shader(hx::DynamicPtr(shader1));
            		}
HXDLIN( 627)		shader->invalidate();
            	}
...
void GLRenderContext_obj::deleteTexture( ::lime::graphics::opengl::GLTexture texture){
            	...
            	HX_STACK_ARG(texture,"texture")
HXLINE( 634)		{
HXLINE( 634)			 ::Dynamic texture1 = texture->id;
HXDLIN( 634)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_texture(hx::DynamicPtr(texture1));
            		}
HXDLIN( 634)		texture->invalidate();
            	}
...
HXLINE( 641)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_depth_func(func);
            	}
...
HXLINE( 648)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_depth_mask(flag);
            	}
...
HXLINE( 655)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_depth_range(zNear,zFar);
            	}
...
void GLRenderContext_obj::detachShader( ::lime::graphics::opengl::GLProgram program, ::lime::graphics::opengl::GLShader shader){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(shader,"shader")
HXLINE( 662)		 ::Dynamic program1 = program->id;
HXDLIN( 662)		 ::Dynamic shader1 = shader->id;
HXDLIN( 662)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(program1);
HXDLIN( 662)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_detach_shader(_hx_tmp,hx::DynamicPtr(shader1));
            	}
...
HXLINE( 669)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_disable(cap);
            	}
...
void GLRenderContext_obj::disableVertexAttribArray(Int index){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
HXLINE( 676)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_disable_vertex_attrib_array(index);
            	}
...
HXLINE( 683)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_draw_arrays(mode,first,count);
            	}
...
void GLRenderContext_obj::drawElements(Int mode,Int count,Int type,Int offset){
            	...
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(offset,"offset")
HXLINE( 690)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_draw_elements(mode,count,type,offset);
            	}
...
void GLRenderContext_obj::enable(Int cap){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(cap,"cap")
HXLINE( 697)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_enable(cap);
            	}
...
void GLRenderContext_obj::enableVertexAttribArray(Int index){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
HXLINE( 704)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_enable_vertex_attrib_array(index);
            	}
...
void GLRenderContext_obj::finish(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 711)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_finish();
            	}
...
void GLRenderContext_obj::flush(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 718)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_flush();
            	}
...
void GLRenderContext_obj::framebufferRenderbuffer(Int target,Int attachment,Int renderbuffertarget, ::lime::graphics::opengl::GLRenderbuffer renderbuffer){
            	...
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE( 725)		 ::Dynamic renderbuffer1 = renderbuffer->id;
HXDLIN( 725)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_framebuffer_renderbuffer(target,attachment,renderbuffertarget,hx::DynamicPtr(renderbuffer1));
            	}
...
void GLRenderContext_obj::framebufferTexture2D(Int target,Int attachment,Int textarget, ::lime::graphics::opengl::GLTexture texture,Int level){
            	...
            	HX_STACK_ARG(texture,"texture")
            	HX_STACK_ARG(level,"level")
HXLINE( 732)		 ::Dynamic texture1 = texture->id;
HXDLIN( 732)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_framebuffer_texture2D(target,attachment,textarget,hx::DynamicPtr(texture1),level);
            	}
...
void GLRenderContext_obj::frontFace(Int mode){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(mode,"mode")
HXLINE( 739)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_front_face(mode);
            	}
...
void GLRenderContext_obj::generateMipmap(Int target){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(target,"target")
HXLINE( 746)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_generate_mipmap(target);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(GLRenderContext_obj,generateMipmap,(void))
 ...
 ::Dynamic GLRenderContext_obj::getActiveAttrib( ::lime::graphics::opengl::GLProgram program,Int index){
            	HX_STACK_FRAME("lime.graphics.GLRenderContext","getActiveAttrib",0x9cd2aba2,"lime.graphics.GLRenderContext.getActiveAttrib","lime/graphics/GLRenderContext.hx",753,0xbdd53034)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(index,"index")
HXLINE( 753)		 ::Dynamic program1 = program->id;
HXDLIN( 753)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_active_attrib(hx::DynamicPtr(program1),index)) );
HXDLIN( 753)		HX_VARI(  ::Dynamic,result) = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 753)		return result;
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(GLRenderContext_obj,getActiveAttrib,return )
 ...
 ::Dynamic GLRenderContext_obj::getActiveUniform( ::lime::graphics::opengl::GLProgram program,Int index){
            	HX_STACK_FRAME("lime.graphics.GLRenderContext","getActiveUniform",0x17ba49dc,"lime.graphics.GLRenderContext.getActiveUniform","lime/graphics/GLRenderContext.hx",760,0xbdd53034)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(index,"index")
HXLINE( 760)		 ::Dynamic program1 = program->id;
HXDLIN( 760)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_active_uniform(hx::DynamicPtr(program1),index)) );
HXDLIN( 760)		HX_VARI(  ::Dynamic,result) = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 760)		return result;
            	}
...
::Array< ::Dynamic> GLRenderContext_obj::getAttachedShaders( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
HXLINE( 767)		return program->getShaders();
            	}
...
Int GLRenderContext_obj::getAttribLocation( ::lime::graphics::opengl::GLProgram program,::String name){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(name,"name")
HXLINE( 774)		 ::Dynamic program1 = program->id;
HXDLIN( 774)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_attrib_location(hx::DynamicPtr(program1),name)) );
            	}
...
HXLINE( 781)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_buffer_parameter(target,pname)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(GLRenderContext_obj,getBufferParameter,return )
 ...
 ::Dynamic GLRenderContext_obj::getContextAttributes(){
            	HX_STACK_FRAME("lime.graphics.GLRenderContext","getContextAttributes",0xbf276074,"lime.graphics.GLRenderContext.getContextAttributes","lime/graphics/GLRenderContext.hx",788,0xbdd53034)
            	HX_STACK_THIS(this)
HXLINE( 788)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_context_attributes()) );
HXDLIN( 788)		HX_VARI(  ::Dynamic,base) = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 788)		base->__SetField(HX_("premultipliedAlpha",28,8e,5c,1a),false,hx::paccDynamic);
HXDLIN( 788)		base->__SetField(HX_("preserveDrawingBuffer",92,bb,1e,4b),false,hx::paccDynamic);
HXDLIN( 788)		return base;
            	}
...
Int GLRenderContext_obj::getError(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 795)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_error()) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(GLRenderContext_obj,getError,return )
 ...
 ::Dynamic GLRenderContext_obj::getExtension(::String name){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(name,"name")
HXLINE( 802)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_extension(name)) );
HXDLIN( 802)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Int GLRenderContext_obj::getFramebufferAttachmentParameter(Int target,Int attachment,Int pname){
            	...
            	HX_STACK_ARG(attachment,"attachment")
            	HX_STACK_ARG(pname,"pname")
HXLINE( 809)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_framebuffer_attachment_parameter(target,attachment,pname)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(GLRenderContext_obj,getFramebufferAttachmentParameter,return )
 ...
 ::Dynamic GLRenderContext_obj::getParameter(Int pname){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pname,"pname")
HXLINE( 816)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_parameter(pname)) );
HXDLIN( 816)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
::String GLRenderContext_obj::getProgramInfoLog( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
HXLINE( 823)		 ::Dynamic program1 = program->id;
HXDLIN( 823)		return ( (::String)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_program_info_log(hx::DynamicPtr(program1))) );
            	}
...
Int GLRenderContext_obj::getProgramParameter( ::lime::graphics::opengl::GLProgram program,Int pname){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(pname,"pname")
HXLINE( 830)		 ::Dynamic program1 = program->id;
HXDLIN( 830)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_program_parameter(hx::DynamicPtr(program1),pname)) );
            	}
...
Int GLRenderContext_obj::getRenderbufferParameter(Int target,Int pname){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(pname,"pname")
HXLINE( 837)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_render_buffer_parameter(target,pname)) );
            	}
...
::String GLRenderContext_obj::getShaderInfoLog( ::lime::graphics::opengl::GLShader shader){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(shader,"shader")
HXLINE( 844)		 ::Dynamic shader1 = shader->id;
HXDLIN( 844)		return ( (::String)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_info_log(hx::DynamicPtr(shader1))) );
            	}
...
Int GLRenderContext_obj::getShaderParameter( ::lime::graphics::opengl::GLShader shader,Int pname){
            	...
            	HX_STACK_ARG(shader,"shader")
            	HX_STACK_ARG(pname,"pname")
HXLINE( 851)		 ::Dynamic shader1 = shader->id;
HXDLIN( 851)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_parameter(hx::DynamicPtr(shader1),pname)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(GLRenderContext_obj,getShaderParameter,return )
 ...
 ::Dynamic GLRenderContext_obj::getShaderPrecisionFormat(Int shadertype,Int precisiontype){
            	HX_STACK_FRAME("lime.graphics.GLRenderContext","getShaderPrecisionFormat",0x3f8fb13e,"lime.graphics.GLRenderContext.getShaderPrecisionFormat","lime/graphics/GLRenderContext.hx",858,0xbdd53034)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(shadertype,"shadertype")
            	HX_STACK_ARG(precisiontype,"precisiontype")
HXLINE( 858)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_precision_format(shadertype,precisiontype)) );
HXDLIN( 858)		HX_VARI(  ::Dynamic,result) = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 858)		return result;
            	}
...
::String GLRenderContext_obj::getShaderSource( ::lime::graphics::opengl::GLShader shader){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(shader,"shader")
HXLINE( 865)		 ::Dynamic shader1 = shader->id;
HXDLIN( 865)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_source(hx::DynamicPtr(shader1))) );
HXDLIN( 865)		 ::Dynamic _hx_tmp = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 865)		return ( (::String)(_hx_tmp) );
            	}
...
::Array< ::String > GLRenderContext_obj::getSupportedExtensions(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 872)		HX_VARI( ::Array< ::String >,result) = ::Array_obj< ::String >::__new();
HXDLIN( 872)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_supported_extensions(hx::DynamicPtr(result));
HXDLIN( 872)		return result;
            	}
...
Int GLRenderContext_obj::getTexParameter(Int target,Int pname){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(pname,"pname")
HXLINE( 879)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_tex_parameter(target,pname)) );
            	}
...
HXLINE( 886)		 ::Dynamic program1 = program->id;
HXDLIN( 886)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_uniform(hx::DynamicPtr(program1),location)) );
HXDLIN( 886)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Int GLRenderContext_obj::getUniformLocation( ::lime::graphics::opengl::GLProgram program,::String name){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(name,"name")
HXLINE( 893)		 ::Dynamic program1 = program->id;
HXDLIN( 893)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_uniform_location(hx::DynamicPtr(program1),name)) );
            	}
...
Int GLRenderContext_obj::getVertexAttrib(Int index,Int pname){
            	...
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(pname,"pname")
HXLINE( 900)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_vertex_attrib(index,pname)) );
            	}
...
Int GLRenderContext_obj::getVertexAttribOffset(Int index,Int pname){
            	...
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(pname,"pname")
HXLINE( 907)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_vertex_attrib_offset(index,pname)) );
            	}
...
void GLRenderContext_obj::hint(Int target,Int mode){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(mode,"mode")
HXLINE( 914)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_hint(target,mode);
            	}
...
Bool GLRenderContext_obj::isBuffer( ::lime::graphics::opengl::GLBuffer buffer){
            	HX_STACK_FRAME("lime.graphics.GLRenderContext","isBuffer",0x219a88ce,"lime.graphics.GLRenderContext.isBuffer","lime/graphics/GLRenderContext.hx",921,0xbdd53034)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(buffer,"buffer")
HXLINE( 921)		Bool _hx_tmp;
HXDLIN( 921)		Bool _hx_tmp1 = hx::IsNotNull( buffer );
HXDLIN( 921)		if (_hx_tmp1) {
HXLINE( 921)			 ::Dynamic a = buffer->id;
HXDLIN( 921)			Float _hx_tmp2 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(a);
HXDLIN( 921)			_hx_tmp = (_hx_tmp2 > (int)0);
            		}
            		else {
HXLINE( 921)			_hx_tmp = false;
            		}
HXDLIN( 921)		if (_hx_tmp) {
HXLINE( 921)			 ::Dynamic buffer1 = buffer->id;
HXDLIN( 921)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_buffer(hx::DynamicPtr(buffer1))) );
            		}
            		else {
HXLINE( 921)			return false;
            		}
HXDLIN( 921)		return false;
            	}
...
Bool GLRenderContext_obj::isEnabled(Int cap){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(cap,"cap")
HXLINE( 935)		return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_enabled(cap)) );
            	}
...
Bool GLRenderContext_obj::isFramebuffer( ::lime::graphics::opengl::GLFramebuffer framebuffer){
            	HX_STACK_FRAME("lime.graphics.GLRenderContext","isFramebuffer",0x26e6be5f,"lime.graphics.GLRenderContext.isFramebuffer","lime/graphics/GLRenderContext.hx",942,0xbdd53034)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(framebuffer,"framebuffer")
HXLINE( 942)		Bool _hx_tmp;
HXDLIN( 942)		Bool _hx_tmp1 = hx::IsNotNull( framebuffer );
HXDLIN( 942)		if (_hx_tmp1) {
HXLINE( 942)			 ::Dynamic a = framebuffer->id;
HXDLIN( 942)			Float _hx_tmp2 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(a);
HXDLIN( 942)			_hx_tmp = (_hx_tmp2 > (int)0);
            		}
            		else {
HXLINE( 942)			_hx_tmp = false;
            		}
HXDLIN( 942)		if (_hx_tmp) {
HXLINE( 942)			 ::Dynamic framebuffer1 = framebuffer->id;
HXDLIN( 942)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_framebuffer(hx::DynamicPtr(framebuffer1))) );
            		}
            		else {
HXLINE( 942)			return false;
            		}
HXDLIN( 942)		return false;
            	}
...
Bool GLRenderContext_obj::isProgram( ::lime::graphics::opengl::GLProgram program){
            	HX_STACK_FRAME("lime.graphics.GLRenderContext","isProgram",0x8805d2f6,"lime.graphics.GLRenderContext.isProgram","lime/graphics/GLRenderContext.hx",949,0xbdd53034)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
HXLINE( 949)		Bool _hx_tmp;
HXDLIN( 949)		Bool _hx_tmp1 = hx::IsNotNull( program );
HXDLIN( 949)		if (_hx_tmp1) {
HXLINE( 949)			 ::Dynamic a = program->id;
HXDLIN( 949)			Float _hx_tmp2 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(a);
HXDLIN( 949)			_hx_tmp = (_hx_tmp2 > (int)0);
            		}
            		else {
...
HXDLIN( 949)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_program(hx::DynamicPtr(program1))) );
            		}
            		else {
HXLINE( 949)			return false;
            		}
HXDLIN( 949)		return false;
            	}
...
Bool GLRenderContext_obj::isRenderbuffer( ::lime::graphics::opengl::GLRenderbuffer renderbuffer){
            	HX_STACK_FRAME("lime.graphics.GLRenderContext","isRenderbuffer",0x698be724,"lime.graphics.GLRenderContext.isRenderbuffer","lime/graphics/GLRenderContext.hx",956,0xbdd53034)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE( 956)		Bool _hx_tmp;
HXDLIN( 956)		Bool _hx_tmp1 = hx::IsNotNull( renderbuffer );
HXDLIN( 956)		if (_hx_tmp1) {
HXLINE( 956)			 ::Dynamic a = renderbuffer->id;
HXDLIN( 956)			Float _hx_tmp2 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(a);
HXDLIN( 956)			_hx_tmp = (_hx_tmp2 > (int)0);
            		}
            		else {
HXLINE( 956)			_hx_tmp = false;
            		}
HXDLIN( 956)		if (_hx_tmp) {
HXLINE( 956)			 ::Dynamic renderbuffer1 = renderbuffer->id;
HXDLIN( 956)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_renderbuffer(hx::DynamicPtr(renderbuffer1))) );
            		}
            		else {
HXLINE( 956)			return false;
            		}
HXDLIN( 956)		return false;
            	}
...
Bool GLRenderContext_obj::isShader( ::lime::graphics::opengl::GLShader shader){
            	HX_STACK_FRAME("lime.graphics.GLRenderContext","isShader",0x6e268af3,"lime.graphics.GLRenderContext.isShader","lime/graphics/GLRenderContext.hx",963,0xbdd53034)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(shader,"shader")
HXLINE( 963)		Bool _hx_tmp;
HXDLIN( 963)		Bool _hx_tmp1 = hx::IsNotNull( shader );
HXDLIN( 963)		if (_hx_tmp1) {
HXLINE( 963)			 ::Dynamic a = shader->id;
HXDLIN( 963)			Float _hx_tmp2 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(a);
HXDLIN( 963)			_hx_tmp = (_hx_tmp2 > (int)0);
            		}
            		else {
HXLINE( 963)			_hx_tmp = false;
            		}
HXDLIN( 963)		if (_hx_tmp) {
HXLINE( 963)			 ::Dynamic shader1 = shader->id;
HXDLIN( 963)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_shader(hx::DynamicPtr(shader1))) );
            		}
            		else {
...
Bool GLRenderContext_obj::isTexture( ::lime::graphics::opengl::GLTexture texture){
            	HX_STACK_FRAME("lime.graphics.GLRenderContext","isTexture",0x32ed514d,"lime.graphics.GLRenderContext.isTexture","lime/graphics/GLRenderContext.hx",970,0xbdd53034)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(texture,"texture")
HXLINE( 970)		Bool _hx_tmp;
HXDLIN( 970)		Bool _hx_tmp1 = hx::IsNotNull( texture );
HXDLIN( 970)		if (_hx_tmp1) {
HXLINE( 970)			 ::Dynamic a = texture->id;
HXDLIN( 970)			Float _hx_tmp2 = ::lime::_hx_system::_CFFIPointer::CFFIPointer_Impl__obj::get(a);
HXDLIN( 970)			_hx_tmp = (_hx_tmp2 > (int)0);
            		}
            		else {
HXLINE( 970)			_hx_tmp = false;
            		}
HXDLIN( 970)		if (_hx_tmp) {
HXLINE( 970)			 ::Dynamic texture1 = texture->id;
HXDLIN( 970)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_texture(hx::DynamicPtr(texture1))) );
            		}
            		else {
...
void GLRenderContext_obj::lineWidth(Float width){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(width,"width")
HXLINE( 977)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_line_width(width);
            	}
...
void GLRenderContext_obj::linkProgram( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
HXLINE( 984)		 ::Dynamic program1 = program->id;
HXDLIN( 984)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_link_program(hx::DynamicPtr(program1));
            	}
...
HXLINE( 991)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_pixel_storei(pname,param);
            	}
...
HXLINE( 998)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_polygon_offset(factor,units);
            	}
...
HXLINE(1005)		HX_VAR(  ::haxe::io::Bytes,buffer);
HXDLIN(1005)		Bool _hx_tmp = hx::IsNull( pixels );
HXDLIN(1005)		if (_hx_tmp) {
HXLINE(1005)			buffer = null();
            		}
            		else {
HXLINE(1005)			buffer = pixels->buffer;
            		}
HXDLIN(1005)		{
HXLINE(1005)			Int byteOffset;
HXDLIN(1005)			Bool _hx_tmp1 = hx::IsNull( pixels );
HXDLIN(1005)			if (_hx_tmp1) {
HXLINE(1005)				byteOffset = (int)0;
            			}
            			else {
HXLINE(1005)				byteOffset = pixels->byteOffset;
            			}
HXDLIN(1005)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_read_pixels(x,y,width,height,format,type,hx::DynamicPtr(buffer),byteOffset);
            		}
            	}
...
void GLRenderContext_obj::renderbufferStorage(Int target,Int internalformat,Int width,Int height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE(1012)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_renderbuffer_storage(target,internalformat,width,height);
            	}
...
HXLINE(1019)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_sample_coverage(value,invert);
            	}
...
void GLRenderContext_obj::scissor(Int x,Int y,Int width,Int height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE(1026)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_scissor(x,y,width,height);
            	}
...
HXLINE(1033)		 ::Dynamic shader1 = shader->id;
HXDLIN(1033)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_shader_source(hx::DynamicPtr(shader1),source);
            	}
...
void GLRenderContext_obj::stencilFunc(Int func,Int ref,Int mask){
            	...
            	HX_STACK_ARG(mask,"mask")
HXLINE(1040)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_func(func,ref,mask);
            	}
...
void GLRenderContext_obj::stencilFuncSeparate(Int face,Int func,Int ref,Int mask){
            	...
            	HX_STACK_ARG(ref,"ref")
            	HX_STACK_ARG(mask,"mask")
HXLINE(1047)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_func_separate(face,func,ref,mask);
            	}
...
void GLRenderContext_obj::stencilMask(Int mask){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(mask,"mask")
HXLINE(1054)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_mask(mask);
            	}
...
void GLRenderContext_obj::stencilMaskSeparate(Int face,Int mask){
            	...
            	HX_STACK_ARG(face,"face")
            	HX_STACK_ARG(mask,"mask")
HXLINE(1061)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_mask_separate(face,mask);
            	}
...
HXLINE(1068)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_op(fail,zfail,zpass);
            	}
...
void GLRenderContext_obj::stencilOpSeparate(Int face,Int fail,Int zfail,Int zpass){
            	...
            	HX_STACK_ARG(zfail,"zfail")
            	HX_STACK_ARG(zpass,"zpass")
HXLINE(1075)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_op_separate(face,fail,zfail,zpass);
            	}
...
void GLRenderContext_obj::texImage2D(Int target,Int level,Int internalformat,Int width,Int height,Int border,Int format,Int type, ::lime::utils::ArrayBufferView pixels){
            	...
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(pixels,"pixels")
HXLINE(1082)		HX_VAR(  ::haxe::io::Bytes,buffer);
HXDLIN(1082)		Bool _hx_tmp = hx::IsNull( pixels );
HXDLIN(1082)		if (_hx_tmp) {
HXLINE(1082)			buffer = null();
            		}
            		else {
HXLINE(1082)			buffer = pixels->buffer;
            		}
HXDLIN(1082)		{
HXLINE(1082)			Int byteOffset;
HXDLIN(1082)			Bool _hx_tmp1 = hx::IsNull( pixels );
HXDLIN(1082)			if (_hx_tmp1) {
HXLINE(1082)				byteOffset = (int)0;
            			}
            			else {
HXLINE(1082)				byteOffset = pixels->byteOffset;
            			}
HXDLIN(1082)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_image_2d(target,level,internalformat,width,height,border,format,type,hx::DynamicPtr(buffer),byteOffset);
            		}
            	}
...
void GLRenderContext_obj::texParameterf(Int target,Int pname,Float param){
            	...
            	HX_STACK_ARG(pname,"pname")
            	HX_STACK_ARG(param,"param")
HXLINE(1089)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_parameterf(target,pname,param);
            	}
...
void GLRenderContext_obj::texParameteri(Int target,Int pname,Int param){
            	...
            	HX_STACK_ARG(pname,"pname")
            	HX_STACK_ARG(param,"param")
HXLINE(1096)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_parameteri(target,pname,param);
            	}
...
void GLRenderContext_obj::texSubImage2D(Int target,Int level,Int xoffset,Int yoffset,Int width,Int height,Int format,Int type, ::lime::utils::ArrayBufferView pixels){
            	...
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(pixels,"pixels")
HXLINE(1103)		HX_VAR(  ::haxe::io::Bytes,buffer);
HXDLIN(1103)		Bool _hx_tmp = hx::IsNull( pixels );
HXDLIN(1103)		if (_hx_tmp) {
HXLINE(1103)			buffer = null();
            		}
            		else {
HXLINE(1103)			buffer = pixels->buffer;
            		}
HXDLIN(1103)		{
HXLINE(1103)			Int byteOffset;
HXDLIN(1103)			Bool _hx_tmp1 = hx::IsNull( pixels );
HXDLIN(1103)			if (_hx_tmp1) {
HXLINE(1103)				byteOffset = (int)0;
            			}
            			else {
HXLINE(1103)				byteOffset = pixels->byteOffset;
            			}
HXDLIN(1103)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_sub_image_2d(target,level,xoffset,yoffset,width,height,format,type,hx::DynamicPtr(buffer),byteOffset);
            		}
            	}
...
void GLRenderContext_obj::uniform1f(Int location,Float x){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
HXLINE(1110)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform1f(location,x);
            	}
...
void GLRenderContext_obj::uniform1fv(Int location, ::lime::utils::ArrayBufferView x){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
HXLINE(1117)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform1fv(location,hx::DynamicPtr(x->buffer));
            	}
...
void GLRenderContext_obj::uniform1i(Int location,Int x){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
HXLINE(1124)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform1i(location,x);
            	}
...
void GLRenderContext_obj::uniform1iv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(1131)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform1iv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GLRenderContext_obj::uniform2f(Int location,Float x,Float y){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(1138)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2f(location,x,y);
            	}
...
void GLRenderContext_obj::uniform2fv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(1145)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2fv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GLRenderContext_obj::uniform2i(Int location,Int x,Int y){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(1152)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2i(location,x,y);
            	}
...
void GLRenderContext_obj::uniform2iv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(1159)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2iv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GLRenderContext_obj::uniform3f(Int location,Float x,Float y,Float z){
            	...
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(z,"z")
HXLINE(1166)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3f(location,x,y,z);
            	}
...
void GLRenderContext_obj::uniform3fv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(1173)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3fv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GLRenderContext_obj::uniform3i(Int location,Int x,Int y,Int z){
            	...
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(z,"z")
HXLINE(1180)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3i(location,x,y,z);
            	}
...
void GLRenderContext_obj::uniform3iv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(1187)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3iv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GLRenderContext_obj::uniform4f(Int location,Float x,Float y,Float z,Float w){
            	...
            	HX_STACK_ARG(z,"z")
            	HX_STACK_ARG(w,"w")
HXLINE(1194)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4f(location,x,y,z,w);
            	}
...
void GLRenderContext_obj::uniform4fv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(1201)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4fv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GLRenderContext_obj::uniform4i(Int location,Int x,Int y,Int z,Int w){
            	...
            	HX_STACK_ARG(z,"z")
            	HX_STACK_ARG(w,"w")
HXLINE(1208)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4i(location,x,y,z,w);
            	}
...
void GLRenderContext_obj::uniform4iv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(1215)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4iv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GLRenderContext_obj::uniformMatrix2fv(Int location,Bool transpose, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(v,"v")
HXLINE(1222)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform_matrix(location,transpose,hx::DynamicPtr(v->buffer),(int)2);
            	}
...
void GLRenderContext_obj::uniformMatrix3fv(Int location,Bool transpose, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(transpose,"transpose")
            	HX_STACK_ARG(v,"v")
HXLINE(1229)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform_matrix(location,transpose,hx::DynamicPtr(v->buffer),(int)3);
            	}
...
void GLRenderContext_obj::uniformMatrix4fv(Int location,Bool transpose, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(transpose,"transpose")
            	HX_STACK_ARG(v,"v")
HXLINE(1236)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform_matrix(location,transpose,hx::DynamicPtr(v->buffer),(int)4);
            	}
...
void GLRenderContext_obj::useProgram( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
HXLINE(1250)		::lime::graphics::opengl::GL_obj::_hx___currentProgram = program;
HXDLIN(1250)		{
HXLINE(1250)			 ::Dynamic program1;
HXDLIN(1250)			Bool _hx_tmp = hx::IsNull( program );
HXDLIN(1250)			if (_hx_tmp) {
HXLINE(1250)				program1 = null();
            			}
            			else {
HXLINE(1250)				program1 = program->id;
            			}
HXDLIN(1250)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_use_program(hx::DynamicPtr(program1));
            		}
            	}
...
void GLRenderContext_obj::validateProgram( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
HXLINE(1257)		 ::Dynamic program1 = program->id;
HXDLIN(1257)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_validate_program(hx::DynamicPtr(program1));
            	}
...
void GLRenderContext_obj::vertexAttrib1f(Int indx,Float x){
            	...
            	HX_STACK_ARG(x,"x")
HXLINE(1264)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib1f(indx,x);
            	}
...
HXLINE(1271)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib1fv(indx,hx::DynamicPtr(values->buffer));
            	}
...
void GLRenderContext_obj::vertexAttrib2f(Int indx,Float x,Float y){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(1278)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib2f(indx,x,y);
            	}
...
void GLRenderContext_obj::vertexAttrib2fv(Int indx, ::lime::utils::ArrayBufferView values){
            	...
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(values,"values")
HXLINE(1285)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib2fv(indx,hx::DynamicPtr(values->buffer));
            	}
...
void GLRenderContext_obj::vertexAttrib3f(Int indx,Float x,Float y,Float z){
            	...
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(z,"z")
HXLINE(1292)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib3f(indx,x,y,z);
            	}
...
void GLRenderContext_obj::vertexAttrib3fv(Int indx, ::lime::utils::ArrayBufferView values){
            	...
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(values,"values")
HXLINE(1299)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib3fv(indx,hx::DynamicPtr(values->buffer));
            	}
...
void GLRenderContext_obj::vertexAttrib4f(Int indx,Float x,Float y,Float z,Float w){
            	...
            	HX_STACK_ARG(z,"z")
            	HX_STACK_ARG(w,"w")
HXLINE(1306)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib4f(indx,x,y,z,w);
            	}
...
void GLRenderContext_obj::vertexAttrib4fv(Int indx, ::lime::utils::ArrayBufferView values){
            	...
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(values,"values")
HXLINE(1313)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib4fv(indx,hx::DynamicPtr(values->buffer));
            	}
...
void GLRenderContext_obj::vertexAttribPointer(Int indx,Int size,Int type,Bool normalized,Int stride,Int offset){
            	...
            	HX_STACK_ARG(offset,"offset")
HXLINE(1320)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib_pointer(indx,size,type,normalized,stride,offset);
            	}
...
void GLRenderContext_obj::viewport(Int x,Int y,Int width,Int height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE(1327)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_viewport(x,y,width,height);
            	}
