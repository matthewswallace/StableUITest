...
void AssetCache_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1055)		this->enabled = true;
HXLINE(1063)		this->audio =  ::haxe::ds::StringMap_obj::__new();
HXLINE(1064)		this->font =  ::haxe::ds::StringMap_obj::__new();
HXLINE(1065)		this->image =  ::haxe::ds::StringMap_obj::__new();
HXLINE(1066)		this->version = (int)23775;
            	}
...
void AssetCache_obj::clear(::String prefix){
            	HX_STACK_FRAME("lime.AssetCache","clear",0xa2398fea,"lime.AssetCache.clear","lime/Assets.hx",1076,0x48c77341)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(prefix,"prefix")
HXLINE(1076)		Bool _hx_tmp = hx::IsNull( prefix );
HXDLIN(1076)		if (_hx_tmp) {
HXLINE(1078)			this->audio =  ::haxe::ds::StringMap_obj::__new();
HXLINE(1079)			this->font =  ::haxe::ds::StringMap_obj::__new();
HXLINE(1080)			this->image =  ::haxe::ds::StringMap_obj::__new();
            		}
            		else {
HXLINE(1084)			HX_VARI(  ::Dynamic,keys) = this->audio->keys();
HXLINE(1086)			while(true){
HXLINE(1086)				Bool _hx_tmp1 = !(( (Bool)( ::Dynamic(keys->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN(1086)				if (_hx_tmp1) {
HXLINE(1086)					goto _hx_goto_0;
            				}
HXDLIN(1086)				HX_VARI( ::String,key) = ( (::String)( ::Dynamic(keys->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE(1088)				Bool _hx_tmp2 = ::StringTools_obj::startsWith(key,prefix);
HXDLIN(1088)				if (_hx_tmp2) {
HXLINE(1090)					this->audio->remove(key);
            				}
            			}
            			_hx_goto_0:;
HXLINE(1096)			HX_VARI_NAME(  ::Dynamic,keys1,"keys") = this->font->keys();
HXLINE(1098)			while(true){
HXLINE(1098)				Bool _hx_tmp3 = !(( (Bool)( ::Dynamic(keys1->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN(1098)				if (_hx_tmp3) {
HXLINE(1098)					goto _hx_goto_1;
            				}
HXDLIN(1098)				HX_VARI_NAME( ::String,key1,"key") = ( (::String)( ::Dynamic(keys1->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE(1100)				Bool _hx_tmp4 = ::StringTools_obj::startsWith(key1,prefix);
HXDLIN(1100)				if (_hx_tmp4) {
HXLINE(1102)					this->font->remove(key1);
            				}
            			}
            			_hx_goto_1:;
HXLINE(1108)			HX_VARI_NAME(  ::Dynamic,keys2,"keys") = this->image->keys();
HXLINE(1110)			while(true){
HXLINE(1110)				Bool _hx_tmp5 = !(( (Bool)( ::Dynamic(keys2->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN(1110)				if (_hx_tmp5) {
HXLINE(1110)					goto _hx_goto_2;
            				}
HXDLIN(1110)				HX_VARI_NAME( ::String,key2,"key") = ( (::String)( ::Dynamic(keys2->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE(1112)				Bool _hx_tmp6 = ::StringTools_obj::startsWith(key2,prefix);
HXDLIN(1112)				if (_hx_tmp6) {
HXLINE(1114)					this->image->remove(key2);
            				}
            			}
            			_hx_goto_2:;
            		}
