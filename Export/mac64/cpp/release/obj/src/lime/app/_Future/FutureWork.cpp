...
HXLINE( 218)		Bool _hx_tmp = hx::IsNull( ::lime::app::_Future::FutureWork_obj::threadPool );
HXDLIN( 218)		if (_hx_tmp) {
HXLINE( 220)			::lime::app::_Future::FutureWork_obj::threadPool =  ::lime::_hx_system::ThreadPool_obj::__new(null(),null());
HXLINE( 221)			::lime::app::_Future::FutureWork_obj::threadPool->doWork->add(::lime::app::_Future::FutureWork_obj::threadPool_doWork_dyn(),null(),null());
HXLINE( 222)			::lime::app::_Future::FutureWork_obj::threadPool->onComplete->add(::lime::app::_Future::FutureWork_obj::threadPool_onComplete_dyn(),null(),null());
HXLINE( 223)			::lime::app::_Future::FutureWork_obj::threadPool->onError->add(::lime::app::_Future::FutureWork_obj::threadPool_onError_dyn(),null(),null());
            		}
HXLINE( 227)		::lime::app::_Future::FutureWork_obj::threadPool->queue(state);
            	}
...
HXLINE( 243)			HX_VARI(  ::Dynamic,result) =  ::Dynamic(state->__Field(HX_("work",d1,01,fd,4e),hx::paccDynamic))();
HXLINE( 244)			::lime::app::_Future::FutureWork_obj::threadPool->sendComplete( ::Dynamic(hx::Anon_obj::Create(2)
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic e = _hx_e;
HXLINE( 248)				::lime::app::_Future::FutureWork_obj::threadPool->sendError( ::Dynamic(hx::Anon_obj::Create(2)
            					->setFixed(0,HX_("promise",9b,cd,e9,f7), ::Dynamic(state->__Field(HX_("promise",9b,cd,e9,f7),hx::paccDynamic)))
...
void FutureWork_obj::threadPool_onComplete( ::Dynamic state){
            	...
            	HX_STACK_ARG(state,"state")
HXLINE( 257)		 ::Dynamic( ::Dynamic(state->__Field(HX_("promise",9b,cd,e9,f7),hx::paccDynamic))->__Field(HX_("complete",b9,00,c8,7f),hx::paccDynamic))( ::Dynamic(state->__Field(HX_("result",dd,68,84,08),hx::paccDynamic)));
            	}
...
void FutureWork_obj::threadPool_onError( ::Dynamic state){
            	...
            	HX_STACK_ARG(state,"state")
HXLINE( 264)		 ::Dynamic( ::Dynamic(state->__Field(HX_("promise",9b,cd,e9,f7),hx::paccDynamic))->__Field(HX_("error",c8,cb,29,73),hx::paccDynamic))( ::Dynamic(state->__Field(HX_("error",c8,cb,29,73),hx::paccDynamic)));
            	}
