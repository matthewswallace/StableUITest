...
void Preloader_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  27)		this->onProgress =  ::lime::app::_Event_Int_Int_Void_obj::__new();
HXLINE(  26)		this->onComplete =  ::lime::app::_Event_Void_Void_obj::__new();
HXLINE(  44)		this->onProgress->add(this->update_dyn(),null(),null());
            	}
...
void Preloader_obj::start(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 274)		this->complete = true;
HXLINE( 284)		this->onComplete->dispatch();
            	}
