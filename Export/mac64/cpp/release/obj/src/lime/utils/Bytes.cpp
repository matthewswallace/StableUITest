...
HXLINE(  63)		 ::Dynamic bytes = ::lime::utils::Bytes_obj::alloc((int)0);
HXDLIN(  63)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::utils::Bytes_obj::cffi_lime_bytes_read_file(path,hx::DynamicPtr(bytes))) );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_obj,readFile,return )
 ...
 ::lime::utils::Bytes Bytes_obj::_hx___fromNativePointer( ::Dynamic data,Int length){
            	...
            	HX_STACK_ARG(length,"length")
HXLINE(  77)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::utils::Bytes_obj::cffi_lime_bytes_from_data_pointer(( (Float)(data) ),length)) );
HXDLIN(  77)		HX_VARI(  ::Dynamic,bytes) = Dynamic(hx::DynamicPtr(inVal));
HXLINE(  78)		return  ::lime::utils::Bytes_obj::__new( ::Dynamic(bytes->__Field(HX_("length",e6,94,07,9f),hx::paccDynamic)), ::Dynamic(bytes->__Field(HX_("b",62,00,00,00),hx::paccDynamic)));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Bytes_obj,_hx___fromNativePointer,return )
 ...
 ::Dynamic Bytes_obj::lime_bytes_from_data_pointer(Float data,Int length){
            	...
            	HX_STACK_ARG(data,"data")
            	HX_STACK_ARG(length,"length")
HXLINE(  92)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::utils::Bytes_obj::cffi_lime_bytes_from_data_pointer(data,length)) );
...
Float Bytes_obj::lime_bytes_get_data_pointer( ::Dynamic data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(  93)		return ( (Float)(::lime::utils::Bytes_obj::cffi_lime_bytes_get_data_pointer(hx::DynamicPtr(data))) );
            	}
...
HXLINE(  94)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::utils::Bytes_obj::cffi_lime_bytes_read_file(path,hx::DynamicPtr(bytes))) );
...
{
{
            	HX_STACK_FRAME("lime.utils.Bytes","boot",0xb863ffcb,"lime.utils.Bytes.boot","lime/utils/Bytes.hx",92,0x9fbf972b)
HXLINE(  92)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_bytes_from_data_pointer",1f,3b,02,90),HX_("dio",4a,3d,4c,00),false);
HXDLIN(  92)		cffi_lime_bytes_from_data_pointer = inValue;
            	}
{
            	HX_STACK_FRAME("lime.utils.Bytes","boot",0xb863ffcb,"lime.utils.Bytes.boot","lime/utils/Bytes.hx",93,0x9fbf972b)
HXLINE(  93)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_bytes_get_data_pointer",af,ff,82,7b),HX_("od",15,61,00,00),false);
HXDLIN(  93)		cffi_lime_bytes_get_data_pointer = inValue;
            	}
{
            	HX_STACK_FRAME("lime.utils.Bytes","boot",0xb863ffcb,"lime.utils.Bytes.boot","lime/utils/Bytes.hx",94,0x9fbf972b)
HXLINE(  94)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_bytes_read_file",c7,b2,82,ba),HX_("soo",53,a4,57,00),false);
HXDLIN(  94)		cffi_lime_bytes_read_file = inValue;
            	}
}
