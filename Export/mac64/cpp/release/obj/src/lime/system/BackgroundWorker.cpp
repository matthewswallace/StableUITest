...
void BackgroundWorker_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  26)		this->onProgress =  ::lime::app::_Event_Dynamic_Void_obj::__new();
HXLINE(  25)		this->onError =  ::lime::app::_Event_Dynamic_Void_obj::__new();
HXLINE(  24)		this->onComplete =  ::lime::app::_Event_Dynamic_Void_obj::__new();
HXLINE(  23)		this->doWork =  ::lime::app::_Event_Dynamic_Void_obj::__new();
            	}
...
void BackgroundWorker_obj::cancel(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  45)		this->canceled = true;
HXLINE(  49)		this->_hx___workerThread = null();
            	}
...
HXLINE(  58)		this->canceled = false;
HXLINE(  59)		this->_hx___runMessage = message;
HXLINE(  63)		this->_hx___messageQueue =  ::cpp::vm::Deque_obj::__new();
HXLINE(  64)		this->_hx___workerThread = ::cpp::vm::Thread_obj::create(this->_hx___doWork_dyn());
HXLINE(  66)		::lime::app::Application_obj::current->onUpdate->add(this->_hx___update_dyn(),null(),null());
            	}
...
void BackgroundWorker_obj::sendComplete( ::Dynamic message){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(message,"message")
HXLINE(  81)		this->_hx___messageQueue->add(::lime::_hx_system::BackgroundWorker_obj::MESSAGE_COMPLETE);
HXLINE(  82)		this->_hx___messageQueue->add(message);
            	}
...
void BackgroundWorker_obj::sendError( ::Dynamic message){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(message,"message")
HXLINE( 102)		this->_hx___messageQueue->add(::lime::_hx_system::BackgroundWorker_obj::MESSAGE_ERROR);
HXLINE( 103)		this->_hx___messageQueue->add(message);
            	}
...
void BackgroundWorker_obj::sendProgress( ::Dynamic message){
            	HX_STACK_FRAME("lime.system.BackgroundWorker","sendProgress",0x5605e7d1,"lime.system.BackgroundWorker.sendProgress","lime/system/BackgroundWorker.hx",123,0x4a0958ac)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(message,"message")
HXLINE( 123)		this->_hx___messageQueue->add(message);
            	}
...
void BackgroundWorker_obj::_hx___doWork(){
            	HX_STACK_FRAME("lime.system.BackgroundWorker","__doWork",0x193122d8,"lime.system.BackgroundWorker.__doWork","lime/system/BackgroundWorker.hx",140,0x4a0958ac)
            	HX_STACK_THIS(this)
HXLINE( 140)		this->doWork->dispatch(this->_hx___runMessage);
            	}
...
HXLINE( 164)		HX_VARI(  ::Dynamic,message) = this->_hx___messageQueue->pop(false);
HXLINE( 166)		Bool _hx_tmp = hx::IsNotNull( message );
HXDLIN( 166)		if (_hx_tmp) {
HXLINE( 168)			if (hx::IsEq( message,::lime::_hx_system::BackgroundWorker_obj::MESSAGE_ERROR )) {
HXLINE( 170)				::lime::app::Application_obj::current->onUpdate->remove(this->_hx___update_dyn());
HXLINE( 172)				Bool _hx_tmp1 = !(this->canceled);
HXDLIN( 172)				if (_hx_tmp1) {
HXLINE( 174)					this->canceled = true;
HXLINE( 175)					 ::Dynamic _hx_tmp2 = this->_hx___messageQueue->pop(false);
HXDLIN( 175)					this->onError->dispatch(_hx_tmp2);
            				}
            			}
            			else {
HXLINE( 179)				if (hx::IsEq( message,::lime::_hx_system::BackgroundWorker_obj::MESSAGE_COMPLETE )) {
HXLINE( 181)					::lime::app::Application_obj::current->onUpdate->remove(this->_hx___update_dyn());
HXLINE( 183)					Bool _hx_tmp3 = !(this->canceled);
HXDLIN( 183)					if (_hx_tmp3) {
HXLINE( 185)						this->canceled = true;
HXLINE( 186)						 ::Dynamic _hx_tmp4 = this->_hx___messageQueue->pop(false);
HXDLIN( 186)						this->onComplete->dispatch(_hx_tmp4);
            					}
            				}
            				else {
HXLINE( 192)					Bool _hx_tmp5 = !(this->canceled);
HXDLIN( 192)					if (_hx_tmp5) {
HXLINE( 194)						this->onProgress->dispatch(message);
            					}
            				}
            			}
            		}
