...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(System_obj,exit,(void))
 ...
 ::lime::_hx_system::Display System_obj::getDisplay(Int id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE(  86)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_display(id)) );
...
HXLINE(  94)			display->dpi =  ::Dynamic(displayInfo->__Field(HX_("dpi",5d,43,4c,00),hx::paccDynamic));
HXLINE(  96)			display->supportedModes = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  98)			HX_VAR(  ::lime::_hx_system::DisplayMode,displayMode);
HXLINE( 100)			{
HXLINE( 100)				HX_VARI( Int,_g) = (int)0;
HXDLIN( 100)				HX_VARI( ::cpp::VirtualArray,_g1) = hx::TCast< ::cpp::VirtualArray >::cast( ::Dynamic(displayInfo->__Field(HX_("supportedModes",a2,a6,b8,b7),hx::paccDynamic)));
HXDLIN( 100)				while((_g < _g1->get_length())){
HXLINE( 100)					HX_VARI(  ::Dynamic,mode) = _g1->__get(_g);
HXDLIN( 100)					++_g;
HXLINE( 102)					displayMode =  ::lime::_hx_system::DisplayMode_obj::__new( ::Dynamic(mode->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)), ::Dynamic(mode->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)), ::Dynamic(mode->__Field(HX_("refreshRate",5b,e2,3f,40),hx::paccDynamic)), ::Dynamic(mode->__Field(HX_("pixelFormat",5d,72,1b,6f),hx::paccDynamic)));
HXLINE( 103)					display->supportedModes->push(displayMode);
            				}
            			}
HXLINE( 107)			Bool _hx_tmp1 = ::Reflect_obj::hasField(displayInfo,HX_("currentMode",3c,ac,f2,80));
HXDLIN( 107)			if (_hx_tmp1) {
HXLINE( 109)				display->currentMode = display->supportedModes->__get(( (Int)(displayInfo->__Field(HX_("currentMode",3c,ac,f2,80),hx::paccDynamic)) )).StaticCast<  ::lime::_hx_system::DisplayMode >();
            			}
            			else {
HXLINE( 113)				display->currentMode =  ::lime::_hx_system::DisplayMode_obj::__new((int)0,(int)0,(int)60,(int)1);
            			}
HXLINE( 117)			return display;
            		}
...
Int System_obj::getTimer(){
            	HX_STACK_FRAME("lime.system.System","getTimer",0xb1bf8f48,"lime.system.System.getTimer","lime/system/System.hx",154,0x6434b429)
HXLINE( 154)		return ( (Int)(::lime::_hx_system::System_obj::cffi_lime_system_get_timer()) );
            	}
...
Bool lazy = __o_lazy.Default(false);
            	HX_STACK_FRAME("lime.system.System","load",0x1dbaa99f,"lime.system.System.load","lime/system/System.hx",169,0x6434b429)
            	HX_STACK_ARG(library,"library")
            	HX_STACK_ARG(method,"method")
            	HX_STACK_ARG(args,"args")
            	HX_STACK_ARG(lazy,"lazy")
HXLINE( 169)		return ::lime::_hx_system::CFFI_obj::load(library,method,args,lazy);
            	}
...
::String System_obj::_hx___getDirectory(Int type){
            	HX_STACK_FRAME("lime.system.System","__getDirectory",0xc98892d0,"lime.system.System.__getDirectory","lime/system/System.hx",177,0x6434b429)
            	HX_STACK_ARG(type,"type")
HXLINE( 181)		Bool _hx_tmp = ::lime::_hx_system::System_obj::_hx___directories->exists(type);
HXDLIN( 181)		if (_hx_tmp) {
HXLINE( 183)			return ( (::String)(::lime::_hx_system::System_obj::_hx___directories->get(type)) );
            		}
            		else {
HXLINE( 187)			HX_VAR( ::String,path);
HXLINE( 189)			if ((type == (int)1)) {
HXLINE( 191)				HX_VARI( ::String,company) = HX_("MyCompany",11,c3,2e,cc);
HXLINE( 192)				HX_VARI( ::String,file) = HX_("MyApplication",24,d3,d1,1c);
HXLINE( 194)				Bool _hx_tmp1;
HXDLIN( 194)				Bool _hx_tmp2 = hx::IsNotNull( ::lime::app::Application_obj::current );
HXDLIN( 194)				if (_hx_tmp2) {
HXLINE( 194)					_hx_tmp1 = hx::IsNotNull( ::lime::app::Application_obj::current->config );
            				}
            				else {
HXLINE( 194)					_hx_tmp1 = false;
            				}
HXDLIN( 194)				if (_hx_tmp1) {
HXLINE( 196)					Bool _hx_tmp3 = hx::IsNotNull( ( (::String)(::lime::app::Application_obj::current->config->__Field(HX_("company",3d,15,69,83),hx::paccDynamic)) ) );
HXDLIN( 196)					if (_hx_tmp3) {
HXLINE( 198)						company = ( (::String)(::lime::app::Application_obj::current->config->__Field(HX_("company",3d,15,69,83),hx::paccDynamic)) );
            					}
HXLINE( 202)					Bool _hx_tmp4 = hx::IsNotNull( ( (::String)(::lime::app::Application_obj::current->config->__Field(HX_("file",7c,ce,bb,43),hx::paccDynamic)) ) );
HXDLIN( 202)					if (_hx_tmp4) {
HXLINE( 204)						file = ( (::String)(::lime::app::Application_obj::current->config->__Field(HX_("file",7c,ce,bb,43),hx::paccDynamic)) );
            					}
            				}
HXLINE( 210)				 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_directory(type,company,file)) );
HXDLIN( 210)				path = Dynamic(hx::DynamicPtr(inVal));
            			}
            			else {
HXLINE( 214)				 ::hx::Object * inVal1 = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_directory(type,null(),null())) );
HXDLIN( 214)				path = Dynamic(hx::DynamicPtr(inVal1));
            			}
HXLINE( 224)			Bool _hx_tmp5;
HXDLIN( 224)			Bool _hx_tmp6;
HXDLIN( 224)			Bool _hx_tmp7 = hx::IsNotNull( path );
HXDLIN( 224)			if (_hx_tmp7) {
HXLINE( 224)				_hx_tmp6 = (path.length > (int)0);
            			}
            			else {
HXLINE( 224)				_hx_tmp6 = false;
            			}
HXDLIN( 224)			if (_hx_tmp6) {
HXLINE( 224)				_hx_tmp5 = !(::StringTools_obj::endsWith(path,HX_("/",2f,00,00,00)));
            			}
            			else {
HXLINE( 224)				_hx_tmp5 = false;
            			}
HXDLIN( 224)			if (_hx_tmp5) {
HXLINE( 226)				hx::AddEq(path,HX_("/",2f,00,00,00));
            			}
HXLINE( 230)			::lime::_hx_system::System_obj::_hx___directories->set(type,path);
HXLINE( 231)			return path;
            		}
...
Bool System_obj::get_allowScreenTimeout(){
            	HX_STACK_FRAME("lime.system.System","get_allowScreenTimeout",0x287e314e,"lime.system.System.get_allowScreenTimeout","lime/system/System.hx",270,0x6434b429)
HXLINE( 270)		return ( (Bool)(::lime::_hx_system::System_obj::cffi_lime_system_get_allow_screen_timeout()) );
            	}
...
Bool System_obj::set_allowScreenTimeout(Bool value){
            	HX_STACK_FRAME("lime.system.System","set_allowScreenTimeout",0x5c29adc2,"lime.system.System.set_allowScreenTimeout","lime/system/System.hx",281,0x6434b429)
            	HX_STACK_ARG(value,"value")
HXLINE( 281)		return ( (Bool)(::lime::_hx_system::System_obj::cffi_lime_system_set_allow_screen_timeout(value)) );
            	}
...
::String System_obj::get_applicationDirectory(){
            	HX_STACK_FRAME("lime.system.System","get_applicationDirectory",0xf6955c7f,"lime.system.System.get_applicationDirectory","lime/system/System.hx",291,0x6434b429)
HXLINE( 291)		return ::lime::_hx_system::System_obj::_hx___getDirectory((int)0);
            	}
...
::String System_obj::get_applicationStorageDirectory(){
            	HX_STACK_FRAME("lime.system.System","get_applicationStorageDirectory",0x34818fe0,"lime.system.System.get_applicationStorageDirectory","lime/system/System.hx",298,0x6434b429)
HXLINE( 298)		return ::lime::_hx_system::System_obj::_hx___getDirectory((int)1);
            	}
...
::String System_obj::get_desktopDirectory(){
            	HX_STACK_FRAME("lime.system.System","get_desktopDirectory",0x483b2773,"lime.system.System.get_desktopDirectory","lime/system/System.hx",305,0x6434b429)
HXLINE( 305)		return ::lime::_hx_system::System_obj::_hx___getDirectory((int)2);
            	}
...
::String System_obj::get_documentsDirectory(){
            	HX_STACK_FRAME("lime.system.System","get_documentsDirectory",0x4a6a8557,"lime.system.System.get_documentsDirectory","lime/system/System.hx",312,0x6434b429)
HXLINE( 312)		return ::lime::_hx_system::System_obj::_hx___getDirectory((int)3);
            	}
...
::String System_obj::get_fontsDirectory(){
            	HX_STACK_FRAME("lime.system.System","get_fontsDirectory",0x8242b40b,"lime.system.System.get_fontsDirectory","lime/system/System.hx",319,0x6434b429)
HXLINE( 319)		return ::lime::_hx_system::System_obj::_hx___getDirectory((int)4);
            	}
...
Int System_obj::get_numDisplays(){
            	HX_STACK_FRAME("lime.system.System","get_numDisplays",0x5056f915,"lime.system.System.get_numDisplays","lime/system/System.hx",327,0x6434b429)
HXLINE( 327)		return ( (Int)(::lime::_hx_system::System_obj::cffi_lime_system_get_num_displays()) );
            	}
...
::String System_obj::get_userDirectory(){
            	HX_STACK_FRAME("lime.system.System","get_userDirectory",0x2b5522e0,"lime.system.System.get_userDirectory","lime/system/System.hx",337,0x6434b429)
HXLINE( 337)		return ::lime::_hx_system::System_obj::_hx___getDirectory((int)5);
            	}
...
::hx::EnumBase System_obj::get_endianness(){
            	HX_STACK_FRAME("lime.system.System","get_endianness",0x4df50bb4,"lime.system.System.get_endianness","lime/system/System.hx",349,0x6434b429)
HXLINE( 349)		return ::lime::_hx_system::Endian_obj::_hx_LITTLE_ENDIAN_dyn();
            	}
...
Bool System_obj::lime_system_get_allow_screen_timeout(){
            	HX_STACK_FRAME("lime.system.System","lime_system_get_allow_screen_timeout",0x4db31cec,"lime.system.System.lime_system_get_allow_screen_timeout","lime/system/System.hx",363,0x6434b429)
HXLINE( 363)		return ( (Bool)(::lime::_hx_system::System_obj::cffi_lime_system_get_allow_screen_timeout()) );
            	}
...
Bool System_obj::lime_system_set_allow_screen_timeout(Bool value){
            	HX_STACK_FRAME("lime.system.System","lime_system_set_allow_screen_timeout",0x608d9e60,"lime.system.System.lime_system_set_allow_screen_timeout","lime/system/System.hx",364,0x6434b429)
            	HX_STACK_ARG(value,"value")
HXLINE( 364)		return ( (Bool)(::lime::_hx_system::System_obj::cffi_lime_system_set_allow_screen_timeout(value)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(System_obj,lime_system_set_allow_screen_timeout,return )
 ...
 ::Dynamic System_obj::lime_system_get_directory(Int type,::String company,::String title){
            	HX_STACK_FRAME("lime.system.System","lime_system_get_directory",0xa47e5645,"lime.system.System.lime_system_get_directory","lime/system/System.hx",365,0x6434b429)
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(company,"company")
            	HX_STACK_ARG(title,"title")
HXLINE( 365)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_directory(type,company,title)) );
HXDLIN( 365)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(System_obj,lime_system_get_directory,return )
 ...
 ::Dynamic System_obj::lime_system_get_display(Int index){
            	HX_STACK_FRAME("lime.system.System","lime_system_get_display",0xf596681a,"lime.system.System.lime_system_get_display","lime/system/System.hx",366,0x6434b429)
            	HX_STACK_ARG(index,"index")
HXLINE( 366)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_display(index)) );
HXDLIN( 366)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Int System_obj::lime_system_get_num_displays(){
            	HX_STACK_FRAME("lime.system.System","lime_system_get_num_displays",0x871a8372,"lime.system.System.lime_system_get_num_displays","lime/system/System.hx",367,0x6434b429)
HXLINE( 367)		return ( (Int)(::lime::_hx_system::System_obj::cffi_lime_system_get_num_displays()) );
            	}
...
Float System_obj::lime_system_get_timer(){
            	HX_STACK_FRAME("lime.system.System","lime_system_get_timer",0x2a4a579d,"lime.system.System.lime_system_get_timer","lime/system/System.hx",368,0x6434b429)
HXLINE( 368)		return ( (Float)(::lime::_hx_system::System_obj::cffi_lime_system_get_timer()) );
            	}
...
{
            	HX_STACK_FRAME("lime.system.System","boot",0x171e93ab,"lime.system.System.boot","lime/system/System.hx",363,0x6434b429)
HXLINE( 363)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_system_get_allow_screen_timeout",73,89,73,7a),HX_("b",62,00,00,00),false);
HXDLIN( 363)		cffi_lime_system_get_allow_screen_timeout = inValue;
            	}
{
            	HX_STACK_FRAME("lime.system.System","boot",0x171e93ab,"lime.system.System.boot","lime/system/System.hx",364,0x6434b429)
HXLINE( 364)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_system_set_allow_screen_timeout",e7,0a,4e,8d),HX_("bb",c0,55,00,00),false);
HXDLIN( 364)		cffi_lime_system_set_allow_screen_timeout = inValue;
            	}
{
            	HX_STACK_FRAME("lime.system.System","boot",0x171e93ab,"lime.system.System.boot","lime/system/System.hx",365,0x6434b429)
HXLINE( 365)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_system_get_directory",5e,9e,04,7c),HX_("isso",06,0f,bf,45),false);
HXDLIN( 365)		cffi_lime_system_get_directory = inValue;
            	}
{
            	HX_STACK_FRAME("lime.system.System","boot",0x171e93ab,"lime.system.System.boot","lime/system/System.hx",366,0x6434b429)
HXLINE( 366)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_system_get_display",f3,47,82,d2),HX_("io",e6,5b,00,00),false);
HXDLIN( 366)		cffi_lime_system_get_display = inValue;
            	}
{
            	HX_STACK_FRAME("lime.system.System","boot",0x171e93ab,"lime.system.System.boot","lime/system/System.hx",367,0x6434b429)
HXLINE( 367)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_system_get_num_displays",f9,90,37,4f),HX_("i",69,00,00,00),false);
HXDLIN( 367)		cffi_lime_system_get_num_displays = inValue;
            	}
{
            	HX_STACK_FRAME("lime.system.System","boot",0x171e93ab,"lime.system.System.boot","lime/system/System.hx",368,0x6434b429)
HXLINE( 368)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_system_get_timer",36,5f,72,67),HX_("d",64,00,00,00),false);
HXDLIN( 368)		cffi_lime_system_get_timer = inValue;
            	}
}
