...
void AssetLibrary_obj::__construct(){
            	HX_STACK_FRAME("lime.AssetLibrary","new",0xa1312ef6,"lime.AssetLibrary.new","lime/Assets.hx",892,0x48c77341)
            	HX_STACK_THIS(this)
HXLINE( 892)		this->onChange =  ::lime::app::_Event_Void_Void_obj::__new();
            	}
...
::String AssetLibrary_obj::getText(::String id){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE( 948)		HX_VARI(  ::lime::utils::Bytes,bytes) = this->getBytes(id);
HXLINE( 950)		Bool _hx_tmp = hx::IsNull( bytes );
HXDLIN( 950)		if (_hx_tmp) {
HXLINE( 952)			return null();
            		}
            		else {
HXLINE( 956)			return bytes->getString((int)0,bytes->length);
            		}
 ...
 ::lime::app::Future AssetLibrary_obj::load(){
            		HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_0, ::lime::AssetLibrary,_gthis) HXARGC(0)
            		 ::lime::AssetLibrary _hx_run(){
            			HX_STACK_FRAME("lime.AssetLibrary","load",0x688cfed0,"lime.AssetLibrary.load","lime/Assets.hx",985,0x48c77341)
HXLINE( 985)			return _gthis;
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_STACK_FRAME("lime.AssetLibrary","load",0x688cfed0,"lime.AssetLibrary.load","lime/Assets.hx",983,0x48c77341)
            	HX_STACK_THIS(this)
HXLINE( 983)		HX_VARI(  ::lime::AssetLibrary,_gthis) = hx::ObjectPtr<OBJ_>(this);
HXLINE( 985)		return  ::lime::app::Future_obj::__new( ::Dynamic(new _hx_Closure_0(_gthis)));
            	}
 ...
 ::lime::app::Future AssetLibrary_obj::loadAudioBuffer(::String id){
            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_0,::String,id, ::lime::AssetLibrary,_gthis) HXARGC(0)
            		 ::lime::audio::AudioBuffer _hx_run(){
            			HX_STACK_FRAME("lime.AssetLibrary","loadAudioBuffer",0x68b85986,"lime.AssetLibrary.loadAudioBuffer","lime/Assets.hx",992,0x48c77341)
HXLINE( 992)			return _gthis->getAudioBuffer(id);
            		}
            		HX_END_LOCAL_FUNC0(return)
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE( 990)		HX_VARI(  ::lime::AssetLibrary,_gthis) = hx::ObjectPtr<OBJ_>(this);
HXLINE( 992)		return  ::lime::app::Future_obj::__new( ::Dynamic(new _hx_Closure_0(id,_gthis)));
            	}
 ...
 ::lime::app::Future AssetLibrary_obj::loadBytes(::String id){
            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_0,::String,id, ::lime::AssetLibrary,_gthis) HXARGC(0)
            		 ::lime::utils::Bytes _hx_run(){
            			HX_STACK_FRAME("lime.AssetLibrary","loadBytes",0x3c9ac77b,"lime.AssetLibrary.loadBytes","lime/Assets.hx",999,0x48c77341)
HXLINE( 999)			return _gthis->getBytes(id);
            		}
            		HX_END_LOCAL_FUNC0(return)
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE( 997)		HX_VARI(  ::lime::AssetLibrary,_gthis) = hx::ObjectPtr<OBJ_>(this);
HXLINE( 999)		return  ::lime::app::Future_obj::__new( ::Dynamic(new _hx_Closure_0(id,_gthis)));
            	}
 ...
 ::lime::app::Future AssetLibrary_obj::loadFont(::String id){
            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_0,::String,id, ::lime::AssetLibrary,_gthis) HXARGC(0)
            		 ::lime::text::Font _hx_run(){
            			HX_STACK_FRAME("lime.AssetLibrary","loadFont",0x57d630bf,"lime.AssetLibrary.loadFont","lime/Assets.hx",1006,0x48c77341)
HXLINE(1006)			return _gthis->getFont(id);
            		}
            		HX_END_LOCAL_FUNC0(return)
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(1004)		HX_VARI(  ::lime::AssetLibrary,_gthis) = hx::ObjectPtr<OBJ_>(this);
HXLINE(1006)		return  ::lime::app::Future_obj::__new( ::Dynamic(new _hx_Closure_0(id,_gthis)));
            	}
 ...
 ::lime::app::Future AssetLibrary_obj::loadImage(::String id){
            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_0,::String,id, ::lime::AssetLibrary,_gthis) HXARGC(0)
            		 ::lime::graphics::Image _hx_run(){
            			HX_STACK_FRAME("lime.AssetLibrary","loadImage",0x3c6bde6b,"lime.AssetLibrary.loadImage","lime/Assets.hx",1013,0x48c77341)
HXLINE(1013)			return _gthis->getImage(id);
            		}
            		HX_END_LOCAL_FUNC0(return)
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(1011)		HX_VARI(  ::lime::AssetLibrary,_gthis) = hx::ObjectPtr<OBJ_>(this);
HXLINE(1013)		return  ::lime::app::Future_obj::__new( ::Dynamic(new _hx_Closure_0(id,_gthis)));
            	}
 ...
 ::lime::app::Future AssetLibrary_obj::loadText(::String id){
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::lime::utils::Bytes bytes){
            			...
            			::String _hx_run(){
            				HX_STACK_FRAME("lime.AssetLibrary","loadText",0x610f9f9d,"lime.AssetLibrary.loadText","lime/Assets.hx",1024,0x48c77341)
HXLINE(1024)				Bool _hx_tmp = hx::IsNull( bytes );
HXDLIN(1024)				if (_hx_tmp) {
HXLINE(1026)					return null();
            				}
            				else {
HXLINE(1030)					return bytes->getString((int)0,bytes->length);
            				}
HXLINE(1024)				return null();
            			}
            			HX_END_LOCAL_FUNC0(return)

            			HX_STACK_FRAME("lime.AssetLibrary","loadText",0x610f9f9d,"lime.AssetLibrary.loadText","lime/Assets.hx",1022,0x48c77341)
            			HX_STACK_ARG(bytes,"bytes")
HXLINE(1022)			return  ::lime::app::Future_obj::__new( ::Dynamic(new _hx_Closure_0(bytes)));
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_STACK_FRAME("lime.AssetLibrary","loadText",0x610f9f9d,"lime.AssetLibrary.loadText","lime/Assets.hx",1020,0x48c77341)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(1020)		return this->loadBytes(id)->then( ::Dynamic(new _hx_Closure_1()));
            	}
