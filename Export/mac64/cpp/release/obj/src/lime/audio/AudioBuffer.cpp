...
HXLINE(  82)		Bool _hx_tmp = hx::IsNull( bytes );
HXDLIN(  82)		if (_hx_tmp) {
HXLINE(  82)			return null();
            		}
HXLINE(  91)		HX_VARI(  ::lime::audio::AudioBuffer,audioBuffer) =  ::lime::audio::AudioBuffer_obj::__new();
HXLINE(  92)		HX_VARI(  ::haxe::io::Bytes,buffer) = ::haxe::io::Bytes_obj::alloc((int)0);
HXDLIN(  92)		HX_VAR_NAME(  ::lime::utils::ArrayBufferView,this1,"this");
HXDLIN(  92)		Bool _hx_tmp1 = hx::IsNotNull( buffer );
HXDLIN(  92)		if (_hx_tmp1) {
HXLINE(  92)			HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__new((int)0,(int)4);
HXDLIN(  92)			if ((hx::Mod((int)0,_this->bytesPerElement) != (int)0)) {
HXLINE(  92)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN(  92)			HX_VARI( Int,bufferByteLength) = buffer->length;
HXDLIN(  92)			{
HXLINE(  92)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE(  92)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
...
HXDLIN(  92)			_this->byteOffset = (int)0;
HXDLIN(  92)			_this->byteLength = bufferByteLength;
HXDLIN(  92)			Float _hx_tmp2 = ((Float)bufferByteLength / (Float)_this->bytesPerElement);
HXDLIN(  92)			_this->length = ::Std_obj::_hx_int(_hx_tmp2);
HXDLIN(  92)			this1 = _this;
            		}
            		else {
HXLINE(  92)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            		}
HXDLIN(  92)		audioBuffer->data = this1;
HXLINE(  94)		 ::hx::Object * _hx_tmp3 = hx::DynamicPtr(bytes);
HXDLIN(  94)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::audio::AudioBuffer_obj::cffi_lime_audio_load(_hx_tmp3,hx::DynamicPtr(audioBuffer))) );
HXDLIN(  94)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE( 121)		Bool _hx_tmp = hx::IsNull( path );
HXDLIN( 121)		if (_hx_tmp) {
HXLINE( 121)			return null();
            		}
HXLINE( 170)		HX_VARI(  ::lime::audio::AudioBuffer,audioBuffer) =  ::lime::audio::AudioBuffer_obj::__new();
HXLINE( 171)		HX_VARI(  ::haxe::io::Bytes,buffer) = ::haxe::io::Bytes_obj::alloc((int)0);
HXDLIN( 171)		HX_VAR_NAME(  ::lime::utils::ArrayBufferView,this1,"this");
HXDLIN( 171)		Bool _hx_tmp1 = hx::IsNotNull( buffer );
HXDLIN( 171)		if (_hx_tmp1) {
HXLINE( 171)			HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__new((int)0,(int)4);
HXDLIN( 171)			if ((hx::Mod((int)0,_this->bytesPerElement) != (int)0)) {
HXLINE( 171)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN( 171)			HX_VARI( Int,bufferByteLength) = buffer->length;
HXDLIN( 171)			{
HXLINE( 171)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 171)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 171)				if ((bufferByteLength < (int)0)) {
HXLINE( 171)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
HXDLIN( 171)			_this->buffer = buffer;
HXDLIN( 171)			_this->byteOffset = (int)0;
HXDLIN( 171)			_this->byteLength = bufferByteLength;
HXDLIN( 171)			Float _hx_tmp2 = ((Float)bufferByteLength / (Float)_this->bytesPerElement);
HXDLIN( 171)			_this->length = ::Std_obj::_hx_int(_hx_tmp2);
HXDLIN( 171)			this1 = _this;
            		}
            		else {
HXLINE( 171)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            		}
HXDLIN( 171)		audioBuffer->data = this1;
HXLINE( 173)		 ::hx::Object * _hx_tmp3 = hx::DynamicPtr(path);
HXDLIN( 173)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::audio::AudioBuffer_obj::cffi_lime_audio_load(_hx_tmp3,hx::DynamicPtr(audioBuffer))) );
HXDLIN( 173)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE( 208)		HX_VARI(  ::lime::audio::AudioBuffer,buffer) = null();
HXLINE( 210)		{
HXLINE( 210)			HX_VARI( Int,_g) = (int)0;
HXDLIN( 210)			while((_g < paths->length)){
HXLINE( 210)				HX_VARI( ::String,path) = paths->__get(_g);
HXDLIN( 210)				++_g;
HXLINE( 212)				buffer = ::lime::audio::AudioBuffer_obj::fromFile(path);
HXLINE( 213)				Bool _hx_tmp = hx::IsNotNull( buffer );
...
void AudioBuffer_obj::fromURL(::String url, ::Dynamic handler){
            	HX_STACK_FRAME("lime.audio.AudioBuffer","fromURL",0x4f3e95dc,"lime.audio.AudioBuffer.fromURL","lime/audio/AudioBuffer.hx",236,0x5fb686fb)
            	HX_STACK_ARG(url,"url")
            	HX_STACK_ARG(handler,"handler")
HXLINE( 236)		Bool _hx_tmp;
HXDLIN( 236)		Bool _hx_tmp1;
HXDLIN( 236)		Bool _hx_tmp2 = hx::IsNotNull( url );
HXDLIN( 236)		if (_hx_tmp2) {
HXLINE( 236)			Int _hx_tmp3 = url.indexOf(HX_("http://",52,75,cd,5a),null());
HXDLIN( 236)			_hx_tmp1 = (_hx_tmp3 == (int)-1);
            		}
            		else {
HXLINE( 236)			_hx_tmp1 = false;
            		}
HXDLIN( 236)		if (_hx_tmp1) {
HXLINE( 236)			Int _hx_tmp4 = url.indexOf(HX_("https://",cf,b4,ae,3e),null());
HXDLIN( 236)			_hx_tmp = (_hx_tmp4 == (int)-1);
            		}
            		else {
HXLINE( 236)			_hx_tmp = false;
            		}
HXDLIN( 236)		if (_hx_tmp) {
HXLINE( 238)			 ::lime::audio::AudioBuffer _hx_tmp5 = ::lime::audio::AudioBuffer_obj::fromFile(url);
HXDLIN( 238)			handler(_hx_tmp5);
            		}
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(AudioBuffer_obj,fromURL,(void))
 ...
 ::lime::app::Future AudioBuffer_obj::loadFromFile(::String path){
            	...
            	HX_STACK_ARG(path,"path")
HXLINE( 278)		HX_VARI(  ::lime::app::Promise_lime_audio_AudioBuffer,promise) =  ::lime::app::Promise_lime_audio_AudioBuffer_obj::__new();
HXLINE( 280)		HX_VARI(  ::lime::audio::AudioBuffer,audioBuffer) = ::lime::audio::AudioBuffer_obj::fromFile(path);
HXLINE( 282)		Bool _hx_tmp = hx::IsNotNull( audioBuffer );
...
HXLINE( 377)		promise->completeWith( ::lime::app::Future_obj::__new( ::Dynamic(new _hx_Closure_0(paths))));
