...
Int y = __o_y.Default(0);
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(1065)		this->type = type;
HXLINE(1066)		this->windowID = windowID;
HXLINE(1067)		this->width = width;
HXLINE(1068)		this->height = height;
HXLINE(1069)		this->x = x;
HXLINE(1070)		this->y = y;
            	}
...
Dynamic WindowEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::WindowEventInfo WindowEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.WindowEventInfo","clone",0x3ae8cd6a,"lime._backend.native._NativeApplication.WindowEventInfo.clone","lime/_backend/native/NativeApplication.hx",1077,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE(1077)		return  ::lime::_backend::native::_NativeApplication::WindowEventInfo_obj::__new(this->type,this->windowID,this->width,this->height,this->x,this->y);
            	}
