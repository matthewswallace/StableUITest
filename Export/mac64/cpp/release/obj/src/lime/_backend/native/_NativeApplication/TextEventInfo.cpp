...
HXLINE( 979)		this->type = type;
HXLINE( 980)		this->windowID = windowID;
HXLINE( 981)		this->text = text;
HXLINE( 982)		this->start = start;
HXLINE( 983)		this->length = length;
            	}
...
Dynamic TextEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::TextEventInfo TextEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.TextEventInfo","clone",0xd025428d,"lime._backend.native._NativeApplication.TextEventInfo.clone","lime/_backend/native/NativeApplication.hx",990,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 990)		return  ::lime::_backend::native::_NativeApplication::TextEventInfo_obj::__new(this->type,this->windowID,this->text,this->start,this->length);
            	}
