...
HXLINE(1021)		this->type = type;
HXLINE(1022)		this->x = x;
HXLINE(1023)		this->y = y;
HXLINE(1024)		this->id = id;
HXLINE(1025)		this->dx = dx;
HXLINE(1026)		this->dy = dy;
HXLINE(1027)		this->pressure = pressure;
HXLINE(1028)		this->device = device;
            	}
...
Dynamic TouchEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::TouchEventInfo TouchEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.TouchEventInfo","clone",0xdd198915,"lime._backend.native._NativeApplication.TouchEventInfo.clone","lime/_backend/native/NativeApplication.hx",1035,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE(1035)		return  ::lime::_backend::native::_NativeApplication::TouchEventInfo_obj::__new(this->type,this->x,this->y,this->id,this->dx,this->dy,this->pressure,this->device);
            	}
