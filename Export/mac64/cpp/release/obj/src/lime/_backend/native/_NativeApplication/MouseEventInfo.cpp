...
HXLINE( 863)		this->type = type;
HXLINE( 864)		this->windowID = (int)0;
HXLINE( 865)		this->x = x;
HXLINE( 866)		this->y = y;
HXLINE( 867)		this->button = button;
HXLINE( 868)		this->movementX = movementX;
HXLINE( 869)		this->movementY = movementY;
            	}
...
Dynamic MouseEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::MouseEventInfo MouseEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.MouseEventInfo","clone",0xea05ad6f,"lime._backend.native._NativeApplication.MouseEventInfo.clone","lime/_backend/native/NativeApplication.hx",876,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 876)		return  ::lime::_backend::native::_NativeApplication::MouseEventInfo_obj::__new(this->type,this->windowID,this->x,this->y,this->button,this->movementX,this->movementY);
            	}
