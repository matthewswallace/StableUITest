...
HXLINE( 822)		this->type = type;
HXLINE( 823)		this->windowID = windowID;
HXLINE( 824)		this->keyCode = keyCode;
HXLINE( 825)		this->modifier = modifier;
            	}
...
Dynamic KeyEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::KeyEventInfo KeyEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.KeyEventInfo","clone",0x1c2dc9f5,"lime._backend.native._NativeApplication.KeyEventInfo.clone","lime/_backend/native/NativeApplication.hx",832,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 832)		return  ::lime::_backend::native::_NativeApplication::KeyEventInfo_obj::__new(this->type,this->windowID,this->keyCode,this->modifier);
            	}
