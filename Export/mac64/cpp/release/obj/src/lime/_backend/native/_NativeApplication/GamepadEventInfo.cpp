...
HXLINE( 736)		this->id = id;
HXLINE( 737)		this->button = button;
HXLINE( 738)		this->axis = axis;
HXLINE( 739)		this->value = value;
            	}
...
Dynamic GamepadEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::GamepadEventInfo GamepadEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.GamepadEventInfo","clone",0x156147b3,"lime._backend.native._NativeApplication.GamepadEventInfo.clone","lime/_backend/native/NativeApplication.hx",746,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 746)		return  ::lime::_backend::native::_NativeApplication::GamepadEventInfo_obj::__new(this->type,this->id,this->button,this->axis,this->value);
            	}
