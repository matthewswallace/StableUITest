...
HXLINE( 122)		HX_VARI(  ::lime::graphics::ImageBuffer,imageBuffer) = null();
HXLINE( 125)		 ::Dynamic handle = this->handle;
HXDLIN( 125)		HX_VARI(  ::haxe::io::Bytes,buffer) = ::haxe::io::Bytes_obj::alloc((int)0);
HXDLIN( 125)		HX_VAR_NAME(  ::lime::utils::ArrayBufferView,this1,"this");
HXDLIN( 125)		Bool _hx_tmp = hx::IsNotNull( buffer );
HXDLIN( 125)		if (_hx_tmp) {
HXLINE( 125)			HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__new((int)0,(int)4);
HXDLIN( 125)			if ((hx::Mod((int)0,_this->bytesPerElement) != (int)0)) {
HXLINE( 125)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN( 125)			HX_VARI( Int,bufferByteLength) = buffer->length;
HXDLIN( 125)			{
HXLINE( 125)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 125)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 125)				if ((bufferByteLength < (int)0)) {
HXLINE( 125)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
HXDLIN( 125)			_this->buffer = buffer;
HXDLIN( 125)			_this->byteOffset = (int)0;
HXDLIN( 125)			_this->byteLength = bufferByteLength;
HXDLIN( 125)			Float _hx_tmp1 = ((Float)bufferByteLength / (Float)_this->bytesPerElement);
HXDLIN( 125)			_this->length = ::Std_obj::_hx_int(_hx_tmp1);
HXDLIN( 125)			this1 = _this;
            		}
            		else {
HXLINE( 125)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            		}
HXDLIN( 125)		 ::Dynamic imageBuffer1 =  ::lime::graphics::ImageBuffer_obj::__new(this1,null(),null(),null(),null());
HXDLIN( 125)		 ::hx::Object * _hx_tmp2 = hx::DynamicPtr(handle);
HXDLIN( 125)		 ::hx::Object * _hx_tmp3 = hx::DynamicPtr(rect);
HXDLIN( 125)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeRenderer_obj::cffi_lime_renderer_read_pixels(_hx_tmp2,_hx_tmp3,hx::DynamicPtr(imageBuffer1))) );
HXDLIN( 125)		imageBuffer = Dynamic(hx::DynamicPtr(inVal));
HXLINE( 133)		Bool _hx_tmp4 = hx::IsNotNull( imageBuffer );
HXDLIN( 133)		if (_hx_tmp4) {
HXLINE( 135)			imageBuffer->format = (int)0;
HXLINE( 136)			return  ::lime::graphics::Image_obj::__new(imageBuffer,null(),null(),null(),null(),null(),null());
            		}
...
void NativeRenderer_obj::render(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 148)		{
HXLINE( 148)			 ::Dynamic handle = this->handle;
HXDLIN( 148)			::lime::_backend::native::NativeRenderer_obj::cffi_lime_renderer_make_current(hx::DynamicPtr(handle));
            		}
HXLINE( 150)		Bool _hx_tmp = !(this->useHardware);
HXDLIN( 150)		if (_hx_tmp) {
HXLINE( 153)			 ::Dynamic handle1 = this->handle;
HXDLIN( 153)			 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeRenderer_obj::cffi_lime_renderer_lock(hx::DynamicPtr(handle1))) );
HXDLIN( 153)			HX_VARI(  ::Dynamic,lock) = Dynamic(hx::DynamicPtr(inVal));
HXLINE( 155)			Bool _hx_tmp1;
HXDLIN( 155)			Bool _hx_tmp2;
HXDLIN( 155)			Bool _hx_tmp3;
HXDLIN( 155)			Bool _hx_tmp4 = hx::IsNotNull( this->cacheLock );
HXDLIN( 155)			if (_hx_tmp4) {
HXLINE( 155)				_hx_tmp3 = hx::IsNotEq(  ::Dynamic(this->cacheLock->__Field(HX_("pixels",2d,ef,a9,8c),hx::paccDynamic)), ::Dynamic(lock->__Field(HX_("pixels",2d,ef,a9,8c),hx::paccDynamic)) );
            			}
            			else {
HXLINE( 155)				_hx_tmp3 = true;
            			}
HXDLIN( 155)			if (!(_hx_tmp3)) {
HXLINE( 155)				_hx_tmp2 = hx::IsNotEq(  ::Dynamic(this->cacheLock->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)), ::Dynamic(lock->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)) );
            			}
            			else {
HXLINE( 155)				_hx_tmp2 = true;
            			}
HXDLIN( 155)			if (!(_hx_tmp2)) {
HXLINE( 155)				_hx_tmp1 = hx::IsNotEq(  ::Dynamic(this->cacheLock->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)), ::Dynamic(lock->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)) );
            			}
            			else {
HXLINE( 155)				_hx_tmp1 = true;
            			}
HXDLIN( 155)			if (_hx_tmp1) {
HXLINE( 157)				this->primarySurface = ::lime::graphics::cairo::_CairoImageSurface::CairoImageSurface_Impl__obj::create( ::Dynamic(lock->__Field(HX_("pixels",2d,ef,a9,8c),hx::paccDynamic)),(int)0, ::Dynamic(lock->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)), ::Dynamic(lock->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)), ::Dynamic(lock->__Field(HX_("pitch",c0,bb,a0,c2),hx::paccDynamic)));
HXLINE( 159)				Bool _hx_tmp5 = hx::IsNotNull( this->cairo );
HXDLIN( 159)				if (_hx_tmp5) {
HXLINE( 161)					this->cairo->recreate(this->primarySurface);
            				}
            				else {
HXLINE( 165)					this->cairo =  ::lime::graphics::cairo::Cairo_obj::__new(this->primarySurface);
            				}
            			}
HXLINE( 171)			this->cacheLock = lock;
            		}
            	}
...
HXLINE( 190)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeRenderer_obj::cffi_lime_renderer_create(hx::DynamicPtr(window))) );
...
HXLINE( 191)		::lime::_backend::native::NativeRenderer_obj::cffi_lime_renderer_flip(hx::DynamicPtr(handle));
            	}
...
Float NativeRenderer_obj::lime_renderer_get_context( ::Dynamic handle){
            	...
            	HX_STACK_ARG(handle,"handle")
HXLINE( 192)		return ( (Float)(::lime::_backend::native::NativeRenderer_obj::cffi_lime_renderer_get_context(hx::DynamicPtr(handle))) );
            	}
...
Float NativeRenderer_obj::lime_renderer_get_scale( ::Dynamic handle){
            	...
            	HX_STACK_ARG(handle,"handle")
HXLINE( 193)		return ( (Float)(::lime::_backend::native::NativeRenderer_obj::cffi_lime_renderer_get_scale(hx::DynamicPtr(handle))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(NativeRenderer_obj,lime_renderer_get_scale,return )
 ...
 ::Dynamic NativeRenderer_obj::lime_renderer_get_type( ::Dynamic handle){
            	...
            	HX_STACK_ARG(handle,"handle")
HXLINE( 194)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeRenderer_obj::cffi_lime_renderer_get_type(hx::DynamicPtr(handle))) );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(NativeRenderer_obj,lime_renderer_get_type,return )
 ...
 ::Dynamic NativeRenderer_obj::lime_renderer_lock( ::Dynamic handle){
            	...
            	HX_STACK_ARG(handle,"handle")
HXLINE( 195)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeRenderer_obj::cffi_lime_renderer_lock(hx::DynamicPtr(handle))) );
HXDLIN( 195)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
void NativeRenderer_obj::lime_renderer_make_current( ::Dynamic handle){
            	...
            	HX_STACK_ARG(handle,"handle")
HXLINE( 196)		::lime::_backend::native::NativeRenderer_obj::cffi_lime_renderer_make_current(hx::DynamicPtr(handle));
            	}
...
HXLINE( 197)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 197)		 ::hx::Object * _hx_tmp1 = hx::DynamicPtr(rect);
HXDLIN( 197)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeRenderer_obj::cffi_lime_renderer_read_pixels(_hx_tmp,_hx_tmp1,hx::DynamicPtr(imageBuffer))) );
...
void NativeRenderer_obj::lime_renderer_unlock( ::Dynamic handle){
            	...
            	HX_STACK_ARG(handle,"handle")
HXLINE( 198)		::lime::_backend::native::NativeRenderer_obj::cffi_lime_renderer_unlock(hx::DynamicPtr(handle));
            	}
...
HXLINE( 190)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_renderer_create",4e,c5,81,91),HX_("oo",20,61,00,00),false);
HXDLIN( 190)		cffi_lime_renderer_create = inValue;
            	}
{
...
HXLINE( 191)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_renderer_flip",7f,d8,55,6f),HX_("ov",27,61,00,00),false);
HXDLIN( 191)		cffi_lime_renderer_flip = inValue;
            	}
{
            	HX_STACK_FRAME("lime._backend.native.NativeRenderer","boot",0x2717cd0f,"lime._backend.native.NativeRenderer.boot","lime/_backend/native/NativeRenderer.hx",192,0x398cc96c)
HXLINE( 192)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_renderer_get_context",74,6e,ee,e1),HX_("od",15,61,00,00),false);
HXDLIN( 192)		cffi_lime_renderer_get_context = inValue;
            	}
{
            	HX_STACK_FRAME("lime._backend.native.NativeRenderer","boot",0x2717cd0f,"lime._backend.native.NativeRenderer.boot","lime/_backend/native/NativeRenderer.hx",193,0x398cc96c)
HXLINE( 193)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_renderer_get_scale",cf,0b,88,72),HX_("od",15,61,00,00),false);
HXDLIN( 193)		cffi_lime_renderer_get_scale = inValue;
            	}
{
            	HX_STACK_FRAME("lime._backend.native.NativeRenderer","boot",0x2717cd0f,"lime._backend.native.NativeRenderer.boot","lime/_backend/native/NativeRenderer.hx",194,0x398cc96c)
HXLINE( 194)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_renderer_get_type",15,c5,47,ea),HX_("oo",20,61,00,00),false);
HXDLIN( 194)		cffi_lime_renderer_get_type = inValue;
            	}
{
            	HX_STACK_FRAME("lime._backend.native.NativeRenderer","boot",0x2717cd0f,"lime._backend.native.NativeRenderer.boot","lime/_backend/native/NativeRenderer.hx",195,0x398cc96c)
HXLINE( 195)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_renderer_lock",bd,61,4f,73),HX_("oo",20,61,00,00),false);
HXDLIN( 195)		cffi_lime_renderer_lock = inValue;
            	}
{
            	HX_STACK_FRAME("lime._backend.native.NativeRenderer","boot",0x2717cd0f,"lime._backend.native.NativeRenderer.boot","lime/_backend/native/NativeRenderer.hx",196,0x398cc96c)
HXLINE( 196)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_renderer_make_current",7a,b5,2f,5b),HX_("ov",27,61,00,00),false);
HXDLIN( 196)		cffi_lime_renderer_make_current = inValue;
            	}
{
            	HX_STACK_FRAME("lime._backend.native.NativeRenderer","boot",0x2717cd0f,"lime._backend.native.NativeRenderer.boot","lime/_backend/native/NativeRenderer.hx",197,0x398cc96c)
HXLINE( 197)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_renderer_read_pixels",a4,e4,37,c3),HX_("oooo",40,4a,b3,49),false);
HXDLIN( 197)		cffi_lime_renderer_read_pixels = inValue;
            	}
{
            	HX_STACK_FRAME("lime._backend.native.NativeRenderer","boot",0x2717cd0f,"lime._backend.native.NativeRenderer.boot","lime/_backend/native/NativeRenderer.hx",198,0x398cc96c)
HXLINE( 198)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_renderer_unlock",16,01,ff,7a),HX_("ov",27,61,00,00),false);
HXDLIN( 198)		cffi_lime_renderer_unlock = inValue;
            	}
}
