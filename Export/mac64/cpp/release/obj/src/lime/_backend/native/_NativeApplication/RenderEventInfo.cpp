...
HXLINE( 903)		this->type = type;
HXLINE( 904)		this->context = context;
            	}
...
Dynamic RenderEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::RenderEventInfo RenderEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.RenderEventInfo","clone",0xa78638c4,"lime._backend.native._NativeApplication.RenderEventInfo.clone","lime/_backend/native/NativeApplication.hx",911,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 911)		return  ::lime::_backend::native::_NativeApplication::RenderEventInfo_obj::__new(this->type,this->context);
            	}
