...
HXLINE( 667)		this->type = type;
HXLINE( 668)		this->deltaTime = deltaTime;
            	}
...
Dynamic ApplicationEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::ApplicationEventInfo ApplicationEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.ApplicationEventInfo","clone",0x3158bc64,"lime._backend.native._NativeApplication.ApplicationEventInfo.clone","lime/_backend/native/NativeApplication.hx",675,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 675)		return  ::lime::_backend::native::_NativeApplication::ApplicationEventInfo_obj::__new(this->type,this->deltaTime);
            	}
