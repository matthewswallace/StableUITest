...
void ApplicationMain_obj::main(){
            	HX_STACK_FRAME("ApplicationMain","main",0x93d2f73e,"ApplicationMain.main","ApplicationMain.hx",22,0x0780ded5)
HXLINE(  24)		::lime::Assets_obj::registerLibrary(HX_("default",c1,d8,c3,9b), ::DefaultAssetLibrary_obj::__new());
HXLINE(  26)		::ApplicationMain_obj::config =  ::Dynamic(hx::Anon_obj::Create(9)
            			->setFixed(0,HX_("company",3d,15,69,83),HX_("Company Name",4e,48,0d,cb))
            			->setFixed(1,HX_("build",2e,db,ea,ba),HX_("17",e6,2a,00,00))
            			->setFixed(2,HX_("windows",83,de,74,e8),::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(hx::Anon_obj::Create(20)
            				...
            				->setFixed(8,HX_("height",e7,07,4c,02),(int)600)
            				->setFixed(9,HX_("title",98,15,3b,10),HX_("StableUITest",e1,b9,23,18))
            			...
            			->setFixed(5,HX_("packageName",f1,04,ad,04),HX_("com.sample.stableuitest",b8,53,dc,af))
            			->setFixed(6,HX_("file",7c,ce,bb,43),HX_("StableUITest",e1,b9,23,18))
            			->setFixed(7,HX_("name",4b,72,ff,48),HX_("StableUITest",e1,b9,23,18))
            			->setFixed(8,HX_("version",18,e7,f1,7c),HX_("1.0.0",b5,d1,2e,55)));
HXLINE(  77)		::ApplicationMain_obj::create();
            	}
...
void ApplicationMain_obj::create(){
            	HX_STACK_FRAME("ApplicationMain","create",0x2f7db141,"ApplicationMain.create","ApplicationMain.hx",83,0x0780ded5)
HXLINE(  85)		HX_VARI(  ::openfl::display::Application,app) =  ::openfl::display::Application_obj::__new();
HXLINE(  86)		app->create(::ApplicationMain_obj::config);
HXLINE(  88)		::ApplicationMain_obj::preloader =  ::openfl::display::Preloader_obj::__new( ::openfl::display::DefaultPreloader_obj::__new());
HXLINE(  89)		app->setPreloader(::ApplicationMain_obj::preloader);
HXLINE(  90)		::ApplicationMain_obj::preloader->onComplete->add(::ApplicationMain_obj::init_dyn(),null(),null());
HXLINE(  91)		::ApplicationMain_obj::preloader->create(::ApplicationMain_obj::config);
HXLINE( 116)		HX_VARI( Int,result) = app->exec();
...
void ApplicationMain_obj::init(){
            	HX_STACK_FRAME("ApplicationMain","init",0x9137fa15,"ApplicationMain.init","ApplicationMain.hx",195,0x0780ded5)
HXLINE( 197)		HX_VARI( ::Array< Int >,loaded) = ::Array_obj< Int >::fromData( _hx_array_data_0,1);
HXLINE( 198)		HX_VARI( Int,total) = (int)0;
HXLINE( 211)		::ApplicationMain_obj::preloader = null();
HXLINE( 216)		if ((total == (int)0)) {
HXLINE( 218)			::ApplicationMain_obj::start();
            		}
            	}
...
void ApplicationMain_obj::start(){
            	HX_STACK_FRAME("ApplicationMain","start",0x45b5d9bd,"ApplicationMain.start","ApplicationMain.hx",225,0x0780ded5)
HXLINE( 227)		::lime::Assets_obj::initialize();
HXLINE( 229)		::Main_obj::main();
HXLINE( 232)		::openfl::Lib_obj::current->stage->dispatchEvent( ::openfl::events::Event_obj::__new(HX_("resize",f4,59,7b,08),false,false));
HXLINE( 234)		Bool _hx_tmp = ::openfl::Lib_obj::current->stage->window->_hx___fullscreen;
HXDLIN( 234)		if (_hx_tmp) {
HXLINE( 236)			::openfl::Lib_obj::current->stage->dispatchEvent( ::openfl::events::FullScreenEvent_obj::__new(HX_("fullScreen",5b,ae,48,2e),false,false,true,true));
            		}
            	}
