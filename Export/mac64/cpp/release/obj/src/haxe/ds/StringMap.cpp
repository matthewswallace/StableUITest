...
HX_DEFINE_DYNAMIC_FUNC2(StringMap_obj,set,(void))
 ...
 ::Dynamic StringMap_obj::get(::String key){
            	HX_STACK_FRAME("haxe.ds.StringMap","get",0x0f0ea0fc,"haxe.ds.StringMap.get","/usr/local/lib/haxe/std/cpp/_std/haxe/ds/StringMap.hx",59,0x61d6228c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
Bool StringMap_obj::exists(::String key){
            	HX_STACK_FRAME("haxe.ds.StringMap","exists",0xd35fc136,"haxe.ds.StringMap.exists","/usr/local/lib/haxe/std/cpp/_std/haxe/ds/StringMap.hx",63,0x61d6228c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
...
Bool StringMap_obj::remove(::String key){
            	HX_STACK_FRAME("haxe.ds.StringMap","remove",0x18083f9e,"haxe.ds.StringMap.remove","/usr/local/lib/haxe/std/cpp/_std/haxe/ds/StringMap.hx",67,0x61d6228c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(key,"key")
