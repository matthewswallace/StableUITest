...
HXLINE( 213)		this->mTime = time;
HXLINE( 214)		::haxe::Timer_obj::sRunningTimers->push(hx::ObjectPtr<OBJ_>(this));
HXLINE( 215)		Float _hx_tmp = ::haxe::Timer_obj::getMS();
HXDLIN( 215)		this->mFireAt = (_hx_tmp + this->mTime);
HXLINE( 216)		this->mRunning = true;
            	}
...
void _hx_run(){
            	HX_STACK_FRAME("haxe.Timer","__default_run",0xdc2b9b9c,"haxe.Timer.__default_run","haxe/Timer.hx",254,0x1a690682)
            	HX_STACK_THIS(this)
            	}
...
void Timer_obj::stop(){
            	HX_STACK_FRAME("haxe.Timer","stop",0xd1fd70b3,"haxe.Timer.stop","haxe/Timer.hx",270,0x1a690682)
            	HX_STACK_THIS(this)
HXLINE( 270)		Bool _hx_tmp = this->mRunning;
HXDLIN( 270)		if (_hx_tmp) {
HXLINE( 272)			this->mRunning = false;
HXLINE( 274)			{
HXLINE( 274)				HX_VARI( Int,_g1) = (int)0;
HXDLIN( 274)				HX_VARI( Int,_g) = ::haxe::Timer_obj::sRunningTimers->length;
HXDLIN( 274)				while((_g1 < _g)){
HXLINE( 274)					HX_VARI( Int,i) = _g1++;
HXLINE( 276)					Bool _hx_tmp1 = hx::IsEq( ::haxe::Timer_obj::sRunningTimers->__get(i).StaticCast<  ::haxe::Timer >(),hx::ObjectPtr<OBJ_>(this) );
HXDLIN( 276)					if (_hx_tmp1) {
HXLINE( 278)						::haxe::Timer_obj::sRunningTimers[i] = null();
HXLINE( 279)						goto _hx_goto_0;
            					}
            				}
            				_hx_goto_0:;
            			}
...
void Timer_obj::_hx___check(Float inTime){
            	HX_STACK_FRAME("haxe.Timer","__check",0xb5623597,"haxe.Timer.__check","haxe/Timer.hx",292,0x1a690682)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(inTime,"inTime")
HXLINE( 292)		Bool _hx_tmp = (inTime >= this->mFireAt);
HXDLIN( 292)		if (_hx_tmp) {
HXLINE( 294)			hx::AddEq(this->mFireAt,this->mTime);
HXLINE( 295)			this->run();
            		}
            	}
...
::Array< ::Dynamic> Timer_obj::sRunningTimers;
 ...
 ::haxe::Timer Timer_obj::delay( ::Dynamic f,Int time){
            		...
            		void _hx_run(){
            			HX_STACK_FRAME("haxe.Timer","delay",0x3ed5f1b2,"haxe.Timer.delay","haxe/Timer.hx",225,0x1a690682)
HXLINE( 227)			t->stop();
HXLINE( 228)			f();
            		}
            		HX_END_LOCAL_FUNC0((void))
            	...
            	HX_STACK_ARG(f,"f")
            	HX_STACK_ARG(time,"time")
HXLINE( 223)		HX_VARI(  ::haxe::Timer,t) =  ::haxe::Timer_obj::__new(time);
HXLINE( 225)		t->run =  ::Dynamic(new _hx_Closure_0(f,t));
HXLINE( 232)		return t;
            	}
...
HXLINE( 239)		return ::lime::_hx_system::System_obj::getTimer();
            	}
...
HXLINE( 246)		HX_VARI( Float,t0) = ::haxe::Timer_obj::stamp();
HXLINE( 247)		HX_VARI(  ::Dynamic,r) = f();
HXLINE( 248)		Float _hx_tmp = ::haxe::Timer_obj::stamp();
HXDLIN( 248)		::haxe::Log_obj::trace(((_hx_tmp - t0) + HX_("s",73,00,00,00)),pos);
HXLINE( 249)		return r;
            	}
...
Float Timer_obj::stamp(){
            	HX_STACK_FRAME("haxe.Timer","stamp",0xebba8a32,"haxe.Timer.stamp","haxe/Timer.hx",263,0x1a690682)
HXLINE( 263)		Int _hx_tmp = ::lime::_hx_system::System_obj::getTimer();
HXDLIN( 263)		return ((Float)_hx_tmp / (Float)(int)1000);
            	}
...
{
{
            	HX_STACK_FRAME("haxe.Timer","boot",0xc6bd04e3,"haxe.Timer.boot","haxe/Timer.hx",204,0x1a690682)
HXLINE( 204)		sRunningTimers = ::Array_obj< ::Dynamic>::__new(0);
            	}
}
