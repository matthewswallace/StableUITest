...
HXLINE(  21)		return  ::motion::easing::QuartEaseIn_obj::__new();
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(Quart_obj,get_easeIn,return )

::Dynamic Quart_obj::get_easeInOut(){
...
HXLINE(  28)		return  ::motion::easing::QuartEaseInOut_obj::__new();
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(Quart_obj,get_easeInOut,return )

::Dynamic Quart_obj::get_easeOut(){
...
HXLINE(  35)		return  ::motion::easing::QuartEaseOut_obj::__new();
            	}
...
static hx::StaticInfo *Quart_obj_sStaticStorageInfo = 0;
#endif
