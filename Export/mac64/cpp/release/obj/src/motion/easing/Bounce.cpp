...
HXLINE(  20)		return  ::motion::easing::BounceEaseIn_obj::__new();
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(Bounce_obj,get_easeIn,return )

::Dynamic Bounce_obj::get_easeInOut(){
...
HXLINE(  27)		return  ::motion::easing::BounceEaseInOut_obj::__new();
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(Bounce_obj,get_easeInOut,return )

::Dynamic Bounce_obj::get_easeOut(){
...
HXLINE(  34)		return  ::motion::easing::BounceEaseOut_obj::__new();
            	}
