...
Float QuadEaseOut_obj::ease(Float t,Float b,Float c,Float d){
            	HX_STACK_FRAME("motion.easing.QuadEaseOut","ease",0xccc16a4e,"motion.easing.QuadEaseOut.ease","motion/easing/Quad.hx",122,0xc538468c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(t,"t")
            	HX_STACK_ARG(b,"b")
            	HX_STACK_ARG(c,"c")
            	HX_STACK_ARG(d,"d")
HXLINE( 122)		hx::DivEq(t,d);
HXDLIN( 122)		return (((-(c) * t) * (t - (int)2)) + b);
            	}
