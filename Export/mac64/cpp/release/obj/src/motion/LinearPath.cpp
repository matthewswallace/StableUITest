...
void LinearPath_obj::__construct(Float end,Float strength){
            	HX_STACK_FRAME("motion.LinearPath","new",0xd27de774,"motion.LinearPath.new","motion/MotionPath.hx",228,0x95e57daa)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(end,"end")
            	HX_STACK_ARG(strength,"strength")
HXLINE( 228)		super::__construct(end,(int)0,strength);
            	}
...
hx::ObjectPtr< LinearPath_obj > LinearPath_obj::__new(Float end,Float strength)
{
	...
	_hx_result->__construct(end,strength);
	return _hx_result;
}
...
Float LinearPath_obj::calculate(Float start,Float k){
            	HX_STACK_FRAME("motion.LinearPath","calculate",0x806d337a,"motion.LinearPath.calculate","motion/MotionPath.hx",235,0x95e57daa)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(start,"start")
            	HX_STACK_ARG(k,"k")
HXLINE( 235)		return (start + (k * (this->end - start)));
            	}
