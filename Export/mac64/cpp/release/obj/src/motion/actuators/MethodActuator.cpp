...
HXLINE(  18)		Bool _hx_tmp = !(::Reflect_obj::hasField(properties,HX_("start",62,74,0b,84)));
HXDLIN(  18)		if (_hx_tmp) {
HXLINE(  20)			this->properties->__SetField(HX_("start",62,74,0b,84),::cpp::VirtualArray_obj::__new(),hx::paccDynamic);
            		}
HXLINE(  24)		Bool _hx_tmp1 = !(::Reflect_obj::hasField(properties,HX_("end",db,03,4d,00)));
...
HXDLIN(  30)			HX_VARI( Int,_g) = ( (Int)( ::Dynamic(this->properties->__Field(HX_("start",62,74,0b,84),hx::paccDynamic))->__Field(HX_("length",e6,94,07,9f),hx::paccDynamic)) );
HXDLIN(  30)			while((_g1 < _g)){
HXLINE(  30)				HX_VARI( Int,i) = _g1++;
HXLINE(  32)				 ::Dynamic _hx_tmp2 =  ::Dynamic(this->properties->__Field(HX_("start",62,74,0b,84),hx::paccDynamic))->__GetItem(i);
HXDLIN(  32)				this->currentParameters->push(_hx_tmp2);
            			}
            		}
            	}
...
void MethodActuator_obj::apply(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  40)		HX_VARI(  ::Dynamic,method) = this->target;
HXDLIN(  40)		HX_VARI( ::cpp::VirtualArray,params) = ( (::cpp::VirtualArray)(this->properties->__Field(HX_("end",db,03,4d,00),hx::paccDynamic)) );
HXDLIN(  40)		Bool _hx_tmp = hx::IsNull( params );
HXDLIN(  40)		if (_hx_tmp) {
HXLINE(  40)			params = ::cpp::VirtualArray_obj::__new(0);
            		}
...
HXDLIN(  47)			HX_VARI( Int,_g) = ( (Int)( ::Dynamic(this->properties->__Field(HX_("start",62,74,0b,84),hx::paccDynamic))->__Field(HX_("length",e6,94,07,9f),hx::paccDynamic)) );
HXDLIN(  47)			while((_g1 < _g)){
HXLINE(  47)				HX_VARI( Int,i) = _g1++;
HXLINE(  49)				 ::Dynamic _hx_tmp = this->tweenProperties;
HXDLIN(  49)				 ::Dynamic _hx_tmp1 = ::Reflect_obj::field(_hx_tmp,(HX_("param",8d,80,55,bd) + i));
HXDLIN(  49)				this->currentParameters->set(i,_hx_tmp1);
            			}
            		}
HXLINE(  53)		{
HXLINE(  53)			HX_VARI(  ::Dynamic,method) = this->target;
HXDLIN(  53)			HX_VARI( ::cpp::VirtualArray,params) = this->currentParameters;
HXDLIN(  53)			Bool _hx_tmp2 = hx::IsNull( params );
...
void MethodActuator_obj::initialize(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  62)		HX_VAR(  ::motion::actuators::PropertyDetails,details);
HXLINE(  63)		HX_VAR( ::String,propertyName);
HXLINE(  64)		HX_VAR(  ::Dynamic,start);
HXLINE(  66)		{
HXLINE(  66)			HX_VARI( Int,_g1) = (int)0;
HXDLIN(  66)			HX_VARI( Int,_g) = ( (Int)( ::Dynamic(this->properties->__Field(HX_("start",62,74,0b,84),hx::paccDynamic))->__Field(HX_("length",e6,94,07,9f),hx::paccDynamic)) );
HXDLIN(  66)			while((_g1 < _g)){
HXLINE(  66)				HX_VARI( Int,i) = _g1++;
...
HXDLIN(  73)				Bool _hx_tmp1 = !(::Std_obj::is(start,hx::ClassOf< ::Float >()));
...
HXLINE(  75)					details =  ::motion::actuators::PropertyDetails_obj::__new(this->tweenProperties,propertyName,start,(( (Float)( ::Dynamic(this->properties->__Field(HX_("end",db,03,4d,00),hx::paccDynamic))->__GetItem(i)) ) - start),null());
...
HXDLIN(  94)				HX_VARI( Int,_g) = ( (Int)( ::Dynamic(this->properties->__Field(HX_("start",62,74,0b,84),hx::paccDynamic))->__Field(HX_("length",e6,94,07,9f),hx::paccDynamic)) );
HXDLIN(  94)				while((_g1 < _g)){
HXLINE(  94)					HX_VARI( Int,i) = _g1++;
HXLINE(  96)					 ::Dynamic _hx_tmp1 = this->tweenProperties;
HXDLIN(  96)					 ::Dynamic _hx_tmp2 = ::Reflect_obj::field(_hx_tmp1,(HX_("param",8d,80,55,bd) + i));
HXDLIN(  96)					this->currentParameters->set(i,_hx_tmp2);
            				}
            			}
HXLINE( 100)			{
HXLINE( 100)				HX_VARI(  ::Dynamic,method) = this->target;
HXDLIN( 100)				HX_VARI( ::cpp::VirtualArray,params) = this->currentParameters;
HXDLIN( 100)				Bool _hx_tmp3 = hx::IsNull( params );
