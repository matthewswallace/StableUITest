...
Bool FileSystem_obj::isDirectory(::String path){
            	HX_STACK_FRAME("sys.FileSystem","isDirectory",0x6c577a21,"sys.FileSystem.isDirectory","/usr/local/lib/haxe/std/cpp/_std/sys/FileSystem.hx",62,0x1f6d7d6f)
            	HX_STACK_ARG(path,"path")
...
void FileSystem_obj::deleteDirectory(::String path){
            	HX_STACK_FRAME("sys.FileSystem","deleteDirectory",0x052a5cc0,"sys.FileSystem.deleteDirectory","/usr/local/lib/haxe/std/cpp/_std/sys/FileSystem.hx",84,0x1f6d7d6f)
            	HX_STACK_ARG(path,"path")
HXLINE(  84)		_hx_std_sys_remove_dir(path);
            	}
...
::Array< ::String > FileSystem_obj::readDirectory(::String path){
            	HX_STACK_FRAME("sys.FileSystem","readDirectory",0x0619f8b5,"sys.FileSystem.readDirectory","/usr/local/lib/haxe/std/cpp/_std/sys/FileSystem.hx",88,0x1f6d7d6f)
            	HX_STACK_ARG(path,"path")
