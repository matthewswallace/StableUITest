...
Int Process_obj::exitCode(){
            	HX_STACK_FRAME("sys.io.Process","exitCode",0x41e72111,"sys.io.Process.exitCode","/usr/local/lib/haxe/std/cpp/_std/sys/io/Process.hx",108,0x8244a714)
            	HX_STACK_THIS(this)
HXLINE( 108)		return _hx_std_process_exit(this->p);
            	}
