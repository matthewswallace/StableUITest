...
void Deque_obj::__construct(){
            	HX_STACK_FRAME("cpp.vm.Deque","new",0xa6685326,"cpp.vm.Deque.new","/usr/local/lib/haxe/std/cpp/vm/Deque.hx",28,0x5079f68d)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Deque_obj,add,(void))
 ...
 ::Dynamic Deque_obj::pop(Bool block){
            	HX_STACK_FRAME("cpp.vm.Deque","pop",0xa669e057,"cpp.vm.Deque.pop","/usr/local/lib/haxe/std/cpp/vm/Deque.hx",37,0x5079f68d)
            	HX_STACK_THIS(this)
