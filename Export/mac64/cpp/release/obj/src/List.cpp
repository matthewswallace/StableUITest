...
HX_DEFINE_DYNAMIC_FUNC1(List_obj,add,(void))
 ...
 ::Dynamic List_obj::first(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  81)		Bool _hx_tmp = hx::IsNull( this->h );
...
HX_DEFINE_DYNAMIC_FUNC0(List_obj,first,return )
 ...
 ::Dynamic List_obj::pop(){
            	HX_STACK_FRAME("List","pop",0xed8a8da1,"List.pop","/usr/local/lib/haxe/std/List.hx",99,0xdb880ee3)
            	HX_STACK_THIS(this)
...
void List_obj::clear(){
            	HX_STACK_FRAME("List","clear",0xd148c59d,"List.clear","/usr/local/lib/haxe/std/List.hx",123,0xdb880ee3)
            	HX_STACK_THIS(this)
