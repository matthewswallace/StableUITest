...
void IntIterator_obj::__construct(Int min,Int max){
            	HX_STACK_FRAME("IntIterator","new",0x5692054f,"IntIterator.new","/usr/local/lib/haxe/std/IntIterator.hx",46,0x6ce8797e)
            	HX_STACK_THIS(this)
...
Bool IntIterator_obj::hasNext(){
            	HX_STACK_FRAME("IntIterator","hasNext",0xd8737ddc,"IntIterator.hasNext","/usr/local/lib/haxe/std/IntIterator.hx",55,0x6ce8797e)
            	HX_STACK_THIS(this)
...
Int IntIterator_obj::next(){
            	HX_STACK_FRAME("IntIterator","next",0x6932a124,"IntIterator.next","/usr/local/lib/haxe/std/IntIterator.hx",64,0x6ce8797e)
            	HX_STACK_THIS(this)
