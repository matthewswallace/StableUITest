...
class HXCPP_CLASS_ATTRIBUTES URLLoader_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		::Dynamic load_dyn();
		 ...
		 ::openfl::utils::ByteArrayData prepareData( ::Dynamic data);
		::Dynamic prepareData_dyn();

		void requestUrl(::String url, ::Dynamic method, ::Dynamic data,::Array< ::Dynamic> requestHeaders);
		::Dynamic requestUrl_dyn();

		Int writeFunction( ::haxe::io::Bytes output,Int size,Int nmemb);
		::Dynamic writeFunction_dyn();

		Int headerFunction( ::haxe::io::Bytes output,Int size,Int nmemb);
		::Dynamic headerFunction_dyn();

		Int progressFunction(Float dltotal,Float dlnow,Float uptotal,Float upnow);
		::Dynamic progressFunction_dyn();

		 ::lime::utils::Bytes readFunction(Int max, ::openfl::utils::ByteArrayData input);
		...
		void onSecurityError(::String msg);
		::Dynamic onSecurityError_dyn();

		void onStatus(Int status);
		::Dynamic onStatus_dyn();

		 ::Dynamic set_dataFormat( ::Dynamic inputVal);
