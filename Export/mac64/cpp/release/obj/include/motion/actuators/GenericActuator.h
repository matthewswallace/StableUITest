...
class HXCPP_CLASS_ATTRIBUTES GenericActuator_obj : public hx::Object
{
	...
	public:
		...
		::Dynamic onResume_7abbe56f( ::Dynamic handler,::cpp::VirtualArray parameters);

		::Dynamic onPause_7abbe56f( ::Dynamic handler,::cpp::VirtualArray parameters);

		::Dynamic snapping_518521ca( ::Dynamic value);

		::Dynamic smartRotation_518521ca( ::Dynamic value);

		::Dynamic reverse_518521ca( ::Dynamic value);

		::Dynamic repeat_518521ca( ::Dynamic times);

		::Dynamic reflect_518521ca( ::Dynamic value);

		::Dynamic onUpdate_7abbe56f( ::Dynamic handler,::cpp::VirtualArray parameters);

		::Dynamic onRepeat_7abbe56f( ::Dynamic handler,::cpp::VirtualArray parameters);

		::Dynamic onComplete_7abbe56f( ::Dynamic handler,::cpp::VirtualArray parameters);

		::Dynamic ease_bc5edcf4(::Dynamic easing);

		::Dynamic delay_8bf59891(Float duration);

		::Dynamic autoVisible_518521ca( ::Dynamic value);
