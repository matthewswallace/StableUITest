...
class HXCPP_CLASS_ATTRIBUTES IEasing_obj {
	public:
		...
		static inline Float calculate( ::Dynamic _hx_,Float k) {
			return (_hx_.mPtr->*( static_cast< ::motion::easing::IEasing_obj *>(_hx_.mPtr->_hx_getInterface(0x864e8b53)))->_hx_calculate)(k);
		}
		...
		static inline Float ease( ::Dynamic _hx_,Float t,Float b,Float c,Float d) {
			return (_hx_.mPtr->*( static_cast< ::motion::easing::IEasing_obj *>(_hx_.mPtr->_hx_getInterface(0x864e8b53)))->_hx_ease)(t,b,c,d);
		}
};
